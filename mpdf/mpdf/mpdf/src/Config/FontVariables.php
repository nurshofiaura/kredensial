	...
	public function __construct()
	{
		$this->defaults = [
			...
			'fontdata' => [
				...
				"dotmatrix" => [
					'R' => "dotmatrix-twoextended.ttf",
					'B' => "dotmatrix-twoextended.ttf",
					'I' => "dotmatrix-twoextended.ttf",
					'BI' => "dotmatrix-twoextended.ttf",
				],				
				"freemono" => [
					'R' => "FreeMono.ttf",
					'B' => "FreeMonoBold.ttf",
				...
				"calibri" => [
					'R' => "CalibriRegular.ttf",
					'B' => "CalibriBold.ttf",
					'I' => "CalibriItalic.ttf",
					'BI' => "CalibriBoldItalic.ttf",
				],				
