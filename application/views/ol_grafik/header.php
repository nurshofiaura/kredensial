...
<script src="<?php echo base_url();?>assets/admin/bower_components/core.js"></script>
<script src="<?php echo base_url();?>assets/admin/bower_components/charts.js"></script>
<script src="<?php echo base_url();?>assets/admin/bower_components//animated.js"></script>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-lg"><b>STATISTIK</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
	       ...
	       <li class="treeview <?php cek_aktif($page,array('wilayah_pengcab','wilayah_instansi','demografi_rs','demografi_pengcab','peta_ruangan','pengcab')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('wilayah_pengcab'));?>">
							<a href="<?php echo base_url('ol_grafik/wilayah_pengcab');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Wilayah
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('wilayah_instansi'));?>">
							<a href="<?php echo base_url('ol_grafik/wilayah_instansi');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Instansi
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('demografi_pengcab'));?>">
							<a href="<?php echo base_url('ol_grafik/demografi_pengcab');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> PerWilayah
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('pengcab'));?>">
							<a href="<?php echo base_url('ol_grafik/pengcab');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Data Wilayah
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('demografi_rs'));?>">
							<a href="<?php echo base_url('ol_grafik/demografi_rs');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Data Instansi
							</a>
						</li>
	          </ul>
	        </li>
