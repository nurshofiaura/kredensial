...
if(empty($id2)){
	...
	$peminatan = $this->m_admin_user->grafik_all_pegawai_result($select_1,$kondisi,'ope.id_status_kawin');
...
<div class="header-report">
	<div class="center">				
		...
		<?= $nama_jabatan ?>
		<h3><b>DAFTAR MARITAL STATUS</b></h3>	
	</div>
...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" colspan="2" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpeminatan['nama_status_kawin'] ?></td>
</tr>	
		<?php
if(empty($id2)){
$kondisit=array('status_pegawai'=>1,'visible'=>1,'opi.id_instansi'=>$id,'ope.id_status_kawin'=>$rowpeminatan['id_status_kawin']);
}else{
$kondisit=array('status_pegawai'=>1,'visible'=>1,'jf.id_jabatan'=>$id2,'opi.id_instansi'=>$id,'ope.id_status_kawin'=>$rowpeminatan['id_status_kawin']);
}
$noe=0;
...
<tr style="border: 1px solid black;">
  ...
  <td class="border-1" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $noe ?>. <?= $rowpegminat['nama_jabatan_fungsional'] ?></td>
</tr>	
		<?php
			}
		}
