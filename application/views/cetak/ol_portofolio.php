...
$apv = $this->m_kredensial->ambil_pengajuan_validasi_asesor($kondisi_asesor);
 ...
 $kompetensi = $this->m_ol_rancak->rkk_print_all($apk['barcode_pengajuan']);
...
<div class="content-report">
 <table class="table" style="font-size: 0.9em;">
   <tr>   
    ...
    <td style="padding: 5px;vertical-align:middle;font-weight: bold;text-align: center;" class="border-1 bg-dark">Kewenangan</td>   
   </tr>  
<?php
 $no = 0;
...
?>
  ...
  <td class="border-1" style="padding: 5px;font-weight: bold; vertical-align: top;text-align: center;"><?= $rowkomp['nama_kewenangan'] ?></td>
  </tr>
<?php
 }
?> 
...
<td class="border-1 bg-dark" rowspan="2" style="vertical-align: middle; text-align: center;padding: 5px;font-weight: bold;">Dokumen</td>
...
//$poin_indikator = htmlspecialchars_decode($poin_indikator); 
 ...
 <td class="border-1" style="vertical-align: middle;padding: 5px;"><?= $rowform2_detil['dokumen_indikator'] ?></td>
