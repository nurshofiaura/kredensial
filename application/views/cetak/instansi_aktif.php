...
$kondisi_str=array('status_pegawai'=>1,'visible'=>1,'jf.id_jabatan'=>$this->session->id_jabatan,'opi.id_instansi'=>$id_working,'status_berkas'=>1,'ol_berkas.id_kategori_berkas'=>1,'tgl_b_berkas >'=>date('Y-m-d'));
$kondisi_sip=array('status_pegawai'=>1,'visible'=>1,'jf.id_jabatan'=>$this->session->id_jabatan,'opi.id_instansi'=>$id_working,'status_berkas'=>1,'ol_berkas.id_kategori_berkas'=>2,'tgl_b_berkas >'=>date('Y-m-d'));
$kondisi_sik=array('status_pegawai'=>1,'visible'=>1,'jf.id_jabatan'=>$this->session->id_jabatan,'opi.id_instansi'=>$id_working,'status_berkas'=>1,'ol_berkas.id_kategori_berkas'=>3,'tgl_b_berkas >'=>date('Y-m-d'));
