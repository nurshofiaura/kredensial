			...
			<table class="table">
				<tbody>
					<tr>		
						...
						<td>&nbsp;</td>	
						<td width="40%" align="center" class="border-1 bg-dark">Nomor Induk</td>							
					</tr>
					<tr>						
...
<tbody>	
		<?php
		$px=0;
		$peminatan = $this->m_member->print_mhs_logbook_per_pasien($first_date,$last_date,$id_ruangan,$this->session->id_pegawai,$pxe);
		foreach($peminatan as $rowpeminatan){
			$px++;
		?>
<tr style="border: 1px solid black;">
  <td class="border-1" style="padding: 5px;vertical-align:middle;text-align:center;"><?= $rowpeminatan['tgl_logbook'] ?></td>
...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:center;">&nbsp;</td>
		...
		<?php
		$no = 0;
			$pegminat = $this->m_member->print_mhs_per_pasien($rowpeminatan['id_logbook']);
