   ...
   <table class="table">
	<thead>
		<tr style="border: 1px solid black;">
		  <th colspan="3" style="background-color: #808080;color: white;padding: 5px;font-size: 1em;vertical-align:middle;text-align:left;">TANGGAL / KATEGORI PEMERIKSAAN</th>
...
foreach (range(1, $tglakhir) as $tanggal) {
	...
	$kondisi_dlm_hari = array('tgl_logbook'=>$akhir,'id_pegawai'=>$member_id);
	$jml_dlm_hari = $this->m_umum->jumlah_record_filter('logbook',$kondisi_dlm_hari);
	if($jml_dlm_hari > 0){
	?>
		<tr style="border: 1px solid black;">
			<td colspan="2" style="padding: 5px;vertical-align:middle;text-align:left;font-weight:bold;">
			<?php echo $tanggal; ?> <?php echo $this->m_rancak->getBulan($bulan); ?> <?php echo $tahun; ?>
			</td>
			<td style="padding: 5px;font-size: 1em;vertical-align:middle;text-align:left;">RM</td>
			<td style="padding: 5px;font-size: 1em;vertical-align:middle;text-align:left;">&nbsp;</td>
		</tr>	
	<?php
	...
	foreach($ambil_range_detil as $rowambil_range_detil){
		...
		<tr style="border: 1px solid black;">
			...
			<td style="padding: 5px;font-size: 1em;vertical-align:middle;text-align:left;"><?php echo $rowambil_range_detil['rm']; ?></td>
	...
	?>
		<tr style="border: 1px solid black;">
			<td colspan="4" style="vertical-align:middle;text-align:left;font-weight:bold;">&nbsp;</td>
		</tr>	
	  </tbody>
	</table>  	
</div>
