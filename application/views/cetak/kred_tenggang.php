<?php 
	...
	if(empty($id2)){
$nama_jabatan = "";
$kondisi_aktif_str=array('status_pegawai'=>1,'status_berkas'=>1,'id_kategori_berkas'=>1,'tgl_b_berkas >='=>date('Y-m-d'),'tgl_b_berkas <='=>$dateb,'opi.id_instansi'=>$id);	
$kondisi_aktif_sip=array('status_pegawai'=>1,'status_berkas'=>1,'id_kategori_berkas'=>2,'tgl_b_berkas >='=>date('Y-m-d'),'tgl_b_berkas <='=>$dateb,'opi.id_instansi'=>$id);
$kondisi_aktif_sik=array('status_pegawai'=>1,'status_berkas'=>1,'id_kategori_berkas'=>3,'tgl_b_berkas >='=>date('Y-m-d'),'tgl_b_berkas <='=>$dateb,'opi.id_instansi'=>$id);
	}else{
	$jabatane = $this->m_umum->ambil_data('jabatan','id_jabatan',$id2);
	$nama_jabatan = "<h3><b>".$jabatane['nama_jabatan']."</b></h3>";
$kondisi_aktif_str=array('status_pegawai'=>1,'status_berkas'=>1,'id_kategori_berkas'=>1,'tgl_b_berkas >='=>date('Y-m-d'),'tgl_b_berkas <='=>$dateb,'opi.id_instansi'=>$id,'jf.id_jabatan'=>$id2);
$kondisi_aktif_sip=array('status_pegawai'=>1,'status_berkas'=>1,'id_kategori_berkas'=>2,'tgl_b_berkas >='=>date('Y-m-d'),'tgl_b_berkas <='=>$dateb,'opi.id_instansi'=>$id,'jf.id_jabatan'=>$id2);
$kondisi_aktif_sik=array('status_pegawai'=>1,'status_berkas'=>1,'id_kategori_berkas'=>3,'tgl_b_berkas >='=>date('Y-m-d'),'tgl_b_berkas <='=>$dateb,'opi.id_instansi'=>$id,'jf.id_jabatan'=>$id2);
	}

$str=$this->m_admin_user->ambil_berkas_ijin_print($kondisi_aktif_str);

$sip=$this->m_admin_user->ambil_berkas_ijin_print($kondisi_aktif_sip);

$sik=$this->m_admin_user->ambil_berkas_ijin_print($kondisi_aktif_sik);
...
<div class="header-report">
	<div class="center">				
		...
		<?= $nama_jabatan ?>
		<h3><b>DAFTAR SURAT IJIN MASA TENGGANG KURANG DARI 3 BULAN</b></h3>	
	</div>
...
<tr style="border: 1px solid black;">
  ...
  <th class="border-1 bg-dark" style="padding-left: 30px;padding-top: 5px;padding-bottom: 5px;border-left: 0px solid;vertical-align:middle;text-align:left;">Jabatan Fungsional</th>
...
<tbody>	
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" colspan="5" style="padding-left: 30px;padding-top: 5px;padding-bottom: 5px;border-left: 0px solid;vertical-align:middle;text-align:left;">STR</td>
</tr>	
		<?php
		$nostr=0;
...
<tr style="border: 1px solid black;">
  ...
  <td class="border-1" style="padding: 5px;border-left: 0px solid;vertical-align:middle;text-align:center;">
  	...
  	?>	
		...
		?>
<tr>
  <td class="border-0" colspan="5" style="padding-left: 30px;padding-top: 5px;padding-bottom: 5px;border-left: 0px solid;vertical-align:middle;text-align:left;">&nbsp;</td>
</tr>	
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" colspan="5" style="padding-left: 30px;padding-top: 5px;padding-bottom: 5px;border-left: 0px solid;vertical-align:middle;text-align:left;">SIP</td>
</tr>	
		<?php
		$nosip=0;
...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" colspan="5" style="padding-left: 30px;padding-top: 5px;padding-bottom: 5px;border-left: 0px solid;vertical-align:middle;text-align:left;">SIK</td>
</tr>	
		<?php
		$nosik=0;
...
<tr style="border: 1px solid black;">
  ...
  <td class="border-1" style="padding-left: 30px;padding-top: 5px;padding-bottom: 5px;border-left: 0px solid;vertical-align:middle;text-align:left;"><?= $rowsik['nama_jabatan_fungsional'] ?></td>
