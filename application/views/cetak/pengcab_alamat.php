<?php 
	...
	$fcolor = $adata['fcolor'];
	$color = $adata['color'];	
	$kondisi_t=array('op.id_jabatan'=>$this->session->id_jabatan,'ope.id_pengcab'=>$id_pengcab);	
...
<?php 
$kondisi_kabt=array('op.id_jabatan'=>$this->session->id_jabatan,'ope.id_pengcab'=>$id_pengcab,'ope.id_prov'=>$rowprovt['id_prov']);
...
<?php
$kondisi_kect=array('op.id_jabatan'=>$this->session->id_jabatan,'ope.id_pengcab'=>$id_pengcab,'ope.id_kab'=>$rowkabt['id_kab']);
...
<?php
$kondisi_kelt=array('op.id_jabatan'=>$this->session->id_jabatan,'ope.id_pengcab'=>$id_pengcab,'ope.id_kec'=>$rowkect['id_kec']);
...
<?php
$kelte=$this->m_ol_grafik->ambil_data_area_pegawai($id_pengcab,$rowkelt['id_kel']);
