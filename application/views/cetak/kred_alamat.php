...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" colspan="2"  style="padding-left: 5px;padding-top: 5px;padding-bottom: 5px;border-right: 0px solid;vertical-align:middle;text-align:left;">Propinsi : <?= $rowprovt['nama_prov'] ?></td>
...
<?php 
if(empty($id2)){
$kondisi_kab=array('status_pegawai'=>1,'visible'=>1,'ope.id_prov'=>$rowprovt['id_prov'],'opi.id_instansi'=>$id);
}else{
...
?>
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" colspan="2"  style="padding-left: 15px;padding-top: 5px;padding-bottom: 5px;border-right: 0px solid;vertical-align:middle;text-align:left;">Kota / Kabupaten : <?= $rowkabt['nama_kab'] ?></td>
...
<?php
if(empty($id2)){
$kondisi_kec=array('status_pegawai'=>1,'visible'=>1,'ope.id_kab'=>$rowkabt['id_kab'],'opi.id_instansi'=>$id);
}else{
...
?>
<tr style="border: 1px solid black;">
  <td colspan="2"  class="border-1 bg-dark" style="padding-left: 25px;padding-top: 5px;padding-bottom: 5px;border-right: 0px solid;vertical-align:middle;text-align:left;">Kecamatan : <?= $rowkect['nama_kec'] ?></td>
...
<?php
if(empty($id2)){
$kondisi_kel=array('status_pegawai'=>1,'visible'=>1,'ope.id_kec'=>$rowkect['id_kec'],'opi.id_instansi'=>$id);
}else{
...
?>
<tr style="border: 1px solid black;">
  <td colspan="2" class="border-1 bg-dark" style="padding-left: 35px;padding-top: 5px;padding-bottom: 5px;border-right: 0px solid;vertical-align:middle;text-align:left;"><b>Kelurahan : <?= $rowkelt['nama_kel'] ?></b></td>
...
<?php
if(empty($id2)){
$kondisi_2=array('status_pegawai'=>1,'visible'=>1,'opi.id_instansi'=>$id,'ope.id_kel'=>$rowkelt['id_kel']);
}else{
...
<td class="border-1" style="padding: 5px;vertical-align:middle;text-align:left;width: 30%;"><?= $rowkelte['nama_jabatan_fungsional'] ?></td>
</tr> 
<tr style="border: 1px solid black;">
  <td colspan="3" class="border-1" style="padding-left: 60px;padding-top: 5px;padding-bottom: 5px;border-right: 0px solid;vertical-align:middle;text-align:left;"><?= $rowkelte['alamat'] ?></td>
</tr> 
<?php
        }
      }
