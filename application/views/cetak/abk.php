...
<table class="asktable" width="100%">
	...
	<tbody>
		...
		<tr>
		  <td style="text-align:left;">&nbsp;</td>
		  <td colspan="4" style="text-align:left;">
			<table width="100%" style="font-size: 0.8em;" class="table table-border">
				<tbody>	
				<tr class="bg-dark">
				  <td style="vertical-align:middle;text-align:center;width:5%;" >No</td>
				  <td style="vertical-align:middle;text-align:center;" >HASIL KERJA</td>
				  <td style="vertical-align:middle;text-align:center;" >JUMLAH BEBAN KERJA 1 TAHUN</td>
				  <td style="vertical-align:middle;text-align:center;" >WAKTU PENYELESAIAN</td>
				  <td style="vertical-align:middle;text-align:center;" >WAKTU EFEKTIF PENYELESAIAN</td>
				  <td style="vertical-align:middle;text-align:center;" >KEBUTUHAN PEGAWAI</td>
				</tr>
				<?php						
				...
				?>
				<tr>
				  <td style="text-align:center;" >4.<?= $noa ?></td>
				  <td style="text-align:left;" ><?= $rowbutir_kegiatan_terpilih['nama_kompetensi'] ?></td>
				  <td style="text-align:right;" ><?= round($rowbutir_kegiatan_terpilih['vol1th'],0) ?></td>
				  <td style="text-align:right;" ><?= round($rowbutir_kegiatan_terpilih['wpk'],4) ?></td>
				  <td style="text-align:right;" ><?= round($rowbutir_kegiatan_terpilih['wpv'],4) ?></td>
				  <td style="text-align:right;" ><?= round($rowbutir_kegiatan_terpilih['formasi'],2) ?></td>
				</tr>
				<?php
					}
				?>			
				<tr class="bg-dark">
				  ...
				  <td style="text-align:right;" ><?= round($twvp,0) ?></td>
				  <td style="text-align:right;" ><?= round($tformasi,4) ?></td>
				</tr>
				<tr class="bg-dark">
				  <td colspan="5" style="text-align:center;" >KEBUTUHAN PEGAWAI</td>
				  <td style="text-align:right;" ><?= round($tformasi,0) ?></td>
				</tr>				
				</tbody>		  
			</table>		  
		  </td>
