...
<div class="header-report">
	<div class="center">				
		...
		<?= $nama_jabatan ?>
		<h3><b>DAFTAR SURAT IJIN EXPIRED</b></h3>	
	</div>
...
<tr style="border: 1px solid black;">
  ...
  <td class="border-1" style="padding-left: 30px;padding-top: 5px;padding-bottom: 5px;border-left: 0px solid;vertical-align:middle;text-align:left;"><?= $rowstr['nama_jabatan_fungsional'] ?></td>
...
<tr style="border: 1px solid black;">
  ...
  <td class="border-1" style="padding-left: 30px;padding-top: 5px;padding-bottom: 5px;border-left: 0px solid;vertical-align:middle;text-align:left;"><?= $rowsip['nama_jabatan_fungsional'] ?></td>
