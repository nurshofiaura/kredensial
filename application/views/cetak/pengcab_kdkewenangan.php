...
//	$ambil_peminatan=$this->m_ol_grafik->ambil_peminatan('peg.id_pengcab',$ambil_1_pengcab['id_pengcab'],'opm.id_peminatan');
	...
	$peminatan = $this->m_ol_rancak->attr_fr_pegawai($kondisi,'ope.id_kode_kewenangan');
	$pengcabe = $this->m_umum->ambil_data('ol_pengcab','id_pengcab',$id_pengcab);
?>
<div class="header-report">
	<div class="center">				
		<h3><b><?= $pengcabe['nama_pengcab'] ?></b></h3>
		<h3><b>DAFTAR PETUGAS KLINIS</b></h3>	
	</div>
...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpeminatan['nama_kode_kewenangan'] ?></td>
</tr>	
		<?php
			$kondisit=array('status_pegawai'=>1,'visible'=>1,'jf.id_jabatan'=>$this->session->id_jabatan,'ope.id_pengcab'=>$id_pengcab,'ope.id_kode_kewenangan'=>$rowpeminatan['id_kode_kewenangan']);
