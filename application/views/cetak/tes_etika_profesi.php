<?php
	...
	$fcolor = $adata['fcolor'];
	$color = $adata['color'];
	$kol_etik_detil_all = $this->m_member->kol_etik_detil_all($id);
	$etik_pegawairow_all = $this->m_member->etik_pegawairow_all($id);
	...
	$instansi = $this->m_member->ambil_data_instansi_row($etik_pegawairow_all['id_pegawai']);
?>
