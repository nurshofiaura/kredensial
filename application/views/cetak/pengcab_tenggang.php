...
$kondisi_str=array('status_pegawai'=>1,'visible'=>1,'op.id_jabatan'=>$this->session->id_jabatan,'ol_pegawai.id_pengcab'=>$id_pengcab,'status_berkas'=>1,'ol_berkas.id_kategori_berkas'=>1,'tgl_b_berkas >='=>date('Y-m-d'),'tgl_b_berkas <='=>$dateb);
$kondisi_sip=array('status_pegawai'=>1,'visible'=>1,'op.id_jabatan'=>$this->session->id_jabatan,'ol_pegawai.id_pengcab'=>$id_pengcab,'status_berkas'=>1,'ol_berkas.id_kategori_berkas'=>2,'tgl_b_berkas >='=>date('Y-m-d'),'tgl_b_berkas <='=>$dateb);
$kondisi_sik=array('status_pegawai'=>1,'visible'=>1,'op.id_jabatan'=>$this->session->id_jabatan,'ol_pegawai.id_pengcab'=>$id_pengcab,'status_berkas'=>1,'ol_berkas.id_kategori_berkas'=>3,'tgl_b_berkas >='=>date('Y-m-d'),'tgl_b_berkas <='=>$dateb);
