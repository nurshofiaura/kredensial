...
<td class="border-1 bg-dark" rowspan="2" style="vertical-align: middle; text-align: center;padding: 5px;font-weight: bold;">Indikator Ketercapaian</td>
...
<td class="border-1 bg-dark" style="vertical-align: middle; text-align: center;padding: 5px;font-weight: bold;width: 7%;">TIDAK</td>      
    ...
    foreach($grup_detil as $rowgrup_detil){
     ?>
     <tr>
<td colspan="7" class="border-1" style="font-weight: bold; vertical-align: middle;padding: 5px;"><?= $rowgrup_detil['nama_elemen'] ?></td>
     </tr>
     <?php
...
//$poin_indikator = htmlspecialchars_decode($poin_indikator); 
 ...
 <td class="border-1" style="vertical-align: middle;padding: 5px;"><?= $rowform2_detil['ketercapaian_indikator'] ?></td>
