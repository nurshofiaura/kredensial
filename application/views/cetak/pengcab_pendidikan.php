...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpeminatan['nama_pendidikan'] ?></td>
</tr>	
		<?php
			$kondisit=array('status_pegawai'=>1,'visible'=>1,'jf.id_jabatan'=>$this->session->id_jabatan,'ope.id_pengcab'=>$id_pengcab,'ope.id_pendidikan'=>$rowpeminatan['id_pendidikan']);
