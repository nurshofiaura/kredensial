...
$kondisi_str=array('status_pegawai'=>1,'visible'=>1,'op.id_jabatan'=>$this->session->id_jabatan,'ol_pegawai.id_pengcab'=>$id_pengcab,'status_berkas'=>1,'ol_berkas.id_kategori_berkas'=>1,'tgl_b_berkas >'=>date('Y-m-d'));
$kondisi_sip=array('status_pegawai'=>1,'visible'=>1,'op.id_jabatan'=>$this->session->id_jabatan,'ol_pegawai.id_pengcab'=>$id_pengcab,'status_berkas'=>1,'ol_berkas.id_kategori_berkas'=>2,'tgl_b_berkas >'=>date('Y-m-d'));
$kondisi_sik=array('status_pegawai'=>1,'visible'=>1,'op.id_jabatan'=>$this->session->id_jabatan,'ol_pegawai.id_pengcab'=>$id_pengcab,'status_berkas'=>1,'ol_berkas.id_kategori_berkas'=>3,'tgl_b_berkas >'=>date('Y-m-d'));
...
<tr style="border: 1px solid black;">
  ...
  <td class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:left;width: 15%;">Berakhir</td>
		...
		<?php
			$str = $this->m_ol_rancak->ambil_berkas_ijin_pengcab($kondisi_str);
...
<tr style="border: 1px solid black;">
  ...
  <td class="border-1" style="padding: 5px;border-left: 0px solid;vertical-align:middle;text-align:left;"><?= date('d-m-Y', strtotime($rowstr['tgl_a_berkas'])) ?></td>
  	...
  	?>
  <td class="border-1" style="padding: 5px;background-color:#DAE83C ; border-left: 0px solid;vertical-align:middle;text-align:left;">
  	<?= date('d-m-Y', strtotime($rowstr['tgl_b_berkas'])) ?>	
  </td>
  	<?php
  		}else{
  	?>
  <td class="border-1" style="padding: 5px;border-left: 0px solid;vertical-align:middle;text-align:left;">
  	<?= date('d-m-Y', strtotime($rowstr['tgl_b_berkas'])) ?>	
  </td>
  	<?php
  		}
...
<tr style="border: 1px solid black;">
  ...
  <td class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:left;">Berakhir</td>
		...
		<?php
			$sip = $this->m_ol_rancak->ambil_berkas_ijin_pengcab($kondisi_sip);
...
<tr style="border: 1px solid black;">
  ...
  <td class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:left;">Berakhir</td>
		...
		<?php
			$sik = $this->m_ol_rancak->ambil_berkas_ijin_pengcab($kondisi_sik);
