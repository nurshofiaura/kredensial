...
<div class="header-report">
	<table class="table">
		<tbody>
			<tr>	
				<td style="width:7%;">&nbsp;</td>				
				<td style="font-size: 1.2em;font-weight: bold;border-bottom:1px solid"><?= $headnya['nama_instansi']; ?></td>					
	...
	<table class="table">
		<tbody>
			...
			<tr>
				<td>&nbsp;</td>				
				<td>&nbsp;</td>						
				<td colspan="3" style="font-size: 1.2em;text-align:center;">Kepala Rumah Sakit</td>				
			</tr>		
			<tr>
				<td>&nbsp;</td>				
				<td>&nbsp;</td>							
			...
			<tr>
				<td>&nbsp;</td>				
				<td>&nbsp;</td>								
				<td colspan="3" style="font-size: 1.2em;text-align:center;"><?= $repot['pangkat'] ?>. <?= $nip ?></td>						
			</tr>
		</tbody>
	</table>
</div>