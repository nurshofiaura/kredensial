...
//	$ambil_peminatan=$this->m_ol_grafik->ambil_peminatan('peg.id_pengcab',$ambil_1_pengcab['id_pengcab'],'opm.id_peminatan');
	$kondisi=array('status_peminatan'=>1,'jf.id_jabatan'=>$this->session->id_jabatan,'opi.id_instansi'=>$id_working);
	$peminatan = $this->m_ol_rancak->peminatan_fr_opminat_instansi($kondisi,'opm.id_peminatan');
	$pengcabe = $this->m_umum->ambil_data('kol_working','id_working',$id_working);
?>
<div class="header-report">
	<div class="center">				
		<h3><b><?= $pengcabe['nama_working'] ?></b></h3>
		<h3><b>DAFTAR PEMINATAN</b></h3>	
	</div>
...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpeminatan['nama_peminatan'] ?></td>
</tr>	
		<?php
			$kondisi2=array('status_peminatan'=>1,'jf.id_jabatan'=>$this->session->id_jabatan,'opi.id_instansi'=>$id_working,'opm.id_peminatan'=>$rowpeminatan['id_peminatan']);
			$pegminat = $this->m_ol_rancak->peminatan_fr_opminat_instansi($kondisi2);
