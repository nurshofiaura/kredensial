...
//	$ambil_peminatan=$this->m_ol_grafik->ambil_peminatan('peg.id_pengcab',$ambil_1_pengcab['id_pengcab'],'opm.id_peminatan');
	...
	$peminatan = $this->m_ol_rancak->attr_fr_pegawai($kondisi,'ope.id_status_kawin');
...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpeminatan['nama_status_kawin'] ?></td>
</tr>	
		<?php
			$kondisit=array('status_pegawai'=>1,'visible'=>1,'jf.id_jabatan'=>$this->session->id_jabatan,'ope.id_pengcab'=>$id_pengcab,'ope.id_status_kawin'=>$rowpeminatan['id_status_kawin']);
