...
if(empty($id2)){
	...
	$peminatan = $this->m_admin_user->grafik_all_pegawai_result($select_1,$kondisi,'ope.id_pendidikan');
...
<tr style="border: 1px solid black;">
  <td colspan="2" class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpeminatan['nama_pendidikan'] ?></td>
</tr>	
		<?php
if(empty($id2)){
	$kondisit=array('status_pegawai'=>1,'visible'=>1,'opi.id_instansi'=>$id,'ope.id_pendidikan'=>$rowpeminatan['id_pendidikan']);
}else{
	$kondisit=array('status_pegawai'=>1,'visible'=>1,'jf.id_jabatan'=>$id2,'opi.id_instansi'=>$id,'ope.id_pendidikan'=>$rowpeminatan['id_pendidikan']);
}
$noe=0;
