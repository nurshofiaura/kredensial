...
$form = $this->m_umum->ambil_data('kol_jenis_form','id_jenis_form',4);
...
<td class="border-1 bg-dark" rowspan="2" style="vertical-align: middle; text-align: center;padding: 5px;font-weight: bold;">Poin yang di amati</td>
...
//$poin_indikator = htmlspecialchars_decode($poin_indikator); 
 ...
 <td class="border-1" style="vertical-align: middle;padding: 5px;"><?= $rowform2_detil['poin_indikator'] ?></td>
 ...
 <td class="border-1" style="vertical-align: middle;padding: 5px;text-align: center;"><?php if(!in_array($rowform2_detil['id_indikator']."_2_".$id,$kesesuaian_bukti)){ echo $gbrclist; } ?></td>
    ...
    ?>
 </table><br><b>Note : P : Pengetahuan, K = Ketrampilan, S : Sikap</b>
  <br style="line-height:1;">
 <table class="table" style="font-size: 0.9em;">
  <tr>
