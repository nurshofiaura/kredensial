...
//	$ambil_peminatan=$this->m_ol_grafik->ambil_peminatan('peg.id_pengcab',$ambil_1_pengcab['id_pengcab'],'opm.id_peminatan');
	$kondisi=array('status_peminatan'=>1,'jf.id_jabatan'=>$this->session->id_jabatan,'ope.id_pengcab'=>$id_pengcab);
	$peminatan = $this->m_ol_rancak->peminatan_fr_opminat($kondisi,'opm.id_peminatan');
...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpeminatan['nama_peminatan'] ?></td>
		...
		<?php
			$kondisi2=array('status_peminatan'=>1,'jf.id_jabatan'=>$this->session->id_jabatan,'ope.id_pengcab'=>$id_pengcab,'opm.id_peminatan'=>$rowpeminatan['id_peminatan']);
			$pegminat = $this->m_ol_rancak->peminatan_fr_opminat($kondisi2);
