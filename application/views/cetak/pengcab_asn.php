...
//	$ambil_peminatan=$this->m_ol_grafik->ambil_peminatan('peg.id_pengcab',$ambil_1_pengcab['id_pengcab'],'opm.id_peminatan');
	$kondisi=array('status_pegawai'=>1,'visible'=>1,'op.id_jabatan'=>$this->session->id_jabatan,'ope.id_pengcab'=>$id_pengcab);
	$peminatan = $this->m_ol_rancak->asn_fr_pegawai($kondisi,'ope.tipe_pegawai');
...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpeminatan['nama_status_pegawai'] ?></td>
		...
		<?php
			$kondisit=array('status_pegawai'=>1,'visible'=>1,'op.id_jabatan'=>$this->session->id_jabatan,'ope.id_pengcab'=>$id_pengcab,'ope.tipe_pegawai'=>$rowpeminatan['id_status_pegawai']);
			$pegminat = $this->m_ol_rancak->asn_fr_pegawai($kondisit);
