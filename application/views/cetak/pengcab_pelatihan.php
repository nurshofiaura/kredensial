...
//	$ambil_peminatan=$this->m_ol_grafik->ambil_peminatan('peg.id_pengcab',$ambil_1_pengcab['id_pengcab'],'opm.id_peminatan');
	$kondisi=array('b.status_berkas'=>1,'b.id_kategori_pelatihan >'=>0,'jf.id_jabatan'=>$this->session->id_jabatan,'peg.id_pengcab'=>$id_pengcab);
	$peminatan = $this->m_ol_rancak->pelatihan_fr_opinstansi($kondisi,'b.id_kategori_pelatihan');
...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpeminatan['nama_kategori_pelatihan'] ?></td>
		...
		<?php
			$kondisi2=array('b.status_berkas'=>1,'b.id_kategori_pelatihan >'=>0,'jf.id_jabatan'=>$this->session->id_jabatan,'peg.id_pengcab'=>$id_pengcab,'b.id_kategori_pelatihan'=>$rowpeminatan['id_kategori_pelatihan']);
			$pegminat = $this->m_ol_rancak->pelatihan_fr_opinstansi($kondisi2);
