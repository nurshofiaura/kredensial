...
//	$ambil_peminatan=$this->m_ol_grafik->ambil_peminatan('peg.id_pengcab',$ambil_1_pengcab['id_pengcab'],'opm.id_peminatan');
	$kondisi=array('status_pegawai'=>1,'visible'=>1,'op.id_jabatan'=>$this->session->id_jabatan,'opi.id_instansi'=>$id_working);
	$peminatan = $this->m_ol_rancak->asn_fr_pegawai_instansi($kondisi,'ope.tipe_pegawai');
	$pengcabe = $this->m_umum->ambil_data('kol_working','id_working',$id_working);
?>
<div class="header-report">
	<div class="center">				
		<h3><b><?= $pengcabe['nama_working'] ?></b></h3>
		<h3><b>DAFTAR STATUS PEGAWAI</b></h3>	
	</div>
...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpeminatan['nama_status_pegawai'] ?></td>
</tr>	
		<?php
			$kondisit=array('status_pegawai'=>1,'visible'=>1,'op.id_jabatan'=>$this->session->id_jabatan,'opi.id_instansi'=>$id_working,'ope.tipe_pegawai'=>$rowpeminatan['id_status_pegawai']);
			$pegminat = $this->m_ol_rancak->asn_fr_pegawai_instansi($kondisit);
