...
if(empty($id2)){
	...
	$peminatan = $this->m_admin_user->grafik_all_pegawai_result($select_1,$kondisi,'ope.tipe_pegawai');
...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" colspan="2" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpeminatan['nama_status_pegawai'] ?></td>
</tr>	
		<?php
if(empty($id2)){
	$kondisit=array('status_pegawai'=>1,'visible'=>1,'opi.id_instansi'=>$id,'ope.tipe_pegawai'=>$rowpeminatan['id_status_pegawai']);
}else{
	$kondisit=array('status_pegawai'=>1,'visible'=>1,'jf.id_jabatan'=>$id2,'opi.id_instansi'=>$id,'ope.tipe_pegawai'=>$rowpeminatan['id_status_pegawai']);
}
$noe=0;
