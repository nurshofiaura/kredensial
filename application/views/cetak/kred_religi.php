...
if(empty($id2)){
	...
	$peminatan = $this->m_admin_user->grafik_all_pegawai_result($select_1,$kondisi,'ope.id_agama');
...
<tr style="border: 1px solid black;">
  <td class="border-1 bg-dark" colspan="2" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpeminatan['nama_agama'] ?></td>
</tr>	
		<?php
if(empty($id2)){
	$kondisit=array('status_pegawai'=>1,'visible'=>1,'opi.id_instansi'=>$id,'ope.id_agama'=>$rowpeminatan['id_agama']);
	$nama_jabatan = "";
}else{
	$kondisit=array('status_pegawai'=>1,'visible'=>1,'jf.id_jabatan'=>$id2,'opi.id_instansi'=>$id,'ope.id_agama'=>$rowpeminatan['id_agama']);
}
...
<tr style="border: 1px solid black;">
  ...
  <td class="border-1" style="padding: 5px;vertical-align:middle;text-align:left;"><?= $rowpegminat['nama_jabatan_fungsional'] ?></td>
</tr>	
		<?php
			}
		}
