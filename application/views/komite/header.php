...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-lg"><b>KOMITE</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php cek_aktif($page,array('user','user_edit','user_tambah')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php cek_aktif($page,array('user','user_edit','user_tambah'));?>">
				<a href="<?php echo base_url('komite/user');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> User Keperawatan</a></li>
				<li class="<?php cek_aktif($page,array('pemulihan'));?>">
					<a href="<?php echo base_url('pemulihan');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pemulihan
					</a>
				</li>
       ...
       <li class="treeview <?php cek_aktif($page,array('logbook','logbook_tambah')); ?>">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('logbook','logbook_tambah'));?>">
				<a href="<?php echo base_url('komite/logbook');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Validasi Kepala Ruangan
				</a>
			</li>
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_isi','pengajuan_kompetensi_asesor')); ?>">
          <a href="#">
            <i class="fa fa-book text-<?php echo $v; ?>"></i>
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_isi','pengajuan_kompetensi_asesor'));?>">
							<a href="<?php echo base_url('komite/pengajuan_kompetensi');?>">
							<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kompetensi
							</a>
					  </li>
          </ul>
        </li>
