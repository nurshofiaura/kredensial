...
<div id="action-buttons">
  ...
  <button id="btn-setting" class="ra-btn"  data-size="btn-sm" disabled>Setting</button>
  ...
  <button id="btn-reload" class="ra-btn"  data-size="btn-sm" data-loading="random">Reload</button>
</div>
