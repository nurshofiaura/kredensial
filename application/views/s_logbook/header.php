		...
		<li class="nav-item">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">NAKES</span>
            </a>
            <ul class="dropdown-menu" style="box-shadow:10px 10px 5px grey; margin-right: 5px;">
              ...
              <li class="user-header">                
                ...
                <p>
                  NAKES
                  <small><?php 
            //      $carijabatan = $this->m_umum->ambil_data('ol_pengcab','id_pengcab',$this->session->);
             //     echo substr($this->session->); 
                ?></small>
                </p>
              </li>
              <!-- Menu Footer-->
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>NAKES</p>
          <p><small>= NAKES =</small></p>
        </div>
      </div>
      <!-- sidebar menu: : style can be found in sidebar.less -->
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">= NAKES =</li>		
				<li>
	         ...
	         <ul class="treeview-menu">
	          <li>
							<a href="<?php echo base_url('');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> 123
							</a>
						</li>
	         </ul>
	        </li>
