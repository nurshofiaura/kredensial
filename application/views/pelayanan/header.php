...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url($this->session->beranda);?>" class="logo">
      ...
      <span class="logo-lg"><b>PELAYANAN</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview <?php cek_aktif($page,array('tindakan','golongan','tindakan_tarif','asuransi','rujukan','faskes','ruangan','user','user_tambah','user_edit','akses','pelayanan')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('tindakan'));?>">
				<a href="<?php echo base_url('admin_pelayanan/tindakan');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Tindakan</a></li>
            <li class="<?php cek_aktif($page,array('tindakan_tarif'));?>">
				<a href="<?php echo base_url('admin_pelayanan/tindakan_tarif');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Tarif</a></li>
            <li class="<?php cek_aktif($page,array('asuransi'));?>">
				<a href="<?php echo base_url('admin_pelayanan/asuransi');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Cara Bayar</a></li>
            <li class="<?php cek_aktif($page,array('rujukan'));?>">
				<a href="<?php echo base_url('admin_pelayanan/rujukan');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Dokter Luar</a></li>
            <li class="<?php cek_aktif($page,array('faskes'));?>">
				<a href="<?php echo base_url('admin_pelayanan/faskes');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Faskes</a></li>			
            <li class="<?php cek_aktif($page,array('pelayanan'));?>">
				<a href="<?php echo base_url('admin_pelayanan/pelayanan');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Ruangan</a></li>
          </ul>
        </li>
      </ul>
    </section>
