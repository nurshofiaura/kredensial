    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
	       ...
	       <li class="treeview <?php cek_aktif($page,array('pegawai_struktur','pegawai_struktur_tambah','pegawai_struktur_edit','struktur','struktur_edit','struktur_tambah','instansi','instansi_edit','user','unit','registrasi','registrasi_aktifasi','user_edit','ol_akses','format_validator','direktur')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('instansi','instansi_edit'));?>">
							<a href="<?php echo base_url('ol_admin_rs/instansi');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Instansi
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('struktur','struktur_edit','struktur_tambah'));?>">
							<a href="<?php echo base_url('ol_admin_rs/struktur');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Struktur Instansi
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('pegawai_struktur','pegawai_struktur_edit','pegawai_struktur_tambah'));?>">
							<a href="<?php echo base_url('ol_admin_rs/pegawai_struktur');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Struktur Anggota / Validator
							</a>
						</li>
						<li class="<?php cek_aktif($page,array('format_validator'));?>">
							<a href="<?php echo base_url('ol_admin_rs/format_validator');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> 
									Format Validator
							</a>
						</li>	
	           <li class="<?php cek_aktif($page,array('registrasi','registrasi_aktifasi'));?>">
							<a href="<?php echo base_url('ol_admin_rs/registrasi');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Aktifasi
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('user','user_edit','ol_akses'));?>">
							<a href="<?php echo base_url('ol_admin_rs/user');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> User
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('unit'));?>">
							<a href="<?php echo base_url('ol_admin_rs/unit');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Ruangan Instansi
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('direktur'));?>">
							<a href="<?php echo base_url('ol_admin_rs/direktur');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Direktur
							</a>
						</li>
	          </ul>
	        </li>
	       <li class="treeview <?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_validasi','pengajuan_kompetensi_lihat','pengajuan_kompetensi_seting','pengajuan_kompetensi_isi_validator','pengajuan_kompetensi_form')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_validasi','pengajuan_kompetensi_lihat','pengajuan_kompetensi_seting','pengajuan_kompetensi_isi_validator','pengajuan_kompetensi_form'));?>">
							<a href="<?php echo base_url('ol_admin_rs/pengajuan_kompetensi');?>">
