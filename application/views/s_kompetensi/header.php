    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
				...
				<?php  
					if($this->session->has_userdata('has_pengurus') || $this->session->userdata('id_level')==99){
				?>
				<li class="<?php cek_aktif($page,array('validasi','validasi_isi','validasi_validasi')); ?>">">
					<a href="<?php echo base_url('ol_validasi');?>">
						<i class="fa fa-dashboard text-<?php echo $v; ?>"></i> 
							<span>Validasi Korespodensi</span>
					</a>
				</li>
				<?php  
					}
					if($this->session->has_userdata('has_struktur') || $this->session->userdata('id_level')==99){
				?>
				<li class="<?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_seting','pengajuan_kompetensi_validasi','pengajuan_kompetensi_lihat','pengajuan_kompetensi_isi_validator')); ?>">">
					<a href="<?php echo base_url('ol_kompetensi');?>">
						<i class="fa fa-dashboard text-<?php echo $v; ?>"></i> 
							<span>Validasi Kompetensi</span>
					</a>
				</li>
				<li class="<?php cek_aktif($page,array('spk','spk_upload_kredensial','spk_upload_mutu','spk_upload_etika','spk_upload_spk','spk_kelengkapan')); ?>">">
					<a href="<?php echo base_url('ol_kompetensi/spk');?>">
						<i class="fa fa-dashboard text-<?php echo $v; ?>"></i> 
							<span>Upload Data dan SPK</span>
					</a>
				</li>
				<?php  
					}
