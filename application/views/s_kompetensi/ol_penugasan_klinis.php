<?php 
	...
	$apk = $this->m_sample->ambil_pengajuan_kompetensi_spk($id);
	$kondisi=array('id_pengajuan'=>$apk['id_pengajuan']);
	$repot = $this->m_umum->ambil_data_kondisi_2tabel_row('s_pengajuan_report',$kondisi,'s_direktur','id_direktur');
	$kompetensi = $this->m_sample->ambil_kompetensi_spk($apk['id_pegawai']);
	$headnya = $this->m_umum->ambil_data('s_working','id_working',$apk['id_instansi']);
...
<div class="header-report">
	...
	<table class="table">
		<tbody>
			...
			<?php
				$kewenangan = $this->m_sample->ambil_kewenangan_spk($apk['id_pegawai'],$rowkompetensi['id_kompetensi']);				
