...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url($this->session->beranda);?>" class="logo">
      ...
      <span class="logo-lg"><b>JADWAL</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview <?php cek_aktif($page,array('elemen','pelengkap','jadwal_dinas')); ?>">
          <a href="#">
            <i class="fa fa-pencil text-<?php echo $v; ?>"></i>
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('elemen'));?>">
				<a href="<?php echo base_url('jadwal/elemen');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Elemen Dinas</a></li>
            <li class="<?php cek_aktif($page,array('pelengkap'));?>">
				<a href="<?php echo base_url('jadwal/pelengkap');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Data Pelengkap</a></li>
            <li class="<?php cek_aktif($page,array('jadwal_dinas'));?>">
				<a href="<?php echo base_url('jadwal/jadwal_dinas');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Jadwal</a></li>
          </ul>
        </li>	
      </ul>
    </section>
