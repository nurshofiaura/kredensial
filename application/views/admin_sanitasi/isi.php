...
elseif ($page=="perlakuan_limbah_tambah")
{
?>
<style>
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('admin_sanitasi/perlakuan_limbah/simpan_tambah');?>" onClick="return cek();">
       <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
...
elseif ($page=="perlakuan_limbah_edit")
{
?>
<style>
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('admin_sanitasi/perlakuan_limbah/simpan_edit');?>" onClick="return cek();">
...
elseif ($page=="sumber_emisi_tambah")
{
?>
<style>
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('admin_sanitasi/sumber_emisi/simpan_tambah');?>" onClick="return cek();">
       <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
            <h3 class="box-title"><button type="submit" class="btn btn-primary btn-xs">Submit</button></h3>
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('admin_sanitasi/sumber_emisi/simpan_edit');?>" onClick="return cek();">
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('admin_sanitasi/pengolah_limbah/simpan_tambah');?>" onClick="return cek();">
       <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
            <h3 class="box-title"><button type="submit" class="btn btn-primary btn-xs">Submit</button></h3>
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('admin_sanitasi/pengolah_limbah/simpan_edit');?>" onClick="return cek();">
...
elseif ($page=="jenis_limbah_tambah")
{
?>
<style>
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('admin_sanitasi/jenis_limbah/simpan_tambah');?>" onClick="return cek();">
       <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
            <h3 class="box-title"><button type="submit" class="btn btn-primary btn-xs">Submit</button></h3>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label>Nama</label>
                  <?php
                    input_text("nama_standar_mutu",$nama_standar_mutu,"maxlength='255' required autofocus","Ketik","text");
                  ?>
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                  <label>Status</label>
                    <?php
                      input_pdselect2("status_standar_mutu",$cmd_status,$status_standar_mutu);
                    ?>
                </div>
              </div>           
             </div>
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('admin_sanitasi/jenis_limbah/simpan_edit');?>" onClick="return cek();">
    <input type="hidden" name="id_standar_mutu" value="<?= $id; ?>">
       <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
            <h3 class="box-title"><button type="submit" class="btn btn-primary btn-xs">Submit</button></h3>
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('admin_sanitasi/limbah/simpan_tambah');?>" onClick="return cek();">
       <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
            <h3 class="box-title"><button type="submit" class="btn btn-primary btn-xs">Submit</button></h3>
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('admin_sanitasi/limbah/simpan_edit');?>" onClick="return cek();">
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('admin_sanitasi/tps/simpan_tambah');?>" onClick="return cek();">
       <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
            <h3 class="box-title"><button type="submit" class="btn btn-primary btn-xs">Submit</button></h3>
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('admin_sanitasi/tps/simpan_edit');?>" onClick="return cek();">
