...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?><?= $this->session->beranda ?>" class="logo">
      ...
      <span class="logo-lg"><b><?= $iheader ?></b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
	       ...
	       <li class="treeview <?php cek_aktif($page,array('jenis_limbah','sumber_emisi','pengolah_limbah','perlakuan_limbah','limbah','lokasi','tps')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('jenis_limbah'));?>">
							<a href="<?php echo base_url('admin_sanitasi/jenis_limbah');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kategori Indikator Mutu
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('sumber_emisi'));?>">
							<a href="<?php echo base_url('admin_sanitasi/sumber_emisi');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Sumber Pengukuran
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('tps'));?>">
							<a href="<?php echo base_url('admin_sanitasi/tps');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> TPS
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('pengolah_limbah'));?>">
							<a href="<?php echo base_url('admin_sanitasi/pengolah_limbah');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pengolah Indikator Mutu
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('perlakuan_limbah'));?>">
							<a href="<?php echo base_url('admin_sanitasi/perlakuan_limbah');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Perlakuan Indikator Mutu
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('limbah'));?>">
							<a href="<?php echo base_url('admin_sanitasi/limbah');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Indikator Mutu
							</a>
						</li>
	          </ul>
	        </li>
