...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>admin_sanitasi/<?php echo $page;?>/data/<?php echo $id;?>",
                "type" : "POST"
            },
            "columns": [
                      { "data": "id_standar_mutu", "searchable":false , "visible":false },
                      { "data": "nama_standar_mutu" },
                      { "data": "nama_jabatan", "searchable":false },
                      { "data": "status_standar_mutu", "searchable":false,
                            "render": function(data, type, row){
                                if (row.standar_mutu === '0') {
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('admin_sanitasi/'.$page.'/tambah'); ?>',function(){
                ...
                },
              {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          data = dt.rows( { selected: true } ).data()[0]['id_standar_mutu'];
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('admin_sanitasi/'.$page.'/edit/'); ?>'+data,function(){
                              $('#modal-default').modal({show:true});
                            });
                  }
              }, 
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>admin_sanitasi/<?php echo $page;?>/data",
                "type" : "POST"
            },
            "columns": [
