...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-lg"><b>PROFIL</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
				...
				<?php 
					if(empty($this->session->userdata('id_level'))){
				?>
	      <li class="treeview">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	         	...
	         	?>
	          <li>
							<a href="<?php echo base_url($rowmulti_level['link_akses']);?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> <?= $rowmulti_level['nama_ms_pengurus'] ?>
							</a>
						</li>
	         	<?php
	         		}
	        ...
	        ?>	
	       <li class="treeview <?php cek_aktif($page,array('pengajuan_surat')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('pengajuan_surat'));?>">
							<a href="<?php echo base_url('ol_surat/pengajuan_surat');?>">
