    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
	       ...
	       <li class="treeview <?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_validasi','pengajuan_kompetensi_lihat','pengajuan_kompetensi_seting','pengajuan_kompetensi_isi_validator','pengajuan_kompetensi_form','pengajuan_rkk')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_validasi','pengajuan_kompetensi_lihat','pengajuan_kompetensi_seting','pengajuan_kompetensi_isi_validator','pengajuan_kompetensi_form'));?>">
							<a href="<?php echo base_url('admin_asesor/pengajuan_kompetensi');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pengajuan Kompetensi
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('pengajuan_rkk'));?>">
							<a href="<?php echo base_url('admin_asesor/pengajuan_rkk');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pengajuan RKK
							</a>
						</li>
	          </ul>
	        </li>
