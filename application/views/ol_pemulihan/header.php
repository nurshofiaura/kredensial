...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-lg"><b>PEMULIHAN</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
				...
				?>
				<li class="<?php cek_aktif($page,array('penolakan','penolakan_pendaftaran')); ?>">">
					<a href="<?php echo base_url('ol_pemulihan/penolakan');?>">
						<i class="fa fa-dashboard text-<?php echo $v; ?>"></i> 
							<span>DAFTAR PEMULIHAN</span>
					</a>
				</li>
				<li class="<?php cek_aktif($page,array('kegiatan','kegiatan_edit','kegiatan_hasil','kegiatan_tambah')); ?>">">
					<a href="<?php echo base_url('ol_pemulihan/kegiatan');?>">
						<i class="fa fa-dashboard text-<?php echo $v; ?>"></i> 
							<span>KEGIATAN PEMULIHAN</span>
					</a>
				</li>
				<?php  
					}
				?>
					<li class="<?php cek_aktif($page,array('list_kegiatan','list_kegiatan_isi'));?>">
						<a href="<?php echo base_url('ol_kegiatan/list_kegiatan');?>">
							<i class="fa fa-dashboard text-<?php echo $v; ?>"></i> 
								<span>PROSES PEMULIHAN</span>
						</a>
					</li>
      </ul>
    </section>
