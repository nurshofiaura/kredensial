    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">ADMIN</li>		
	       ...
	       <li class="treeview <?php cek_aktif($page,array('even','acara','hasil','peserta')); ?>">
	         <a href="#">
	           <i class="fa fa-file-text text-<?php echo $v; ?>"></i>
	           <span>Even / Kegiatan</span>
	           <span class="pull-right-container">
	             <i class="fa fa-angle-left pull-right"></i>
	           </span>
	         </a>
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('even','acara','hasil','peserta'));?>">
							<a href="<?php echo base_url('admin_even/even');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Even
							</a>
						</li>
	          </ul>
	        </li>
