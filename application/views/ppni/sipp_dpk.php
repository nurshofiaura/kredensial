...
<table cellspacing="0" style="border-collapse:collapse; border:none; width:100%;">
	<tbody>
		<?php  
			foreach($dp as $rowdp){
				$tgl_lahirs	= $this->m_rancak->fullBulan(date('d-m-Y', strtotime($rowdp['tgl_lahir'])));
		?>
		<tr>
			<td style="width:25%">Nama</td>
			<td style="width:5%;text-align: center;">:</td>
			<td><?= $rowdp['nama_pegawai'] ?></td>
		</tr>
		<tr>
			<td>Tempat dan tanggal lahir</td>
			<td style="text-align: center;">:</td>
			<td><?= $rowdp['tmp_lahir'].' '.$tgl_lahirs ?></td>
		</tr>
		<tr>
			<td>Jabatan</td>
			<td style="text-align: center;">:</td>
			<td><?= $rowdp['nama_ms_pengurus'].' '.$rowdp['nama_pengcab'] ?></td>
		</tr>
		<?php 
			}
		?>
...
<br />
Adalah benar berprofesi sebagai perawat dan telah terdaftar sebagai anggota PPNI <?= $d['asal'] ?>.<br />
<br />
Surat pengantar ini dibuat untuk permohonan pembuatan Surat Rekomendasi dari PPNI <?= $d['tujuan'] ?> untuk melengkapi syarat pembuatan SIPP (Surat Ijin Praktik Perawat) yang bertempat praktik di <?= $d['nama_working'] ?><br />
<br />
