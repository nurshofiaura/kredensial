<?php
//=================================== H O M E ================================================
$arraybox = array('-primary','-secondary','-warning','-info','-danger','-success','-indigo','-lightblue','-navy','-purple','-fuchsia','-pink','-maroon','-orange','-lime','-teal','-olive','');
...
<section class="content">
  <div class="container-fluid">
    <div class="row">
        <div class="col-12">
          <div class="card card<?php echo $thenarray; ?> shadow-lg">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select class="form-control select2 select2bs4-danger" data-dropdown-css-class="select2bs4-danger" style="width: 100%;">
                          <option selected="selected">Alabama</option>
                          <option>Alaska</option>
                          <option>California</option>
                          <option>Delaware</option>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <?php
                          input_mask_date("tgl_lahir",$tgl_lahir,"Masukkan Tanggal Lahir"," required");
                        ?>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <?php
                          input_pdselect3array("jk","jk",$gender,$jk);
                        ?>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <?php
                          input_pdselect3array("id_status_kawin","id_status_kawin",$cmd_status_kawin,$id_status_kawin);
                        ?>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>Agama</label>
                        <?php
                          input_pdselect3array("id_agama","id_agama",$cmd_agama,$id_agama);
                        ?>
                      </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <?php
                          input_pdselect3array("tipe_pegawai","tipe_pegawai",$cmd_tipe_pegawai,$tipe_pegawai);
                        ?>
                      </div>
                    </div>
                    <div class="col-md-4">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <?php
                          input_pdselect23fleksibel("id_jabatan_fungsional","id_jabatan_fungsional",$cmd_jabfung,"id_jabatan_fungsional","nama_jabatan_fungsional",$id_jabatan_fungsional,"Tidak Ada Jabfung");
                        ?>
                      </div>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>DPK / DPW</label>
                        <?php
                          input_pdselect23fleksibel("id_pengcab","id_pengcab",$null_pengcab,"id_pengcab","nama_pengcab",$id_pengcab,"Tidak Termasuk");
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <?php
                          input_pdselect3array("id_pendidikan","id_pendidikan",$cmd_pendidikan,$id_pendidikan);
                        ?>
                      </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <?php
                          input_pdselect23fleksibel("id_prov","id_prov",$kol_provinsi,"id_prov","nama_prov",$id_prov,"Silahkan Pilih Provinsi Dulu");
                        ?>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <?php
                          input_pdselect3array("id_kab","id_kab",$kab,$id_kab);
                        //  echo form_dropdown('id_kab',$kab,'0',array('id'=>'id_kab','class'=>'form-control'));
                        ?>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <?php
                          input_pdselect3array("id_kec","id_kec",$kec,$id_kec);
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <?php
                          input_pdselect3array("id_kel","id_kel",$kel,$id_kel);
