...
<!-- =============================================== -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
	 ...
	 <a href="<?php echo base_url('berkas');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Berkas dan OPPE</a></li>
			...
			<li><a href="<?php echo base_url('upload');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Upload</a></li>
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('pendidikan','kategori_berkas','kategori_pelatihan')); ?>">
          <a href="#">
            <i class="fa fa-cog text-<?php echo $v; ?>"></i>
            <span>Master</span>
            <span class="pull-right-container">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('pendidikan'));?>">
				<a href="<?php echo base_url('kepegawaian/pendidikan');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pendidikan</a></li>
            <li class="<?php cek_aktif($page,array('kategori_berkas'));?>">
				<a href="<?php echo base_url('kepegawaian/kategori_berkas');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kategori Berkas</a></li>
            <li class="<?php cek_aktif($page,array('kategori_pelatihan'));?>">
				<a href="<?php echo base_url('kepegawaian/kategori_pelatihan');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kategori Pelatihan</a></li>
          </ul>
        </li>
      </ul>
    </section>
