...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url($this->session->beranda);?>" class="logo">
      ...
      <span class="logo-lg"><b>ANJAB ABK</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview <?php cek_aktif($page,array('informasi_jabatan','informasi_jabatan_pilihan','informasi_jabatan_isi','informasi_jabatan_abk','pegawai','laporan')); ?>">
          <a href="#">
      ...
      <li class="<?php cek_aktif($page,array('informasi_jabatan','informasi_jabatan_pilihan','informasi_jabatan_isi','informasi_jabatan_abk'));?>">
				<a href="<?php echo base_url('anjababk/informasi_jabatan');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Informasi Jabatan
				</a>
			</li>
      <li class="<?php cek_aktif($page,array('pegawai'));?>">
				<a href="<?php echo base_url('anjababk/pegawai');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Data Pegawai
				</a>
			</li>
          </ul>
        </li>
