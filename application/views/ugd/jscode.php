...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ugd/<?php echo $page;?>/data/<?php echo $id;?>",
                "type" : "POST"
            },
            "columns": [
                    {
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('ugd/'.$page.'/edit/'); ?>'+data,function(){
...
$("#last_date").inputmask("datetime", {
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ugd/<?php echo $page;?>/data/<?php echo $first_date;?>/<?php echo $last_date;?>/<?php echo $key;?>",
                "type" : "POST"
            },
            "columns": [
                    {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        if( statusps=='Batal'){
                            swal({
	                      	...
	                      	location.href = '<?php echo base_url('ugd/'.$page.'/tambah/'); ?>'+data;
						}
                    }
                },
              {
...
?>
function load_pmr() {
  $('.pemeriksaane').load('<?php echo base_url('ugd/daftar/pemeriksaane/'); ?><?php echo $first_date; ?>');
}
$(document).ready(function() {
  $('.select2').select2()
...
?>
    ...
    $(document).ready(function() {
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ugd/daftar/hasil_lab_all/<?php echo $first_date;?>",
                "type" : "POST"
            },
            "columns": [
                    {
            ...
            "buttons": [
                {
                  ...
                  className: "btnteal",
                    action: function ( e, dt, node, config ) {
                        ...
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('ugd/daftar/lab_view/'); ?>'+data,function(){
                            $('#modal-default').modal({show:true});
                          });
...
?>
function load_data() {
  $('.tabelpenunjang').load('<?php echo base_url('ugd/daftar/tabelpenunjang/'); ?><?php echo $first_date; ?>');
}
$(document).ready(function() {
  $('.select2').select2()
    $('a[data-toggle="tab"]').on( 'shown.bs.tab', function (e) {
...
elseif ($page=="daftar_asuhan" || $page=="daftar_data_asuhan")
{
?>
$(document).ready(function() {
  $('.select2').select2()
  ...
  '<tr> <td>Hasil Ro:</td><td>'+d.hasil_radiologi_result+'</td> </td><td></td><td>Kesimpulan Ro:</td><td>'+d.kesimpulan_radiologi_result+'</td> </tr>'+
    ...
    $(document).ready(function() {
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ugd/daftar/radiolog/<?php echo $first_date;?>",
                "type" : "POST"
            },
            "columns": [
                    {
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ugd/daftar/histori/<?php echo $first_date;?>",
                "type" : "POST"
            },
            "columns": [
                    {
            ...
            "buttons": [
                {
                  ...
                  className: "btnfuchsia",
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_pendaftaran_unit']; 
						window.open('<?php echo base_url('ugd/daftar/data_ps/'); ?>'+data);
                    }
                },
              {
                    text: "<i class='fa fa-refresh'></i> Reload",
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ugd/daftar/penunjang/<?php echo $first_date;?>",
                "type" : "POST"
            },
            "columns": [
                    {
...
?>
    ...
    $(document).ready(function() {
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ugd/daftar/sparkling/<?php echo $first_date;?>",
                "type" : "POST"
            },
            "columns": [
                    {
...
elseif ($page=="daftar_grafik_vitalxx")
{
?>
...
chart.dateFormatter.inputDateFormat = "dd-MM-yyyy HH:mm:ss"
    chart.data = [
    <?php
    foreach($grafik_garis as $rowgrafik_garis_opsi){
    ?>
    {
 //     "year": <?php echo '"'.$rowgrafik_garis_opsi['waktu_pemeriksaan_vital'].'"'; ?>,
      "year": new Date(<?= $rowgrafik_garis_opsi['thn'] ?>, <?= $rowgrafik_garis_opsi['bln'] ?>-1, <?= $rowgrafik_garis_opsi['hr'] ?>, <?= $rowgrafik_garis_opsi['jam'] ?>, <?= $rowgrafik_garis_opsi['mnt'] ?>, <?= $rowgrafik_garis_opsi['dtk'] ?>),
      <?php
      $jsonx = $this->m_ol_rancak->grafik_garis_hasil($rowgrafik_garis_opsi['waktu_pemeriksaan_vital'],$first_date);
      foreach($jsonx as $row2){
      ?>
     		"sistole":<?php echo $row2['sistole']; ?>,
     		"diastole":<?php echo $row2['diastole']; ?>,
     		"rr":<?php echo $row2['rr']; ?>,
     		"nadi":<?php echo $row2['nadi']; ?>,
     		"suhu":<?php echo $row2['suhu']; ?>,
     		"spo2":<?php echo $row2['spo2']; ?>,
      <?php
      }
      ?>
    },
 ...
 //   chart.dateFormatter.dateFormat = "dd-MM-yyyy H:i:s";
...
dateAxis.periodChangeDateFormats.setKey("year", "MMM-yy");
dateAxis.dateFormats.setKey("month", "MMM-yy");
dateAxis.dateFormats.setKey("year", "MMM-yy");*/
/*  dateAxis.dateFormats.setKey("hour", "dd-mm-YYYY, H:mm");
  dateAxis.periodChangeDateFormats.setKey("hour", "dd-mm-YYYY, H:mm");*/
// Set date label formatting
/*chart.dateFormatter.dateFormat = "dd-MM-yyyy";
dateAxis.periodChangeDateFormats.setKey("second", "[bold]dd-MM-yyyy");*/

/*chart.dateFormatter.intlLocales = "de-DE";
...
//  series.dateFormatter.dateFormat = "DD-MM-YYYY, JJ:NN:SS";
//  series.legendSettings.valueText = "{valueY}";
  ...
  bullet.circle.strokeWidth = 2;
	...
	createSeriesAndAxis("sistole", "Sistole", true, true);
	createSeriesAndAxis("diastole", "Diastole", true, true);
	createSeriesAndAxis("rr", "Resp Rate", true, true);
	createSeriesAndAxis("nadi", "Nadi", true, true);
	createSeriesAndAxis("suhu", "Suhu", true, true);
	createSeriesAndAxis("spo2", "Spo2", true, true);
...
/*    chart.exporting.menu = new am4core.ExportMenu();
    ...
    title.text = "GRAFIK VITAL SIGN";
    title.fontSize = 18;
    title.tooltipText = "GRAFIK VITAL SIGN";
