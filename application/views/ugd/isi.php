...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('ugd/lobby/simpan_edit');?>" onClick="return cek();">
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="<?php echo base_url('ugd/daftar/tambah/'.$first_date);?>">Pemeriksaan</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li class="active"><a href="<?php echo base_url('ugd/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('ugd/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li class="active"><a href="<?php echo base_url('ugd/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
              <li class="pull-right"><h3><i class="fa fa-server"></i> E REKAM MEDIS</h3></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="<?php echo base_url('ugd/daftar/tambah/'.$first_date);?>">Pemeriksaan</a></li>
              <li class="active"><a href="<?php echo base_url('ugd/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('ugd/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li class="active"><a href="<?php echo base_url('ugd/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('ugd/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li class="active"><a href="<?php echo base_url('ugd/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
              <li class="pull-right"><h3><i class="fa fa-server"></i> E REKAM MEDIS</h3></li>
            </ul>
            <div class="tab-content">
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="<?php echo base_url('ugd/daftar/tambah/'.$first_date);?>">Pemeriksaan</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li class="active"><a href="<?php echo base_url('ugd/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('ugd/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li class="active"><a href="<?php echo base_url('ugd/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
              <li class="pull-right"><h3><i class="fa fa-server"></i> E REKAM MEDIS</h3></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active">
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('ugd/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li class="active"><a href="<?php echo base_url('ugd/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="<?php echo base_url('ugd/daftar/tambah/'.$first_date);?>">Pemeriksaan</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('ugd/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              ...
              <div class="tab-pane active">
                <div class="nav-tabs-custom">
                  <ul class="nav nav-tabs pull-right">
                    <li class="active"><a href="<?php echo base_url('ugd/daftar/tambah/'.$first_date);?>">Pendaftaran</a></li>
                    <li><a href="<?php echo base_url('ugd/daftar/penunjang_luar/'.$first_date);?>" >Penunjang dari Luar</a></li>
                    <li><a href="<?php echo base_url('ugd/daftar/vital_sign/'.$first_date);?>" >Pemeriksaan Vital Sign</a></li>
                    <li><a href="<?php echo base_url('ugd/daftar/asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                <div class="nav-tabs-custom">
                  <ul class="nav nav-tabs pull-right">
                    <li><a href="<?php echo base_url('ugd/daftar/tambah/'.$first_date);?>">Pendaftaran</a></li>
                    <li class="active"><a href="<?php echo base_url('ugd/daftar/penunjang_luar/'.$first_date);?>" >Penunjang dari Luar</a></li>
                    <li><a href="<?php echo base_url('ugd/daftar/vital_sign/'.$first_date);?>" >Pemeriksaan Vital Sign</a></li>
                    <li><a href="<?php echo base_url('ugd/daftar/asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
                    <li class="pull-left header"><i class="fa fa-money"></i> Billing</li>
                  </ul>
              ...
              <div class="tab-pane active" id="tab_1">
                <div class="nav-tabs-custom">
                  <ul class="nav nav-tabs pull-right">
                    <li><a href="<?php echo base_url('ugd/daftar/tambah/'.$first_date);?>">Pendaftaran</a></li>
                    <li><a href="<?php echo base_url('ugd/daftar/penunjang_luar/'.$first_date);?>" >Penunjang dari Luar</a></li>
                    <li class="active"><a href="<?php echo base_url('ugd/daftar/vital_sign/'.$first_date);?>" >Pemeriksaan Vital Sign</a></li>
                    <li><a href="<?php echo base_url('ugd/daftar/asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
                    <li class="pull-left header"><i class="fa fa-money"></i> Billing</li>
                  </ul>
                  <div class="tab-content">
                    <div class="tab-pane active" id="datavital">
                      <?php echo form_open_multipart('Ugd/daftar/vital_sign/'.$first_date,'  '); // id = id_pasien
                      input_text("barcode_pendaftaran_unit",$barcode_pendaftaran_unit,"","","hidden");
                      ?>
                      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
                        <div class="box-header with-border">
                           <h3 class="box-title">PEMERIKSAAN VITAL SIGN DAN FISIK</h3>
                        ...
                        <div class="box-body">
                <div class="box-header with-border">
                   <div class="box-title">No Pendaftaran : <?= $no_pendaftaran ?></div>
                      <p>Tanggal Periksa : <?= $this->m_rancak->fullBulan(date('d-m-Y', strtotime($tgl_pendaftaran_unit))); ?><br>
                      Keluhan : <?= $keluhan ?><br>
                      Keterangan : <?= $ket_pendaftaran_unit ?></p>
                      <div class="box-tools pull-right">
                      <p>Cara Bayar : <?= $nama_bayar ?><br>
                      Pengirim : <?= $nama_instansi ?> <?= $nama_dokter ?><br>
                      Admin : <?= $nama_pegawai ?></p>
                      </div>
                </div>
                            <div class="row">
                              <div class="col-md-8">
                                <div class="col-md-2">
                                  ...
                                  <label>Sistole</label>
                                  <?php
                                    input_textcustom("sistole",$sistole,"style='text-align:right;' required maxlength='3'
                                          onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control'",
                                              "Angka","text");
                                  ?>     
                                  <label>Diastole</label>
                                  <?php
                                    input_textcustom("diastole",$diastole,"style='text-align:right;' required maxlength='3'
                                          onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control'",
                                              "Angka","text");
                                  ?>   
                                  <label>Resp Rate</label>
                                  <?php
                                    input_textcustom("rr",$rr,"style='text-align:right;' required maxlength='3'
                                          onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control'",
                                              "Angka","text");
                                  ?>                 
                                  <label>Nadi</label>
                                  <?php
                                    input_textcustom("nadi",$nadi,"style='text-align:right;' required maxlength='3'
                                          onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control'",
                                              "Angka","text");
                                  ?>            
                                  <label>Suhu</label>
                                  <?php
                                    input_textcustom("suhu",$suhu,"style='text-align:right;' required maxlength='3'
                                          onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control'",
                                              "Angka","text");
                                  ?>   
                                  <label>Spo2</label>
                                  <?php
                                    input_textcustom("spo2",$spo2,"style='text-align:right;' required maxlength='3'
                                          onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control'",
                                              "Angka","text");
                                  ?> 
                                </div>  
                                <div class="col-md-4">
                                  ...
                                  <label>GCS Eye</label>
                                  <?php
                                    input_pdselect2("id_gcs_eye",$gcs_eye,$id_gcs_eye);
                                  ?>     
                                  <label>GCS Motorik</label>
                                  <?php
                                    input_pdselect2("id_gcs_motorik",$gcs_motorik,$id_gcs_motorik);
                                  ?>    
                                  <label>GCS Verbal</label>
                                  <?php
                                    input_pdselect2("id_gcs_verb",$gcs_verb,$id_gcs_verb);
                                  ?>        
                                  <label>Jalan Napas</label>
                                  <?php
                                    input_pdselect2("id_jalan_napas",$jalan_napas,$id_jalan_napas);
                                  ?>     
                                  <label>Pernapasan</label>
                                  <?php
                                    input_pdselect2("id_pernapasan",$pernapasan,$id_pernapasan);
                                  ?>    
                                  <label>Nutrisi</label>
                                  <?php
                                    input_pdselect2("id_nutrisi",$nutrisi,$id_nutrisi);
                                  ?>        
                                  <label>Skala Geriatri</label>
                                  <?php
                                    input_pdselect2("id_geriatri",$geriatri,$id_geriatri);
                                  ?>     
                                </div>     
                                <div class="col-md-3">
                                  <label>Skala Edmonson</label>
                                  <?php
                                    input_pdselect2("id_edmonson",$edmonson,$id_edmonson);
                                  ?>     
                                  <label>Skala Morse</label>
                                  <?php
                                    input_pdselect2("id_morse",$morse,$id_morse);
                                  ?>    
                                  <label>Skala Humpty Dumpty</label>
                                  <?php
                                    input_pdselect2("id_hd",$hd,$id_hd);
                                  ?>        
                                  <label>Skala Nyeri</label>
                                  <?php
                                    input_pdselect2("id_nyeri",$nyeri,$id_nyeri);
                                  ?>     
                                  <label>Lokasi Nyeri</label>
                                  <?php
                                    input_text("nyeri_lokasi",$nyeri_lokasi,"maxlength='255' ","Ketik","text");
                                  ?>     
                                  <label>Nyeri Hilang Bila</label>
                                  <?php
                                    input_text("nyeri_hilang",$nyeri_hilang,"maxlength='255' ","Ketik","text");
                                  ?>    
                                  <label>Riwayat Alergi</label>
                                  <?php
                                    input_text("riwayat_alergi",$riwayat_alergi,"maxlength='255' ","Ketik","text");
                                  ?>        
                                  <label>Masalah Dalam Berbicara</label>
                                  <?php
                                    input_text("talk_problem",$talk_problem,"maxlength='255' ","Ketik","text");
                                  ?>     
                                </div>    
                                <div class="col-md-3">
                                  <label>Jenis Kasus</label>
                                  <?php
                                    checkboxflatred("kasus","kasus[]",$kol_kasus,"id_kasus","nama_kasus",$kasus,"flat-red","<br>","","array");
                                  ?>        
                                  <label>Sirkulasi</label>
                                  <?php
                                    checkboxflatred("sirkulasi","sirkulasi[]",$kol_sirkulasi,"id_sirkulasi","nama_sirkulasi",$sirkulasi,"minimal","<br>","","array");
                                  ?>        
                                  <label>Respon</label>
                                  <?php
                                    checkboxflatred("respon","respon[]",$kol_respon,"id_respon","nama_respon",$respon,"minimal-red","<br>","","array");
                                  ?> 
                                  <label>Triase</label>
                  <select  name="id_triase" class="form-control s1">
                  <?php
                    foreach($kol_triase as $rowback){
                      $selected = ($id_triase == $rowback['id_triase'] ? 'selected="selected"' : '');
                  ?>
                    <option value="<?= $rowback['id_triase'] ?>" style="background-color:<?= $rowback['warna_triase'] ?>;" warna="<?= $rowback['warna_triase'] ?>" <?= $selected ?>>
                      <?php echo $rowback['nama_triase']; ?>
                    </option>
                  <?php
                    }
                  ?>
                                      ...
                                      <?php
                                 //       input_pdselect2("id_triase",$kol_triase,$id_triase);
                                      ?>         
                                </div> 
                              </div> 
                              <div class="col-md-4">
                                <label>Keterangan</label>
                                <?php
                                  input_textareacustom("ket_pemeriksaan_vital_sign",$ket_pemeriksaan_vital_sign," id='editor1' rows='3' cols='20' class='form-control' ","Keterangan");
                                ?>        
                              </div>
                            </div>
                        </div>
...
ul {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
              ...
              <div class="tab-pane active" id="tab_1">
                <div class="nav-tabs-custom">
                  <ul class="nav nav-tabs pull-right">
                    ...
                    <li><a href="<?php echo base_url('ugd/daftar/penunjang_luar/'.$first_date);?>" >Penunjang dari Luar</a></li>
                    <li><a href="<?php echo base_url('ugd/daftar/vital_sign/'.$first_date);?>" >Pemeriksaan Vital Sign</a></li>
                    <li class="active"><a href="<?php echo base_url('ugd/daftar/asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
                    <li class="pull-left header"><i class="fa fa-money"></i> Billing</li>
                  </ul>
                  <div class="tab-content">
                    <div class="tab-pane active" id="datavital">
                      <?php echo form_open_multipart('ugd/daftar/asuhan/'.$first_date,'  '); // id = id_pasien
                      input_text("barcode_pendaftaran_unit",$barcode_pendaftaran_unit,"","","hidden");
                      ?>
                      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
                        <div class="box-header with-border">
                           <h3 class="box-title">ASUHAN KEPERAWATAN</h3>
      ...
      foreach($asuhan_pengkajian_1 as $rowasuhan_kategori_1){
        $asuhan_kaji_detil_1 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_1['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_1,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array");  
      }       
      ?>                
                </td>
                <td style="border-color: black;vertical-align:middle;padding:5px;width:1%;border-right:0;border-top:none;">&nbsp;</td>
      ...
      <?php
        $asuhan_mas_detil_1 = $this->m_ol_rancak->asuhan_masalah_detil($rowasuhan_masalah_1['id_masalah']);
        checkboxflatred("id_mas_detil","id_mas_detil[]",$asuhan_mas_detil_1,"id_mas_detil","nama_mas_detil",$id_mas_detil,"flat-red","<br>","","array");  
      }
      ?>
                </td>
                <td style="border-color: black;vertical-align:middle;padding:5px;width:1%;border-right:0;border-top:none;">&nbsp;</td>
      ...
      foreach($asuhan_implementasi_1 as $rowasuhan_implementasi_1){
        $asuhan_imp_detil_1 = $this->m_ol_rancak->asuhan_implementasi_detil($rowasuhan_implementasi_1['id_implementasi']);
        checkboxflatred("id_imp_detil","id_imp_detil[]",$asuhan_imp_detil_1,"id_imp_detil","nama_imp_detil",$id_imp_detil,"flat-red","<br>","","array");  
      }
      ?>                
                </td>
                </tr>
      ...
      ?>
                ...
                <div class="col-sm-4">
                  ...
                  <label>RR</label>
                  <?php
                      input_textcustom("rr_asuhan",$rr_asuhan,"style='text-align:right;' required maxlength='3'
                            onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control'",
                                "Angka","text");
                  ?>  
                  </div>
                ...
                <div class="col-sm-6">
                  ...
                  <label>RR</label><br>
                  <?php
                    input_pdselect2("rr_ritme",$array_rr_ritme,$rr_ritme);
                  ?>  
                  </div>
                </div>
                <div class="col-sm-12">
      ...
      foreach($asuhan_pengkajian_2 as $rowasuhan_kategori_2){
        $asuhan_kaji_detil_2 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_2['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_2,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array");  
      }       
      ?>                
                </div>
                </div>
      ...
      <?php
        $asuhan_mas_detil_2 = $this->m_ol_rancak->asuhan_masalah_detil($rowasuhan_masalah_2['id_masalah']);
        checkboxflatred("id_mas_detil","id_mas_detil[]",$asuhan_mas_detil_2,"id_mas_detil","nama_mas_detil",$id_mas_detil,"flat-red","<br>","","array");  
      }
      ?>                
                </td>
                <td style="border-color: black;vertical-align:middle;padding:5px;width:1%;border-right:0;border-top:none;">&nbsp;</td>
      ...
      foreach($asuhan_implementasi_2 as $rowasuhan_implementasi_2){
        $asuhan_imp_detil_2 = $this->m_ol_rancak->asuhan_implementasi_detil($rowasuhan_implementasi_2['id_implementasi']);
        checkboxflatred("id_imp_detil","id_imp_detil[]",$asuhan_imp_detil_2,"id_imp_detil","nama_imp_detil",$id_imp_detil,"flat-red","<br>","","array");  
      }
      foreach($asuhan_implementasi_3 as $rowasuhan_implementasi_3){
        echo $rowasuhan_implementasi_3['nama_implementasi']; ?><br style="margin-bottom: 0.5em;"> 
      <?php
        $asuhan_imp_detil_3 = $this->m_ol_rancak->asuhan_implementasi_detil($rowasuhan_implementasi_3['id_implementasi']);
        checkboxflatred("id_imp_detil","id_imp_detil[]",$asuhan_imp_detil_3,"id_imp_detil","nama_imp_detil",$id_imp_detil,"flat-red","<br>","","array");  
      }
      ?>      
                  <div class="form-group">
                  <label>Volume Pemberian Oksigen</label>
                  <?php
                    input_text("breathingo2",$breathingo2,"maxlength='255' ","","text");
                  ?>  
                  </div>    
                </td>
                </tr>
      ...
      foreach($asuhan_pengkajian_3 as $rowasuhan_kategori_3){
        $asuhan_kaji_detil_3 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_3['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_3,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array");  
      }   
      foreach($asuhan_pengkajian_4 as $rowasuhan_kategori_4){
        echo $rowasuhan_kategori_4['nama_pengkajian']; ?><br style="margin-bottom: 0.5em;"> <?php
        $asuhan_kaji_detil_4 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_4['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_4,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array");  
      }     
      foreach($asuhan_pengkajian_5 as $rowasuhan_kategori_5){
        echo $rowasuhan_kategori_5['nama_pengkajian']; ?><br style="margin-bottom: 0.5em;"> 
                <div class="row">
                  <div class="col-sm-4">
                    ...
                    <label>Sistole</label>
                    <?php
                      input_textcustom("sistole_asuhan",$sistole_asuhan,"style='text-align:right;' required maxlength='3'
                            onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control'",
                                "Angka","text");
                    ?>  
                    </div>
                  ...
                  <div class="col-sm-4">
                    ...
                    <label>Diastole</label>
                    <?php
                      input_textcustom("diastole_asuhan",$diastole_asuhan,"style='text-align:right;' required maxlength='3'
                            onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control'",
                                "Angka","text");
                    ?>  
                    </div>
      ...
      <?php
        $asuhan_kaji_detil_5 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_5['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_5,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array");  
      }       
      ?>      
                  </div>
                </div>
      ...
      foreach($asuhan_pengkajian_6 as $rowasuhan_kategori_6){
        echo $rowasuhan_kategori_6['nama_pengkajian']; ?><br style="margin-bottom: 0.5em;"> <?php
        $asuhan_kaji_detil_6 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_6['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_6,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array");  
      }   
      foreach($asuhan_pengkajian_7 as $rowasuhan_kategori_7){
        echo $rowasuhan_kategori_7['nama_pengkajian']; ?><br style="margin-bottom: 0.5em;"> <?php
        $asuhan_kaji_detil_7 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_7['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_7,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array");  
      }     
      foreach($asuhan_pengkajian_8 as $rowasuhan_kategori_8){
        echo $rowasuhan_kategori_8['nama_pengkajian']; ?><br style="margin-bottom: 0.5em;"> <?php
        $asuhan_kaji_detil_8 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_8['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_8,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array");  
      }     
      foreach($asuhan_pengkajian_9 as $rowasuhan_kategori_9){
        echo $rowasuhan_kategori_9['nama_pengkajian']; ?><br style="margin-bottom: 0.5em;"> <?php
        $asuhan_kaji_detil_9 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_9['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_9,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array");  
      }       
      ?>
                </td>
                <td style="border-color: black;vertical-align:middle;padding:5px;width:1%;border-right:0;border-top:none;">&nbsp;</td>
      ...
      <?php
        $asuhan_mas_detil_3 = $this->m_ol_rancak->asuhan_masalah_detil($rowasuhan_masalah_3['id_masalah']);
        checkboxflatred("id_mas_detil","id_mas_detil[]",$asuhan_mas_detil_3,"id_mas_detil","nama_mas_detil",$id_mas_detil,"flat-red","<br>","","array");  
      }
      ...
      <?php
        $asuhan_mas_detil_4 = $this->m_ol_rancak->asuhan_masalah_detil($rowasuhan_masalah_4['id_masalah']);
        checkboxflatred("id_mas_detil","id_mas_detil[]",$asuhan_mas_detil_4,"id_mas_detil","nama_mas_detil",$id_mas_detil,"flat-red","<br>","","array");  
      }
      ?>      
                </td>
                <td style="border-color: black;vertical-align:middle;padding:5px;width:1%;border-right:0;border-top:none;">&nbsp;</td>
      ...
      <?php
        $asuhan_imp_detil_4 = $this->m_ol_rancak->asuhan_implementasi_detil($rowasuhan_implementasi_4['id_implementasi']);
        checkboxflatred("id_imp_detil","id_imp_detil[]",$asuhan_imp_detil_4,"id_imp_detil","nama_imp_detil",$id_imp_detil,"flat-red","<br>","","array");  
      }
      foreach($asuhan_implementasi_5 as $rowasuhan_implementasi_5){
        echo $rowasuhan_implementasi_5['nama_implementasi']; ?><br style="margin-bottom: 0.5em;"> 
      <?php
        $asuhan_imp_detil_5 = $this->m_ol_rancak->asuhan_implementasi_detil($rowasuhan_implementasi_5['id_implementasi']);
        checkboxflatred("id_imp_detil","id_imp_detil[]",$asuhan_imp_detil_5,"id_imp_detil","nama_imp_detil",$id_imp_detil,"flat-red","<br>","","array");  
      }
      ?>                  
                </td>
                </tr>
      ...
      foreach($asuhan_pengkajian_10 as $rowasuhan_kategori_10){
        echo $rowasuhan_kategori_10['nama_pengkajian']; 
        $asuhan_kaji_detil_10 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_10['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_10,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array"); 
      }     
      ?>      
                  </div><br>
                  <div class="col-sm-6">
                    <label>Eye  (Skor Normal : 4)</label><br>
                    <?php
                      input_pdselect2("eye_asuhan",$kol_gcs_eye,$eye_asuhan);
                    ?>  
                  </div>
                  <div class="col-sm-6">
                    <label>Motorik  (Skor Normal : 6)</label>
                    <?php
                      input_pdselect2("motorik_asuhan",$kol_gcs_motorik,$motorik_asuhan);
                    ?>  
                  </div>
                  <div class="col-sm-6">
                    <label>Verbal (Skor Normal : 5)</label>
                    <?php
                      input_pdselect2("verbal_asuhan",$kol_gcs_verb,$verbal_asuhan);
                    ?>  
                  </div>  
                  <div class="col-sm-3">
                    <label>GCS</label>
                    <?php
                      input_textcustom("gcs_asuhan",$gcs_asuhan,"style='text-align:right;' required maxlength='3'
                            onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control'",
                                "Angka","text");
                    ?>  
                  </div>
      ...
      ?>
                    ...
                    <label>&nbsp;&nbsp;Diameter Pupil</label>
                    <?php
                      input_textcustom("diameter_pupil",$diameter_pupil,"style='text-align:right;' required maxlength='3'
                            onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control'",
                                "Angka","text");
                    ?>  
                  </div>                    
      ...
      foreach($asuhan_pengkajian_11 as $rowasuhan_kategori_11){
        $asuhan_kaji_detil_11 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_11['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_11,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array"); 
      }     
      ?>      
                  </div>
                  <div class="col-sm-12">
      ...
      <?php
        $asuhan_kaji_detil_12 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_12['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_12,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array"); 
      }     
      ?>      
                  </div>
                  <div class="col-sm-12">
                  ...
                  <div class="col-sm-5">
                    <div class="form-group">                
                    <label>Ext Atas</label>
                    <?php
                      input_text("ext_atas",$ext_atas,"maxlength='255' ","","text");
                    ?>  
                    </div>
                  </div>  
                  <div class="col-sm-5">
                    <div class="form-group">                
                    <label>Ext Bawah</label>
                    <?php
                      input_text("ext_bawah",$ext_bawah,"maxlength='255' ","","text");
                    ?>  
                    </div>
                  </div>
                </div>              
      ...
      <?php
        $asuhan_mas_detil_5 = $this->m_ol_rancak->asuhan_masalah_detil($rowasuhan_masalah_5['id_masalah']);
        checkboxflatred("id_mas_detil","id_mas_detil[]",$asuhan_mas_detil_5,"id_mas_detil","nama_mas_detil",$id_mas_detil,"flat-red","<br>","","array");  
      }
      ?>                    
                </td>
                <td style="border-color: black;vertical-align:middle;padding:5px;width:1%;border-right:0;border-top:none;">&nbsp;</td>
      ...
      <?php
        $asuhan_imp_detil_6 = $this->m_ol_rancak->asuhan_implementasi_detil($rowasuhan_implementasi_6['id_implementasi']);
        checkboxflatred("id_imp_detil","id_imp_detil[]",$asuhan_imp_detil_6,"id_imp_detil","nama_imp_detil",$id_imp_detil,"flat-red","<br>","","array");  
      }
      ?>
      <div class="form-group">                
      <label>GCS</label>
      <?php
        input_text("disabilitygcs",$disabilitygcs,"maxlength='255' ","","text");
      ?>  
      </div>      
      <?php
      foreach($asuhan_implementasi_7 as $rowasuhan_implementasi_7){
      ...
      <?php
        $asuhan_imp_detil_7 = $this->m_ol_rancak->asuhan_implementasi_detil($rowasuhan_implementasi_7['id_implementasi']);
        checkboxflatred("id_imp_detil","id_imp_detil[]",$asuhan_imp_detil_7,"id_imp_detil","nama_imp_detil",$id_imp_detil,"flat-red","<br>","","array");  
      }
      ?>  
      <div class="form-group">                
      <label>Volume Pemberian Oksigen</label>
      <?php
        input_text("disabilityo2",$disabilityo2,"maxlength='255' ","","text");
      ?>  
      </div>        
                </td>
                </tr>
      ...
      foreach($asuhan_pengkajian_13 as $rowasuhan_kategori_13){
        $asuhan_kaji_detil_13 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_13['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_13,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array"); 
      }       
      ?>                
                </td>
                <td style="border-color: black;vertical-align:middle;padding:5px;width:1%;border-right:0;border-top:none;">&nbsp;</td>
      ...
      <?php
        $asuhan_mas_detil_6 = $this->m_ol_rancak->asuhan_masalah_detil($rowasuhan_masalah_6['id_masalah']);
        checkboxflatred("id_mas_detil","id_mas_detil[]",$asuhan_mas_detil_6,"id_mas_detil","nama_mas_detil",$id_mas_detil,"flat-red","<br>","","array");  
      }
      ...
      <?php
        $asuhan_mas_detil_7 = $this->m_ol_rancak->asuhan_masalah_detil($rowasuhan_masalah_7['id_masalah']);
        checkboxflatred("id_mas_detil","id_mas_detil[]",$asuhan_mas_detil_7,"id_mas_detil","nama_mas_detil",$id_mas_detil,"flat-red","<br>","","array");  
      }
      ...
      <?php
        $asuhan_mas_detil_8 = $this->m_ol_rancak->asuhan_masalah_detil($rowasuhan_masalah_8['id_masalah']);
        checkboxflatred("id_mas_detil","id_mas_detil[]",$asuhan_mas_detil_8,"id_mas_detil","nama_mas_detil",$id_mas_detil,"flat-red","<br>","","array");  
      }
      ?>                  
                </td>
                <td style="border-color: black;vertical-align:middle;padding:5px;width:1%;border-right:0;border-top:none;">&nbsp;</td>
      ...
      foreach($asuhan_implementasi_8 as $rowasuhan_implementasi_8){
        $asuhan_imp_detil_8 = $this->m_ol_rancak->asuhan_implementasi_detil($rowasuhan_implementasi_8['id_implementasi']);
        checkboxflatred("id_imp_detil","id_imp_detil[]",$asuhan_imp_detil_8,"id_imp_detil","nama_imp_detil",$id_imp_detil,"flat-red","<br>","","array");  
      }
      foreach($asuhan_implementasi_9 as $rowasuhan_implementasi_9){
        echo $rowasuhan_implementasi_9['nama_implementasi']; ?><br style="margin-bottom: 0.5em;"> 
      <?php
        $asuhan_imp_detil_9 = $this->m_ol_rancak->asuhan_implementasi_detil($rowasuhan_implementasi_9['id_implementasi']);
        checkboxflatred("id_imp_detil","id_imp_detil[]",$asuhan_imp_detil_9,"id_imp_detil","nama_imp_detil",$id_imp_detil,"flat-red","<br>","","array");  
      }
      ?>                
                </td>
                </tr>
      ...
      <?php
        $asuhan_kaji_detil_14 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_14['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_14,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array"); 
      }   
      foreach($asuhan_pengkajian_15 as $rowasuhan_kategori_15){
        echo $rowasuhan_kategori_15['nama_pengkajian'];  ?><br style="margin-bottom: 0.5em;">
      <?php
        $asuhan_kaji_detil_15 = $this->m_ol_rancak->asuhan_pengkajian_detil($rowasuhan_kategori_15['id_pengkajian']);
        checkboxflatred("id_kaji_detil","id_kaji_detil[]",$asuhan_kaji_detil_15,"id_kaji_detil","nama_kaji_detil",$id_kaji_detil,"flat-red","<br>","","array"); 
      }         
      ?>                
                </td>
                <td style="border-color: black;vertical-align:middle;padding:5px;width:1%;border-right:0;border-top:none;">&nbsp;</td>
      ...
      foreach($asuhan_implementasi_10 as $rowasuhan_implementasi_10){
        $asuhan_imp_detil_10 = $this->m_ol_rancak->asuhan_implementasi_detil($rowasuhan_implementasi_10['id_implementasi']);
        checkboxflatred("id_imp_detil","id_imp_detil[]",$asuhan_imp_detil_10,"id_imp_detil","nama_imp_detil",$id_imp_detil,"flat-red","<br>","","array"); 
      }               
      ?>
                </td>
                </tr>
...
$('#btn_pemeriksaan').on('click',function(){
    ...
    $.ajax({
        type : "POST",
        url  : "<?php echo base_url('ugd/daftar/simpan_tambah_pemeriksaan_billing')?>",
        dataType : "JSON",
      ...
      "oLanguage": {
        ...
        "select": {
          ...
          "rows": {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ugd/daftar/billing/<?php echo $first_date;?>",
                "type" : "POST"
            },
            "columns": [
...
/*              {
              ...
              },*/
              {
                ...
                className: "btnred",
                  action: function ( e, dt, node, config ) {
                      data = dt.rows( { selected: true } ).data()[0]['barcode_pemeriksaan'];
                      $("#modal-default").modal();
                        $('.modal-body').load('<?php echo base_url('ugd/daftar/hapus_pemeriksaan/'); ?>'+data,function(){
                          $('#modal-default').modal({show:true});
                        });
    ...
    $('select[name=id_kelas]').on('change',function(){
        $.ajax({
            url:'<?php echo base_url();?>ugd/data_pemeriksaan/'+$(this).val(),
            type: "POST",
            dataType: 'json'
         }).done(function(data) {
               var len = data.length;
  ...
  $("#search-inp").keypress(function(event) {
    ...
    $(document).ready(function() {
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ugd/daftar/pmr/<?php echo$first_date;?>",
                "type" : "POST"
            },
            "columns": [
            ...
            "buttons": [
              {
                  ...
                  action: function ( e, dt, node, config ) {
                      $("#modal-default").modal();
                        $('.modal-body').load('<?php echo base_url('ugd/daftar/tambah_penunjang/'); ?><?php echo $first_date; ?>',function(){
                          $('#modal-default').modal({show:true});
                        });
                  }
              },
              {
                ...
                className: "btnteal",
                  action: function ( e, dt, node, config ) {
                      ...
                      $("#modal-default").modal();
                        $('.modal-body').load('<?php echo base_url('ugd/daftar/edit_penunjang/'); ?>'+data,function(){
                          $('#modal-default').modal({show:true});
                        });
              ...
              },
              {
                ...
                className: "btnred",
                  action: function ( e, dt, node, config ) {
                      data = dt.rows( { selected: true } ).data()[0]['id_pemeriksaan_penunjang'];
                      $("#modal-default").modal();
                        $('.modal-body').load('<?php echo base_url('ugd/daftar/hapus_penunjang/'); ?>'+data,function(){
                          $('#modal-default').modal({show:true});
                        });
...
$('#btn_simpan').on('click',function(){
    ...
    $.ajax({
        type : "POST",
        url  : "<?php echo base_url('ugd/daftar/simpan_tambah_penunjang')?>",
        dataType : "JSON",
...
$('#btn_edit').on('click',function(){
    ...
    $.ajax({
        type : "POST",
        url  : "<?php echo base_url('ugd/daftar/simpan_edit_penunjang')?>",
        dataType : "JSON",
        data : {nama:nama, hasil:hasil, tgl:tgl, daftar:daftar, dokter:dokter},
        success: function(data){
...
$('#btn_hapus').on('click',function(){
    ...
    $.ajax({
        type : "POST",
        url  : "<?php echo base_url('ugd/daftar/simpan_hapus_penunjang')?>",
        dataType : "JSON",
...
.select2-container {
    ...
    padding: 0;
      ...
      <div class="row">
        <div class="col-md-12">
		<FORM method="POST" class="form-horizontal" action="<?php echo base_url('ugd/daftar/aksi_penunjang');?>" onClick="return cek();">
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('ugd/pemeriksaan/simpan_edit_pemeriksaan');?>" onClick="return cek();">
      <input type="hidden" name="barcode_pemeriksaan" id="barcode_pemeriksaan" value="<?= $barcode_pemeriksaan; ?>">
