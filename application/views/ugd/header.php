...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url($this->session->beranda);?>" class="logo">
      ...
      <span class="logo-lg"><b>UGD</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview <?php cek_aktif($page,array('daftar','daftar_tambah','lobby')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('lobby'));?>">
							<a href="<?php echo base_url('ugd/lobby');?>"><i class="fa fa-clock-o text-<?php echo $v; ?>"></i>
								Lobby
							</a>
						</li>	
            <li class="<?php cek_aktif($page,array('daftar','daftar_tambah'));?>">
							<a href="<?php echo base_url('ugd/daftar');?>"><i class="fa fa-clock-o text-<?php echo $v; ?>"></i>
								Pemeriksaan
							</a>
						</li>				
          </ul>
