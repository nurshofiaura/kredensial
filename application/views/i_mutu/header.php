    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
	       ...
	       <li class="treeview <?php cek_aktif($page,array('lhu','lhu_input','lhu_upload','laporan','laporan_tambah','laporan_edit','laporan_tambah_tabel','laporan_edit_tabel','laporan_print_tabel','laporan_clone','lihat','lihat_profil','lihat_laporan','lihat_tabel','lihat_galeri','berkas')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('lhu','lhu_input','lhu_upload'));?>">
							<a href="<?php echo base_url('i_mutu/lhu');?>">
	           ...
	           <li class="<?php cek_aktif($page,array('lihat','lihat_profil','lihat_laporan','lihat_tabel','lihat_galeri'));?>">
							<a href="<?php echo base_url('i_mutu/lihat');?>">
