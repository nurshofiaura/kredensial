  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview <?php cek_aktif($page,array('daftar','kegiatan','kegiatan_edit','kegiatan_tambah','kegiatan_hasil')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('daftar'));?>">
							<a href="<?php echo base_url('pemulihan/daftar');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Daftar Penolakan</a></li>
							<li class="<?php cek_aktif($page,array('kegiatan','kegiatan_edit','kegiatan_tambah','kegiatan_hasil'));?>">
								<a href="<?php echo base_url('pemulihan/kegiatan');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Daftar Kegiatan</a></li>
          </ul>
        </li>
      </ul>
    </section>
