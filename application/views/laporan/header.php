  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php cek_aktif($page,array('buku_besar','neraca')); ?>">
          <a href="#">
            <i class="fa fa-cog text-<?php echo $v; ?>"></i>
            <span>LAPORAN</span>
            <span class="pull-right-container">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('buku_besar','neraca'));?>">
				<a href="<?php echo base_url('akunting/buku_besar');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Buku Besar</a></li>
            <li class="<?php cek_aktif($page,array('neraca'));?>">
				<a href="<?php echo base_url('akunting/neraca');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Neraca</a></li>         
		 </ul>
        </li>
      </ul>
    </section>
