...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>admin_im/<?php echo $page;?>/data/<?php echo $id;?>",
                "type" : "POST"
            },
            "columns": [
                      { "data": "id_equipment", "searchable":false , "visible":false },
                      { "data": "nama_equipment" },
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('admin_im/'.$page.'/tambah'); ?>',function(){
                ...
                },
              {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          data = dt.rows( { selected: true } ).data()[0]['id_equipment'];
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('admin_im/'.$page.'/edit/'); ?>'+data,function(){
                              $('#modal-default').modal({show:true});
                            });
                  }
              }, 
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      { "data": "id_limbah", "searchable":false , "visible":false },
                      { "data": "nama_limbah" },
                      { "data": "nama_standar_mutu", "searchable":false },
                      { "data": "standar_mutu", "searchable":false },
                      { "data": "range_mutu", "searchable":false },
                      { "data": "satuan_limbah", "searchable":false },
                      { "data": "status_limbah", "searchable":false,
                            "render": function(data, type, row){
                                if (row.status_limbah === '0') {
                                   return '<button class="btn btn-xs btn-danger">NON AKTIF</button>';
                               } else {
                                   return '<button class="btn btn-xs btn-success">AKTIF</button>';
                               }
            ...
            "buttons": [
                ...
                },
             {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          data = dt.rows( { selected: true } ).data()[0]['id_limbah'];
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('admin_im/'.$page.'/edit/'); ?>'+data,function(){
                              $('#modal-default').modal({show:true});
                            });
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>admin_im/<?php echo $page;?>/data",
                "type" : "POST"
            },
            "columns": [
                      { "data": "id_sumber_emisi", "searchable":false , "visible":false },
                      { "data": "nama_sumber_emisi" },
                      { "data": "nama_opsi_pengukuran", "searchable":false },
                      { "data": "nama_standar_mutu", "searchable":false },
                      { "data": "nama_working", "searchable":false },
                      { "data": "status_sumber_emisi", "searchable":false,
                            "render": function(data, type, row){
                                if (row.status_sumber_emisi === '0') {
                                   return '<button class="btn btn-xs btn-danger">NON AKTIF</button>';
                               } else {
                                   return '<button class="btn btn-xs btn-success">AKTIF</button>';
                               }
            ...
            "buttons": [
                ...
                },
             {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          data = dt.rows( { selected: true } ).data()[0]['id_sumber_emisi'];
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('admin_im/'.$page.'/edit/'); ?>'+data,function(){
                              $('#modal-default').modal({show:true});
                            });
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      { "data": "id_pengolah_limbah", "searchable":false , "visible":false },
                      { "data": "nama_pengolah_limbah" },
                      { "data": "nama_standar_mutu", "searchable":false },
                      { "data": "nama_working", "searchable":false },
                      { "data": "status_pengolah_limbah", "searchable":false,
                            "render": function(data, type, row){
                                if (row.status_pengolah_limbah === '0') {
                                   return '<button class="btn btn-xs btn-danger">NON AKTIF</button>';
                               } else {
                                   return '<button class="btn btn-xs btn-success">AKTIF</button>';
                               }
            ...
            "buttons": [
                ...
                },
             {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          data = dt.rows( { selected: true } ).data()[0]['id_pengolah_limbah'];
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('admin_im/'.$page.'/edit/'); ?>'+data,function(){
                              $('#modal-default').modal({show:true});
                            });
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      { "data": "id_tps", "searchable":false , "visible":false },
                      { "data": "nama_tps" },
                      { "data": "nama_working", "searchable":false },
                      { "data": "status_tps", "searchable":false,
                            "render": function(data, type, row){
                                if (row.status_tps === '0') {
                                   return '<button class="btn btn-xs btn-danger">NON AKTIF</button>';
                               } else {
            ...
            "buttons": [
                ...
                },
             {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          data = dt.rows( { selected: true } ).data()[0]['id_tps'];
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('admin_im/'.$page.'/edit/'); ?>'+data,function(){
                              $('#modal-default').modal({show:true});
                            });
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      { "data": "id_perlakuan_emisi", "searchable":false , "visible":false },
                      { "data": "nama_perlakuan_emisi" },
                      { "data": "status_perlakuan_emisi", "searchable":false,
                            "render": function(data, type, row){
                                if (row.status_perlakuan_emisi === '0') {
                                   return '<button class="btn btn-xs btn-danger">NON AKTIF</button>';
                               } else {
                                   return '<button class="btn btn-xs btn-success">AKTIF</button>';
                               }
            ...
            "buttons": [
                ...
                },
             {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          data = dt.rows( { selected: true } ).data()[0]['id_perlakuan_emisi'];
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('admin_im/'.$page.'/edit/'); ?>'+data,function(){
                              $('#modal-default').modal({show:true});
                            });
