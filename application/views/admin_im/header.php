    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
	       ...
	       <li class="treeview <?php cek_aktif($page,array('kategori_im','indikator_mutu')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('kategori_im'));?>">
							<a href="<?php echo base_url('admin_im/kategori_im');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kategori Indikator Mutu
							</a>
						</li>
	          </ul>
	        </li>
<!--	       <li class="treeview php cek_aktif($page,array('sumber_pengukuran','pengolah_limbah','pembuangan','tps')); ?>">
	         <a href="#">
	           <i class="fa fa-cog text-php echo $v; ?>"></i>
	           <span>Model Sanitasi</span>
	           <span class="pull-right-container">
	             <i class="fa fa-angle-left pull-right"></i>
	           </span>
	         </a>
	         <ul class="treeview-menu">
	           <li class="php cek_aktif($page,array('tps'));?>">
							<a href="php echo base_url('admin_im/tps');?>">
								<i class="fa fa-circle-o text-php echo $v; ?>"></i> Lokasi Pembuangan Limbah
							</a>
						</li>
	           <li class="php cek_aktif($page,array('sumber_pengukuran'));?>">
							<a href="php echo base_url('admin_im/sumber_pengukuran');?>">
								<i class="fa fa-circle-o text-php echo $v; ?>"></i> Sumber Pengukuran
							</a>
						</li>
	           <li class="php cek_aktif($page,array('pengolah_limbah'));?>">
							<a href="php echo base_url('admin_im/pengolah_limbah');?>">
								<i class="fa fa-circle-o text-php echo $v; ?>"></i> Pengolah Indikator Mutu
							</a>
						</li>
	           <li class="php cek_aktif($page,array('pembuangan'));?>">
							<a href="php echo base_url('admin_im/pembuangan');?>">
								<i class="fa fa-circle-o text-php echo $v; ?>"></i> Pembuangan Indikator Mutu
							</a>
						</li>
	          </ul>
	        </li>-->
