		...
		<li><a href="<?php echo base_url();?>"><i class="fa fa-cog text-<?php echo $v; ?>"></i> <span>Dashboard</span></a></li>
         <li class="treeview <?php cek_aktif($page,array()); ?>">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('admin_pelayanan'));?>">
				<a href="<?php echo base_url('admin_pelayanan');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pelayanan</a></li>
			<li><a href="<?php echo base_url('pendaftaran');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pendaftaran</a></li>
			<li><a href="<?php echo base_url('normal/format_radiologi');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Hasil Normal</a></li>
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('daftar','daftar_tambah')); ?>">
          <a href="#">
            <i class="fa fa-cog text-<?php echo $v; ?>"></i>
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('daftar','daftar_tambah'));?>">
							<a href="<?php echo base_url('radiologi/daftar');?>"><i class="fa fa-clock-o text-<?php echo $v; ?>"></i>
								Pendaftaran
							</a>
						</li>
          </ul>
