...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url($this->session->beranda);?>" class="logo">
      ...
      <span class="logo-lg"><b>LABORATORIUM</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview <?php cek_aktif($page,array('format_hasil')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">		
            <li class="<?php cek_aktif($page,array('format_hasil'));?>">
							<a href="<?php echo base_url('laboratorium/format_hasil');?>"><i class="fa fa-clock-o text-<?php echo $v; ?>"></i>
								Format Normal
							</a>
						</li>				
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('daftar','lobby')); ?>">
          <a href="#">
            <i class="fa fa-cog text-<?php echo $v; ?>"></i>
          ...
          <ul class="treeview-menu">		
            <li class="<?php cek_aktif($page,array('lobby'));?>">
							<a href="<?php echo base_url('laboratorium/lobby');?>"><i class="fa fa-clock-o text-<?php echo $v; ?>"></i>
								Lobby
							</a>
						</li>	
            <li class="<?php cek_aktif($page,array('daftar'));?>">
							<a href="<?php echo base_url('laboratorium/daftar');?>"><i class="fa fa-clock-o text-<?php echo $v; ?>"></i>
								Hasil
							</a>
						</li>				
          </ul>
