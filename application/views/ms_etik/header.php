...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url($this->session->beranda);?>" class="logo">
      ...
      <span class="logo-lg"><b>ETIK</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
         ...
         <li class="<?php cek_aktif($page,array('etika_profesi','etika_profesi_input','etika_profesi','etika_profesi'));?>">
					<a href="<?php echo base_url('ms_etik/etika_profesi');?>">
						<i class="fa fa-list-alt text-<?php echo $v; ?>"></i> 
							<span>Input Etika Profesi</span>
					</a>
				</li>
      </ul>
    </section>
