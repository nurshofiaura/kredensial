...
<?= input_custom(['name' => 'start','placeholder' => 'YYYY-MM-DD','attr' =>['class' => 'form-control basic-date']]) ?>
<?= input_custom(['name' => 'end','placeholder' => 'YYYY-MM-DD','attr' =>['class' => 'form-control basic-date']]) ?>
