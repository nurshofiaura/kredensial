...
function initCalendar(){
  ...
  if(!calendarEl){
    console.warn('[Calendar] element #calendar tidak ada');
    return;
  }
  ...
  let calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    eventClick: function(info){
      $.get("<?= site_url('member/get') ?>/"+info.event.id,function(res){
  ...
  $('#formAdd').submit(function(e){
    e.preventDefault();
    $.post("<?= site_url('member/add') ?>",$(this).serialize(),function(){
      $('#modalAdd').modal('hide');
  ...
  $('#formEdit').submit(function(e){
    e.preventDefault();
    $.post("<?= site_url('member/update') ?>",$(this).serialize(),function(){
  ...
  $('#btnDelete').click(function(){
    if(confirm('Hapus acara?')){
      $.get("<?= site_url('member/delete') ?>/"+$('#id').val(),function(){
        $('#modalEdit').modal('hide');
        calendar.refetchEvents();
      });
    }
