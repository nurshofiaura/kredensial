...
if(empty($photo)){
 $url_profilegbr=base_url().'assets/images/noavatar.jpg';
 $url_profilebesar=base_url().'assets/images/noavatar.jpg';    
}else{
 $cek_filesmall=FCPATH.'assets/foto/ol/'.$photo;
 if(file_exists($cek_filesmall)){
  $url_profilegbr=base_url().'assets/foto/ol/'.$photo;
  $url_profilebesar=base_url().'assets/foto/ol/'.$photo;
 }else{
  $url_profilegbr=base_url().'assets/images/noavatar.jpg';
  $url_profilebesar=base_url().'assets/images/noavatar.jpg';
 }    
...
?>
       ...
       <div class="recent-order-table">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link" onclick="location.href='<?php  echo base_url('ol_pengajuan');?>'" type="button">
         <img style="width:25px;" src="<?php echo base_url('assets/images/kompetensi.png');?>" alt="" class="w-35">
        ...
        <li class="nav-item" role="presentation">
<button type="button"
  class="btn btn-primary LihatBilling"
  data-bs-toggle="modal"
  data-bs-target="#exampleModalFullscreenXxl"
  data-url="<?= base_url('member/billing/lihat'); ?>">
  Billing
</button>
<button class="btn btn-danger open-modal"
        data-url="<?= base_url('member/billing/lihat'); ?>">
  Lihat Detail
</button>
<button type="button" class="nav-link LihatBilling" data-bs-toggle="modal" data-bs-target="#exafmpleModalFullscreenXxl">
         <img style="width:25px;" src="<?= base_url('assets/images/billing.png') ?>" alt="" class="w-35">
         <span> Billing</span>
</button>
        </li>
        <?php  
        ...
        ?>
        <li class="nav-item" role="presentation">
          <button class="nav-link" onclick="location.href='<?= base_url('member/profil') ?>'" type="button">
         <img style="width:25px;" src="<?= base_url('assets/images/profil.png') ?>" alt="" class="w-35">
         <span> Profil</span>
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" onclick="location.href='<?= base_url('member/berkas') ?>'" type="button">
         <img style="width:25px;" src="<?= base_url('assets/images/berkas.png') ?>" alt="" class="w-35">
         <span> Berkas</span>
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" onclick="location.href='<?= base_url('member/ijasah') ?>'" type="button">
         <img style="width:25px;" src="<?= base_url('assets/images/ijasah.png') ?>" alt="" class="w-35">
         <span> Ijasah</span>
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" onclick="location.href='<?= base_url('member/pelatihan') ?>'" type="button">
         <img style="width:25px;" src="<?= base_url('assets/images/sertifikat.png') ?>" alt="" class="w-35">
         <span> Pelatihan</span>
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" onclick="location.href='<?= base_url('member/surat_ijin') ?>'" type="button">
         <img style="width:25px;" src="<?= base_url('assets/images/str.png') ?>" alt="" class="w-35">
         <span> Surat Ijin</span>
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" onclick="location.href='<?= base_url('jadwal_all/lihat_jadwal') ?>'" type="button">
         <img style="width:25px;" src="<?= base_url('assets/images/jadwal.png') ?>" alt="" class="w-35">
         <span> Jadwal</span>
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" onclick="location.href='<?= base_url('jadwal_all/chat') ?>'" type="button">
         <img style="width:25px;" src="<?= base_url('assets/images/laporan.png') ?>" alt="" class="w-35">
         <span> Laporan</span>
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" onclick="location.href='<?= base_url('ol_logbook') ?>'" type="button">
         <img style="width:25px;" src="<?= base_url('assets/images/logbook.png') ?>" alt="" class="w-35">
         <span> Logbook</span>
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" onclick="location.href='<?= base_url('member/tes') ?>'" type="button">
         <img style="width:25px;height: 35px;" src="<?= base_url('assets/images/tes.png') ?>" alt="" class="w-35">
         <span> Latihan</span>
          </button>
        </li>
         </ul>
     ...
     <div class="card-footer">
       <div class="recent-order-table">
        ...
        ?>
        <li class="nav-item" role="presentation">
          <button class="nav-link" onclick="location.href='<?= base_url($rowshortcut['link_shortcut']) ?>'" type="button">
         <span class="blinking"> <?= $rowshortcut['judul_shortcut'] ?></span>
          </button>
        </li>
        <?php 
         }
                  ...
                  <div class="card-body">
                    ...
                    <div class="profile-top-content">
                      <div class="h-80 w-80 d-flex-center b-r-50 overflow-hidden">
                        <a href="<?= $url_profilegbr ?>" class="glightbox" data-glightbox="type: image; zoomable: true;">
                         <img src="<?= $url_profilegbr ?>" class="img-fluid" alt="image">
                       </a>                      
                      </div>
                      <h6 class="text-dark f-w-600 mb-0">Kari wiza</h6>
                      <p class="text-secondary f-s-13 mb-0">@Kari_wiza@001</p>
                      <div>
                          <a href="<?= base_url('member/profil') ?>" role="button" class="btn btn-light-primary">View Profile</a>
                      </div>
 ...
 <div class="modal fade" id="exampleModalFullscreenXxl" tabindex="-1"
  ...
  <div class="modal-dialog modal-fullscreen-xxl-down">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h6 class="modal-title" id="exampleModalFullscreenXxlLabel">Billing</h6>
...
<div class="modal fade" id="exampleModalFullscreenLg" tabindex="-1">
  <div class="modal-dialog modal-fullscreen-lg-down">
    <div class="modal-content">
      <div class="modal-header">
        <h6 class="modal-title">Detail Halaman</h6>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
