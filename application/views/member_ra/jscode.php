...
/*  $('.LihatBilling').on('click',function(){
    $('.modal-body').load('<?php echo base_url('member/billing/lihat/'); ?>',function(){
      $('#exampleModalFullscreenXxl').modal({show:true});
    });
  });
$('.LihatBilling').on('click', function () {
  $('.modal-body').load('<?= base_url('member/billing/lihat'); ?>');
});
$('#exampleModalFullscreenXxl').on('show.bs.modal', function (e) {
  const button = $(e.relatedTarget); // tombol yang diklik
  const modalBody = $(this).find('.modal-body');

  modalBody.html('Loading...');

  modalBody.load('<?= base_url("member/billing/lihat"); ?>');
});
$('#exampleModalFullscreenXxl').on('shown.bs.modal', function () {
  $('.modal-body').load('<?= base_url("member/billing/lihat"); ?>');
});*/
$(function () {
