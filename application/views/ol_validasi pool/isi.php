              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <p class="mb-0 text-muted small">The DataTables API has a number of methods for attaching child rows to a parent row in the
                  ...
                  <div class="card-body px-0">
                    <div class="app-datatable-default overflow-auto">
                      <table id="dttb" class="display w-100 datatable child-row-datatable" data-server="true">
                        <thead>
                          <tr class="selected">
                            <th></th>
                            <th>Nama</th>
...
<div id="dt-playground-panel"
  ...
  <div style="padding:10px;border-bottom:1px solid #eee">
    <strong>🎛️ Button Playground</strong>
    <button onclick="togglePlayground(false)"
            style="float:right">✖</button>
  </div>

  <div style="padding:10px">
    <button onclick="renderButtons()">Render ALL</button>
    <input id="jumpIndex" type="number" min="1" max="3780"
           style="width:80px">
    <button onclick="jumpToIndex()">Go</button>

    <button onclick="renderAllRandomNoIcon()"
            style="margin-left:6px">
      No Icon
    </button>
  </div>

  <div id="dt-btn-playground"
       style="
         padding:10px;
         display:flex;
         flex-wrap:wrap;
...
<div style="padding:12px">
  <h4>🎛️ Playground – Random No Icon</h4>
...
<hr>
<div style="padding:12px">
  <h4>🎛️ Button Playground (3780)</h4>

  <div style="margin-bottom:10px">
    <button onclick="renderButtons()">Render All</button>
    <input id="jumpIndex" type="number" min="1" max="3780" placeholder="Index (1–3780)">
    <button onclick="jumpToIndex()">Go</button>
  </div>

  <div id="btn-playground"
       style="display:flex;flex-wrap:wrap;gap:6px;max-height:70vh;overflow:auto">
  </div>
</div>
