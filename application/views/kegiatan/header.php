  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview <?php cek_aktif($page,array('pemulihan','pemulihan_isi','pemulihan_tambah')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
							<li class="<?php cek_aktif($page,array('pemulihan','pemulihan_isi','pemulihan_tambah'));?>">
								<a href="<?php echo base_url('kegiatan/pemulihan');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Daftar Pemulihan</a></li>
          </ul>
        </li>
      </ul>
    </section>
