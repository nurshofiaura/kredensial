...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url($this->session->beranda);?>" class="logo">
      ...
      <span class="logo-lg"><b>RADIOLOGI</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href="<?php echo base_url($this->session->beranda);?>"><i class="fa fa-money text-<?php echo $v; ?>"></i> <span>Dashboard</span></a></li>
       <li class="treeview <?php cek_aktif($page,array('program_tr','program_tr_unit','program_tr_tindakan','asuransi','rujukan','faskes','reject','fokus',
			 		'thickness','fe','fe_tambah','bakhp','bakhp_tambah')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
						<li class="<?php cek_aktif($page,array('reject'));?>">
							<a href="<?php echo base_url('admin_radiologi/reject');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i>
								Reject
							</a>
						</li>
						<li class="<?php cek_aktif($page,array('fe','fe_tambah'));?>">
							<a href="<?php echo base_url('admin_radiologi/fe');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i>
								fe
							</a>
						</li>
						 <li class="treeview <?php cek_aktif($page,array('bakhp','bakhp_tambah')); ?>">
 		           <a href="#">
 		           ...
 		           <ul class="treeview-menu">
 		             <li class="<?php cek_aktif($page,array('bakhp','bakhp_tambah'));?>">
 		 							<a href="<?php echo base_url('admin_radiologi/bakhp');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i>
 		 								FORMAT
 		 							</a>
 		 						</li>
 		           </ul>
