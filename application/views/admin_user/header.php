    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">ADMIN</li>		
	       ...
	       <li class="treeview <?php cek_aktif($page,array('aktifasi','aktifasi_tambah','data_user','berkas_kategori','kategori_pelatihan','peminatan','unit','ms_etik','kinerja_unit')); ?>">
	         <a href="#">
         ...
         <li class="<?php cek_aktif($page,array('demografi'));?>">
					<a href="<?php echo base_url('admin_user/demografi');?>">
						<i class="fa fa-list-alt text-<?php echo $v; ?>"></i> 
							<span>Demografi Profesi</span>
					</a>
				</li>	
      </ul>
    </section>
