      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">ADMIN</li>		
         ...
         <li class="<?php cek_aktif($page,array('data_user'));?>">
					<a href="<?php echo base_url('admin_komunitas/data_user');?>">
						<i class="fa fa-users text-<?php echo $v; ?>"></i> 
							<span>Data User</span>
					</a>
				</li>	
	       <li class="treeview <?php cek_aktif($page,array('kategori_surat')); ?>">
	         <a href="#">
	           <i class="fa fa-file-text text-<?php echo $v; ?>"></i>
	           <span>Master Korespondensi</span>
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('kategori_surat'));?>">
							<a href="#">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Tipe Surat (Pengembangan)
							</a>
						</li>
	          </ul>
	        </li>
         <li class="<?php cek_aktif($page,array('demografi'));?>">
					<a href="<?php echo base_url('admin_komunitas/demografi');?>">
