...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url($this->session->beranda);?>" class="logo">
      ...
      <span class="logo-lg"><b>RADIOLOG</b></span>
    </a>
       ...
       <li class="treeview <?php cek_aktif($page,array('format_hasil')); ?>">
          ...
          <ul class="treeview-menu">		
            <li class="<?php cek_aktif($page,array('format_hasil'));?>">
							<a href="<?php echo base_url('radiolog/format_hasil');?>"><i class="fa fa-clock-o text-<?php echo $v; ?>"></i>
								Format Hasil
							</a>
						</li>				
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('daftar')); ?>">
          <a href="#">
            <i class="fa fa-cog text-<?php echo $v; ?>"></i>
          ...
          <ul class="treeview-menu">		
            <li class="<?php cek_aktif($page,array('daftar'));?>">
							<a href="<?php echo base_url('radiolog/daftar');?>"><i class="fa fa-clock-o text-<?php echo $v; ?>"></i>
								Hasil
							</a>
						</li>				
          </ul>
