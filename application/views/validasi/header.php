...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url($this->session->beranda);?>" class="logo">
      ...
      <span class="logo-lg"><b>VALIDASI</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview <?php cek_aktif($page,array('pengajuan_kompetensi')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('pengajuan_kompetensi'));?>">
							<a href="<?php echo base_url('validasi/pengajuan_kompetensi');?>">
