...
$("#last_date").inputmask("datetime", {
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>direktur/<?php echo $page;?>/data/<?php echo $first_date; ?>/<?php echo $last_date; ?>/<?php echo $id; ?>",
                "type" : "POST"
            },
            "columns": [
                    {
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        location.href = '<?php echo base_url('direktur/v_kabid_logbook/0/'); ?><?php echo $first_date; ?>/<?php echo $last_date; ?>/'+data;
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
						data = dt.rows( { selected: true } ).data()[0]['id_pegawai'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('direktur/v_kabid_logbook/1/'); ?><?php echo $first_date; ?>/<?php echo $last_date; ?>/'+data;
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
						data = dt.rows( { selected: true } ).data()[0]['id_pegawai'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('direktur/v_kabid_logbook/2/'); ?><?php echo $first_date; ?>/<?php echo $last_date; ?>/'+data;
                    }
                },
                {
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>direktur/<?php echo $page;?>/data",
                "type" : "POST"
            },
            "columns": [
                    {
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('direktur/'.$page.'/isi/'); ?>'+data;
                    }
                },
                {
                    text: "<i class='fa fa-recycle'></i> Return Data Direktur",
                    extend: "selected",
                    className: "btnmaroon",
                    action: function ( e, dt, node, config ) {
						data = dt.rows( { selected: true } ).data()[0]['id_pengajuan'];
						// alert(JSON.stringify(data));
						location.href = '<?php echo base_url('direktur/'.$page.'/proses_kabid/'); ?>'+data;
                ...
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['id_pengajuan'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('direktur/'.$page.'/kelengkapan/'); ?>'+data;
                    }
                },
                {
                  text: "<i class='fa fa-file-pdf-o'></i> Penugasan Klinis",
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        if(direktur=='Kompeten' && komite=='Kompeten' && status_terbitkan=='Terbitkan'){
							data = dt.rows( { selected: true } ).data()[0]['id_pengajuan'];
							window.open('<?php echo base_url('direktur/'.$page.'/pdf/'); ?>'+data);
                        }
                        else{
                            swal({
                ...
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        direktur = dt.rows( { selected: true } ).data()[0]['acc_direktur'];
                        status_terbitkan = dt.rows( { selected: true } ).data()[0]['status_terbitkan'];
                        if(direktur=='Kompeten' && komite=='Kompeten' && no_terbitkan>0){
							data = dt.rows( { selected: true } ).data()[0]['id_pengajuan'];
							// alert(JSON.stringify(data));
							location.href = '<?php echo base_url('direktur/'.$page.'/terbitkan/'); ?>'+data+'/0';
                        }
                        else{
                            swal({
                ...
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        if(direktur=='Kompeten' && komite=='Kompeten' && no_terbitkan==0){
							data = dt.rows( { selected: true } ).data()[0]['id_pengajuan'];
							// alert(JSON.stringify(data));
							location.href = '<?php echo base_url('direktur/'.$page.'/terbitkan/'); ?>'+data+'/1';
                        }
                        else{
                            swal({
                              title: "Cek Validasi Data",
                ...
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        if(direktur=='Kompeten' && komite=='Kompeten' && no_terbitkan==0){
							data = dt.rows( { selected: true } ).data()[0]['id_pengajuan'];
							// alert(JSON.stringify(data));
							location.href = '<?php echo base_url('direktur/'.$page.'/terbitkan/'); ?>'+data+'/2';
                        }
                        else{
                            swal({
                              title: "Cek Validasi Data",
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
		  ...
		  "initComplete": function (settings, json) {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>direktur/pengajuan_kompetensi/data2/<?php echo $id; ?>",
                "type" : "POST"
            },
            "columns": [
                      { "data": "id_logbook","searchable":false },
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('direktur/v_kabid_kompetensi/0/0/'); ?>'+data+'/<?php echo $id; ?>/'+data2;
                    }
                },
                {
                    text: "<i class='fa fa-check'></i> SETUJU",
                    ...
                    action: function ( e, dt, node, config ) {
						...
						data2 = dt.rows( { selected: true } ).data()[0]['id_logbook'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('direktur/v_kabid_kompetensi/1/0/'); ?>'+data+'/<?php echo $id; ?>/'+data2;
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
						...
						data2 = dt.rows( { selected: true } ).data()[0]['id_logbook'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('direktur/v_kabid_kompetensi/2/0/'); ?>'+data+'/<?php echo $id; ?>/'+data2;
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('direktur/v_kabid_kompetensi_all/0/'); ?><?php echo $id; ?>';
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('direktur/v_kabid_kompetensi_all/1/'); ?><?php echo $id; ?>';
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                       location.href = '<?php echo base_url('direktur/v_kabid_kompetensi_all/2/'); ?><?php echo $id; ?>';
                    }
                },
                {
                    text: "<i class='fa fa-refresh'></i> Reload",
        ...
        var table2 = $('#dttb2').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>direktur/pengajuan_kompetensi/pemulihan/<?php echo $id;?>",
                "type" : "POST"
            },
            "columns": [
            ...
            "buttons": [
              {
                ...
                className: "btnteal",
                  action: function ( e, dt, node, config ) {
                      ...
                      $("#modal-default").modal();
                        $('.modal-body').load('<?php echo base_url('direktur/pengajuan_kompetensi/lihat_pemulihan/'); ?>'+data,function(){
              ...
              },
              {
                ...
                className: "btnfuchsia",
                  action: function ( e, dt, node, config ) {
                      data = dt.rows( { selected: true } ).data()[0]['id_logbook_pemulihan'];
                      $("#modal-default").modal();
                        $('.modal-body').load('<?php echo base_url('direktur/pengajuan_kompetensi/lihat_kegiatan/'); ?>'+data,function(){
                          $('#modal-default').modal({show:true});
                        });
...
elseif ($page=="xcvpengajuan_kompetensi_isi")
{
?>
	$("#search-inp").keypress(function(event) {
		var character = String.fromCharCode(event.keyCode);
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('direktur/v_kabid_kompetensi/0/'); ?><?php echo $id; ?>';
                    }
                },
                {
                    text: "<i class='fa fa-check'></i> SETUJU SEMUA",
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('direktur/v_kabid_kompetensi/1/'); ?><?php echo $id; ?>';
                    }
                },
                {
                    text: "<i class='fa fa-close'></i> TOLAK SEMUA",
                    ...
                    action: function ( e, dt, node, config ) {
                       location.href = '<?php echo base_url('direktur/v_kabid_kompetensi/2/'); ?><?php echo $id; ?>';
                    }
                },
                {
                    text: "<i class='fa fa-refresh'></i> Reload",
...
/* 	am4core.ready(function() {
	...
	chart.dataSource.url = "<?php echo base_url();?>direktur/pengajuan_kompetensi/tabel/<?php echo $id;?>";
