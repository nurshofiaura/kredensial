       ...
       <li class="treeview <?php cek_aktif($page,array('logbook','logbook_tambah')); ?>">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('logbook','logbook_tambah'));?>">
				<a href="<?php echo base_url('direktur/logbook');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Validasi Kepala Ruangan
				</a>
			</li>			
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_isi','pengajuan_kompetensi_asesor','pengajuan_kompetensi_kelengkapan')); ?>">
          <a href="#">
            <i class="fa fa-book text-<?php echo $v; ?>"></i>
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_isi','pengajuan_kompetensi_asesor','pengajuan_kompetensi_kelengkapan'));?>">
				<a href="<?php echo base_url('direktur/pengajuan_kompetensi');?>">
