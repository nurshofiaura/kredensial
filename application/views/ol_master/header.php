    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
	       ...
	       <li class="treeview <?php cek_aktif($page,array('kategori_kewenangan','relasi','relasi_tambah','relasi','butir_kegiatan')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('kategori_kewenangan'));?>">
							<a href="<?php echo base_url('ol_master/kategori_kewenangan');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Buku Putih Keperawatan
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('relasi','relasi_tambah'));?>">
							<a href="<?php echo base_url('ol_master/relasi');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Link Kan
							</a>
						</li>
	          </ul>
	        </li>
