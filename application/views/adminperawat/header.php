  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php cek_aktif($page,array()); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
			<li><a href="<?php echo base_url('direktur');?>"><i class="fa fa-cog text-<?php echo $v; ?>"></i> <span>Direktur</span></a></li>
			<li><a href="<?php echo base_url('komite');?>"><i class="fa fa-cog text-<?php echo $v; ?>"></i> <span>Komite</span></a></li>
			<li><a href="<?php echo base_url('asesor');?>"><i class="fa fa-cog text-<?php echo $v; ?>"></i> <span>Asesor</span></a></li>
			<li><a href="<?php echo base_url('kabid');?>"><i class="fa fa-cog text-<?php echo $v; ?>"></i> <span>Kabid</span></a></li>
			<li><a href="<?php echo base_url('karu');?>"><i class="fa fa-cog text-<?php echo $v; ?>"></i> <span>Karu</span></a></li>
			<li><a href="<?php echo base_url('pegawai');?>"><i class="fa fa-cog text-<?php echo $v; ?>"></i> <span>Pegawai</span></a></li>
          </ul>
        </li>
        <li class="treeview <?php cek_aktif($page,array('user','user_edit','user_tambah','akses')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array());?>">
				<a href="<?php echo base_url('user');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> User Non Keperawatan</a></li>
            <li class="<?php cek_aktif($page,array('user','user_edit','user_tambah','akses'));?>">
				<a href="<?php echo base_url('admin_perawat/user');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> User Keperawatan</a></li>
             <li class="<?php cek_aktif($page,array('aktifasi'));?>">
				<a href="<?php echo base_url('aktifasi');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Aktifasi</a></li>
             <li class="<?php cek_aktif($page,array('unit'));?>">
				<a href="<?php echo base_url('unit');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Unit</a></li>
             <li class="<?php cek_aktif($page,array('ruangan'));?>">
				<a href="<?php echo base_url('ruangan');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Ruangan</a></li>
             <li class="<?php cek_aktif($page,array('kepegawaian'));?>">
				<a href="<?php echo base_url('kepegawaian');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kepegawaian</a></li>
             <li class="<?php cek_aktif($page,array('etik'));?>">
				<a href="<?php echo base_url('etik');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Etik</a></li>
             ...
             <li class="<?php cek_aktif($page,array('upload'));?>">
				<a href="<?php echo base_url('upload');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Upload</a></li>
          </ul>
        </li>
		<li class="treeview <?php cek_aktif($page,array('kategori_kompetensi','kategori_kewenangan','kompetensi','kompetensi_tambah',
					'kompetensi_edit','kompetensi_clone','butir_kegiatan','butir_kewenangan','butir_kewenangan_tambah','seting_dupak',
					'butir_pegawai','butir_pegawai_tambah','lulus','lulus_tambah','kompetensi_tambah_unit','cat_oppe')); ?>">
		  <a href="#"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kredensial
			<span class="pull-right-container">
			  <i class="fa fa-angle-left pull-right"></i>
			</span>
		  </a>
		  <ul class="treeview-menu">
			<li class="<?php cek_aktif($page,array('kategori_kompetensi'));?>">
				<a href="<?php echo base_url('admin_perawat/kategori_kompetensi');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kategori Kompetensi
				</a>
			</li>
			<li class="<?php cek_aktif($page,array('cat_oppe'));?>">
				<a href="<?php echo base_url('admin_perawat/cat_oppe');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Rekom Nilai OPPE</a></li>
			<li class="treeview <?php cek_aktif($page,array('kategori_kewenangan','kompetensi','kompetensi_tambah','kompetensi_edit',
			'kompetensi_clone','kompetensi_tambah_unit','lulus','lulus_tambah')); ?>">
			  ...
			  <ul class="treeview-menu">
				<li class="<?php cek_aktif($page,array('kategori_kewenangan'));?>">
					<a href="<?php echo base_url('admin_perawat/kategori_kewenangan');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Data</a></li>
				<li class="<?php cek_aktif($page,array('kompetensi','kompetensi_tambah','kompetensi_edit','kompetensi_copy','kompetensi_clone','kompetensi_tambah_unit'));?>">
					<a href="<?php echo base_url('admin_perawat/kompetensi');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Detil</a></li>
				<li class="<?php cek_aktif($page,array('lulus','lulus_tambah'));?>">
					<a href="<?php echo base_url('admin_perawat/lulus');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Lulus</a></li>
			  </ul>
			</li>
			<li class="treeview <?php cek_aktif($page,array('butir_kegiatan','butir_kewenangan','butir_kewenangan_tambah',
				'butir_pegawai','butir_pegawai_tambah')); ?>">
			  <a href="#"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Butir Kegiatan
				<span class="pull-right-container">
				  <i class="fa fa-angle-left pull-right"></i>
				</span>
			  </a>
			...
			<li class="<?php cek_aktif($page,array('butir_kegiatan'));?>">
				<a href="<?php echo base_url('admin_perawat/butir_kegiatan');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Data</a></li>
				<li class="<?php cek_aktif($page,array('butir_kewenangan','butir_kewenangan_tambah'));?>">
					<a href="<?php echo base_url('admin_perawat/butir_kewenangan');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Detil</a></li>
			  </ul>
			</li>
			<li class="treeview <?php cek_aktif($page,array('seting_dupak')); ?>">
			  <a href="#">
				<i class="fa fa-users text-<?php echo $v; ?>"></i>
				<span>Dupak Pegawai</span>
				<span class="pull-right-container">
				  <i class="fa fa-angle-left pull-right"></i>
				</span>
			  </a>
			  <ul class="treeview-menu">
				<li class="<?php cek_aktif($page,array('seting_dupak'));?>">
					<a href="<?php echo base_url('admin_perawat/seting_dupak');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Non / Aktif Isi Dupak</a></li>
			  </ul>
			</li>
		  </ul>
		</li>
		<li class="treeview <?php cek_aktif($page,array('intro','faq')); ?>">
		  <a href="#"><i class="fa fa-globe text-<?php echo $v; ?>"></i> Web
			<span class="pull-right-container">
			  <i class="fa fa-angle-left pull-right"></i>
			</span>
		  </a>
		  <ul class="treeview-menu">
			<li class="<?php cek_aktif($page,array('intro')); ?>">
				<a href="<?php echo base_url('admin_perawat/intro');?>">
					<i class="fa fa-globe text-<?php echo $v; ?>"></i> Seting Website
				</a>
			</li>
			<li class="<?php cek_aktif($page,array('faq','faq_tambah','faq_edit')); ?>">
				<a href="<?php echo base_url('admin_perawat/faq');?>">
					<i class="fa fa-globe text-<?php echo $v; ?>"></i> Frequently Asked Question
				</a>
			</li>
		  </ul>
		</li>
