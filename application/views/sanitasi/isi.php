...
.select2-container {
  ...
  //      input_textcustom("",""," autofocus class='form-control input-sm' id='search-inp' ","CARI DI TABEL","text");
      ?>
        ...
        <div class="box-body">
      <?php echo form_open_multipart('sanitasi/lhu/view/'.$id.'/'.$id2.'/'.$id3.'/'.$id4,' id="signupform" '); ?>
        <div class="col-md-9">
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
        ...
        <div class="box-header with-border">
          ...
          <div style="font-weight:bold;color:green;" class="box-body">
            <ul>
            <li>Input Indikator Mutu hanya dapat satu kali di input setiap 1 LHU</li>
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('sanitasi/lhu/simpan_tambah');?>" onClick="return cek();">
       <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
      ...
      <div class="box-header with-border">
        ...
        <div class="box-body">
          <div class="container col-md-12">
            <div class="row">
              <div class="col-md-12">
                  <label>Instalasi / Ruangan</label>
                  <?php
                    input_pdselect2("id_unit",$ambil_data_unit,$id_unit);
                  ?>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-12">
                  <label>NO LHU</label>
                  <?php
                    input_text("no_lhu",$no_lhu,"maxlength='40' ","Ketik","text");
                  ?>
              </div> 
             </div>
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        ...
        <?php echo form_open_multipart('sanitasi/lhu/upload/'.$id,' ');
...
.select2-container {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php echo form_open_multipart('sanitasi/lhu/input/'.$id,' id="signupform" ');  
    input_text("id_lhu",$id_lhu,"","","hidden");
    input_text("barcode_lhu",$barcode_lhu,"","","hidden");
      ?>
    <div class="box-body">     
        ...
        <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>No LHU</label>
                <?php
                  input_text("no_lhu",$no_lhu,"maxlength='40' autofocus","Masukkan No","text");
                ?>  
              </div>        
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <?php
                      input_textareacustom("deskripsi_lhu",$deskripsi_lhu," id='editor1' rows='10' cols='100' class='form-control' ","Masukkan Deskripsi");
                ?>  
              </div>        
            </div>                        
        </div>  
          ...
          <table id="dttb" width="100%" class="table table-bordered table-striped table-hover" >
            <thead>
              <tr>
                ...
                <th style="text-align:right;">Baku Mutu</th>            
                <th>Satuan</th>                       
                <th>Keterangan</th>                       
              </tr>
            </thead>
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('sanitasi/lhu/simpan_isi');?>" onClick="return cek();">
    ...
    <div class="box-body">
      ...
      <div class="box-header with-border">
        ...
        <div class="box-body">
            <div class="col-md-12">
              <div class="col-md-6">
                  <label>Sumber Pengukuran</label>
                    <?php
              input_pdselect2fleksibel("id_sumber_emisi","id_sumber_emisi",$ambil_sn_sumber_emisi,"id_sumber_emisi","nama_sumber_emisi",$id_sumber_emisi,"Tidak Ada");
                    ?>
              </div>
              <div class="col-md-6">
                  <label>Limbah</label>
            ...
            <div class="col-md-12">
              <div class="col-md-6">
                  <label>TPS</label>
                    <?php
              input_pdselect2fleksibel("id_tps","id_tps",$ambil_sn_tps,"id_tps","nama_tps",$id_tps,"Tidak Ada");
                    ?>
              </div>
              <div class="col-md-6">
                  <label>Hasil LHU</label>
                  <?php
          input_textcustom("hasil_lhu_detil",$hasil_lhu_detil,"maxlength='6' required autofocus class='form-control' 
            ...
            <div class="col-md-12">
              <div class="col-md-6">
                  <label>IM Dikelola</label>
                  <?php
          input_textcustom("output_lhu_detil",$output_lhu_detil,"maxlength='6' required autofocus class='form-control' 
            onkeypress='return event.keyCode > 47 && event.keyCode < 58 || event.keyCode == 46' " ,"Masukkan Angka dan Titik","text"); 
                  ?>       
              </div>
              <div class="col-md-6">
                  ...
                  <?php
                    input_text("ket_lhu_detil",$ket_lhu_detil,"maxlength='255'  ","Ketik","text");
                  ?>
              </div> 
            </div>  
        </div>
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('sanitasi/lhu/simpan_rubah');?>" onClick="return cek();">
       <input type="hidden" name="id_lhu" value="<?= $id_lhu; ?>">
       <input type="hidden" name="barcode_lhu" value="<?= $barcode_lhu; ?>">
...
.select2-container {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
  <?php echo form_open_multipart('sanitasi/lhu/set/'.$id.'/'.$id2,' id="signupform" ');
  input_text("id_lhu",$id_lhu,"","","hidden");
  input_text("barcode_lhu",$barcode_lhu,"","","hidden");
  ?>
      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
        <h3 class="box-title">UNTUK HASIL UJI YANG SUDAH TERINPUT SEBELUMYA TIDAK TERSIMPAN</h3>
          <div class="box-tools pull-right">
        ...
        <div class="box-body">
        <?php
        foreach($ambil_limbah as $row){
          if(in_array($row['id_limbah'], $terpilih)){
            input_text("id_limbah[]",$row['id_limbah'],"","","hidden");
            $jml_log = $this->m_sanitasi->jumlah_record_sn_lhu_detil($row['id_limbah'],$barcode_lhu);
            if($jml_log == 0){
        ?>
    <div class="row">
      <div class="col-md-4">
        <h5>
        <?php 
        input_textarea("nama_limbah",$row['nama_limbah'],"readonly rows='1' ","","text");
        ?>
        </h5>
      </div>
      <div class="col-md-2">
        <label><strong>Hasil LHU</strong></label>
        <?php 
        input_textcustom("hasil_lhu_detil[]","0","maxlength='6' required autofocus class='form-control hasil' 
          onkeypress='return event.keyCode > 47 && event.keyCode < 58 || event.keyCode == 46' " ,"Masukkan Angka dan Titik","text"); 
        ?>
      </div>
      <div class="col-md-2">
        <label><strong>Maksimal LHU</strong></label>
        <?php 
        input_textcustom("max_lhu_detil[]","0","maxlength='6' class='form-control max'
          onkeypress='return event.keyCode > 47 && event.keyCode < 58 || event.keyCode == 46' " ,"Masukkan Angka dan Titik","text"); 
        ?>
      </div>
      <div class="col-md-4">
        ...
        <?php 
        input_text("ket_lhu_detil[]","","maxlength='255' ","Masukkan Keterangan","text");
        ?>
      </div>
    </div><br>
        <?php
...
.select2-container {
  ...
  //      input_textcustom("",""," autofocus class='form-control input-sm' id='search-inp' ","CARI DI TABEL","text");
      ?>
        ...
        <div class="box-body">
      <?php echo form_open_multipart('sanitasi/laporan/view/'.$id.'/'.$id2.'/'.$id3.'/'.$id4,' id="signupform" '); ?>
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
          <h3 class="box-title">RANGE /PERIODE TANGGAL</h3>
        </div>
...
?> 
  <div class="content-wrapper">
    ...
    <section class="content">
  <?php echo form_open_multipart('sanitasi/laporan/tambah',' id="signupform" '); ; 
        ...
        <div class="box-body">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php
                input_text("header_profil",$header_profil," maxlength='255' ","","text");
              ?>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php
                input_text("sub_header_profil",$sub_header_profil," maxlength='255' ","","text");
              ?>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label>Sejarah</label>
              <?php
                input_textareacustom("sejarah",$sejarah," id='editor4' rows='5' cols='50' class='form-control' ","");
              ?>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php
                input_textareacustom("visi_misi",$visi_misi," id='editor5' rows='5' cols='50' class='form-control' ","");
              ?>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php
                input_textareacustom("tujuan_fungsi",$tujuan_fungsi," id='editor6' rows='5' cols='50' class='form-control' ","");
              ?>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php
                input_textareacustom("informasi_layanan",$informasi_layanan," id='editor7' rows='5' cols='50' class='form-control' ","");
              ?>
            </div>
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label>Tujuan</label>
              <?php
                input_text("tujuan_laporan",$tujuan_laporan," maxlength='255' ","","text");
              ?>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php
                input_text("dasar_laporan",$dasar_laporan," maxlength='255' ","","text");
              ?>
            </div>
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label>Teknis Pengumpulan Data</label>
              <?php
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('sanitasi/laporan/simpan_urutan');?>" onClick="return cek();">
...
?> 
  <div class="content-wrapper">
    ...
    <section class="content">
  <?php echo form_open_multipart('sanitasi/laporan/clone/'.$id,' id="signupform" '); ; 
...
?>
  <div class="content-wrapper">
    ...
    <section class="content">
    <div class="row">
      <?php echo form_open_multipart('sanitasi/laporan/struktur/'.$id,' id="signupform" ');
      ...
      <div class="col-md-6">
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                <label>Pilih Foto &nbsp;<small>Format harus jpeg,jpg,png dan Max 2MB</small></label>
                <?php
                  input_text("upload_Files[]","","","","file");
                ?>               
              </div>
              <div class="col-md-12">
                <label>No Regulasi / Peraturan / Berkas</label>
                <?php
                  input_text("no_berkas",$no_berkas,"maxlength='255' autofocus","Masukkan No","text");
                ?>
              </div>
              <div class="col-md-12">
                <label>Nama / Judul Berkas</label>
                <?php
                  input_text("nama_berkas",$nama_berkas,"maxlength='255'","Masukkan Nama","text");
                ?>               
              </div>
            </div>
          </div>
          <div class="box-footer">
            <button type="submit" name="action" value="BtnUpload" class="btn btn-primary"><i class="fa fa-upload"></i> Upload</button>
          </div>
        </div>
      </div>
      <div class="col-md-6">
            <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
              <div class="box-header with-border">
                 <h3 class="box-title">PILIH LIST BERKAS (UNCHECK SEMUA UNTUK KOSONGKAN)</h3>
                <div class="box-tools pull-right">
                ...
                <table id="example1" width="100%" class="table table-bordered table-striped table-hover" >
                  ...
                  <tr>
                    <th style="width:5%;text-align:center;vertical-align:middle;">
                      ...
                      <th style="text-align:center;vertical-align:middle;font-weight:bold;">Nama Berkas</th>
                      <th style="text-align:center;vertical-align:middle;font-weight:bold;">Gambar</th>
                      <th style="text-align:center;vertical-align:middle;font-weight:bold;">Keterangan</th>
                  </tr>
                  </thead>
                  <tbody>
                    <?php
      /*              $kondisi=array('id_logbooker'=>$this->session->id_pegawai,'tolak >'=> 0);
                    ...
                    foreach($ol_berkas as $row){
                      if (in_array($row['id_berkas'],explode(",", $struktur_organisasi))){ 
                        $tol = 'checked'; 
                      }else{ 
                        $tol = ''; 
                      }
                  ...
                  <tr>
                    <td style="vertical-align:middle;text-align:left;">
                      <div class="checkbox">
                      <label>
                        <input type="checkbox" class="child" name="chk[]" value="<?php echo $row['id_berkas'];?>" <?= $tol ?> >
                      </label>
                      </div>
                    </td>
                    <td style="vertical-align:middle;"><?php echo $row['nama_berkas']; ?></td>
                    <td style="vertical-align:middle;text-align:left;">
                      <a class="example-image-link" href="<?php echo base_url('assets/berkas/im/'.$row['link_berkas']);?>"
                        data-lightbox="example-set" data-title="<?php echo $row['nama_berkas']; ?>">
                        <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url('assets/berkas/resize/'.$row['link_berkas']);?>" style="width: 150;height: 150;" alt="Photo">
                      </a>
                    </td>
                    <td style="vertical-align:middle;"><?php echo $row['no_berkas']; ?></td>
                  </tr>
                    <?php
                    }
                    ?>
              ...
              <div class="box-footer">
                <button type="submit" name="action" value="BtnSimpan" class="btn btn-success"><i class="fa fa-save"></i> Simpan</button>
              </div>
            </div>        
      </div>
      <?php echo form_close(); ?>  
      <div class="col-md-12">
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
          <div class="box-header with-border">
             <h3 class="box-title">Daftar Berkas di Laporan <?= $judul_laporan ?></h3>
            <div class="box-tools pull-right">

            </div>
          </div>
          <div class="box-body">
            <table id="example2" width="100%" class="table table-bordered table-striped table-hover" >
              <thead>
              <tr>
                  <th style="text-align:center;vertical-align:middle;font-weight:bold;">Nama Berkas</th>
                  <th style="text-align:center;vertical-align:middle;font-weight:bold;">Gambar</th>
  ...
  /*              $kondisi=array('id_logbooker'=>$this->session->id_pegawai,'tolak >'=> 0);
                ...
                $eimplokw_tolak = implode(",", $kw_tolak);*/
                foreach($ol_berkas_in as $rowbrk){
  /*                if (in_array($row['id_berkas'],explode(",", $regulasi))){ 
                    $tol = 'checked'; 
                  }else{ 
                    $tol = ''; 
                  }*/
                ?>
              <tr>
                <td style="vertical-align:middle;"><?php echo $rowbrk['nama_berkas']; ?></td>
            ...
            <a class="example-image-link" href="<?php echo base_url('assets/berkas/im/'.$row['link_berkas']);?>"
              ...
              <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url('assets/berkas/resize/'.$row['link_berkas']);?>" style="width: 150;height: 150;" alt="Photo">
                ...
                <td style="vertical-align:middle;"><?php echo $rowbrk['no_berkas']; ?></td>
              </tr>
                <?php
                }
                ?>
...
?>
  <div class="content-wrapper">
    ...
    <section class="content">
    <div class="row">
      <?php echo form_open_multipart('sanitasi/laporan/regulasi/'.$id,' id="signupform" ');
        input_text("barcode_laporan",$barcode_laporan,"","","hidden");
      ?>
      <div class="col-md-6">
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                 <label>Pilih Berkas &nbsp;<small>Format harus PDF dan Max 2MB</small></label>
                  <?php
                    input_text("upload_Files[]","","","","file");
                  ?>         
              </div>
      ...
      <div class="col-md-6">
            <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
              ...
              <div class="box-body">
                ...
                <th style="text-align:center;vertical-align:middle;font-weight:bold;">Nama Berkas (Klik Untk Lihat)</th>
                <th style="text-align:center;vertical-align:middle;font-weight:bold;">No Berkas / Peraturan / Lainnya</th>
                  </tr>
                  </thead>
                  <tbody>
                    <?php
      /*              $kondisi=array('id_logbooker'=>$this->session->id_pegawai,'tolak >'=> 0);
                  ...
                  <tr>
                    ...
                    <td style="vertical-align:middle;text-align:left;">
                <a href="<?php echo base_url('assets/berkas/im/'.$row['link_berkas']);?>" target="_blank">
                  <?php echo $row['nama_berkas']; ?>
                </a>
                    </td>
                    <td style="vertical-align:middle;"><?php echo $row['no_berkas']; ?></td>
                  </tr>
        ...
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
          ...
          <div class="box-body">
            <table id="example2" width="100%" class="table table-bordered table-striped table-hover" >
              ...
              <tr>
                <td style="vertical-align:middle;">
                <a href="<?php echo base_url('assets/berkas/im/'.$rowbrk['link_berkas']);?>" target="_blank">
                  <?php echo $row['nama_berkas']; ?>
                </a>
                </td>
                <td style="vertical-align:middle;"><?php echo $rowbrk['no_berkas']; ?></td>
...
?>
  <div class="content-wrapper">
    ...
    <section class="content">
    <div class="row">
      <?php echo form_open_multipart('sanitasi/laporan/berkas/'.$id,' id="signupform" ');
        input_text("barcode_laporan",$barcode_laporan,"","","hidden");
      ?>
      <div class="col-md-6">
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
      ...
      /*              $kondisi=array('id_logbooker'=>$this->session->id_pegawai,'tolak >'=> 0);
                    ...
                    $eimplokw_tolak = implode(",", $kw_tolak);*/
                    foreach($ol_berkas as $row){
                      if (in_array($row['id_berkas'],explode(",", $berkas_laporan))){ 
                        $tol = 'checked'; 
                      }else{ 
                        $tol = ''; 
                      }
...
?>
  <div class="content-wrapper">
    ...
    <section class="content">
    <div class="row">
      <?php echo form_open_multipart('sanitasi/laporan/galeri/'.$id,' id="signupform" ');
        input_text("barcode_laporan",$barcode_laporan,"","","hidden");
      ?>
      <div class="col-md-6">
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
              ...
              <div class="box-body">
                <table id="example1" width="100%" class="table table-bordered table-striped table-hover" >
                  ...
                  <tbody>
                    <?php
                    foreach($ol_berkas as $row){
                      if (in_array($row['id_berkas'],explode(",", $galeri_laporan))){ 
                        $tol = 'checked'; 
                      }else{ 
                        $tol = ''; 
                      }
...
?> 
  ...
  <?php echo form_open_multipart('sanitasi/laporan/edit/'.$id,' id="signupform" '); ; 
...
?> 
  <div class="content-wrapper">
    ...
    <section class="content">
  <?php echo form_open_multipart('sanitasi/laporan/tambah_tabel/'.$id,' id="signupform" '); ; 
    input_text("id_laporan",$id_laporan,"","","hidden");
    input_text("barcode_laporan",$barcode_laporan,"","","hidden");
  ?>  
      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
...
#chartdiv {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
  <?php echo form_open_multipart('sanitasi/laporan/edit_tabel/'.$id.'/'.$id2,' id="signupform" '); ; 
    input_text("id_laporan",$id_laporan,"","","hidden");
    input_text("barcode_laporan",$barcode_laporan,"","","hidden");
...
<button type="button" class="btn btn-block btn-<?php echo $arraybox[array_rand($arraybox)]; ?> OpenDisposisi" data-toggle="tooltip" data-placement="right" data-id="<?php echo $id; ?>" data-id2="<?php echo $id2; ?>" title="Rubah Data" data-toggle="modal" data-target="#modal-default">
  Rubah Tabel dan LHU
</button>
            </div>
          </div>  
          ...
          <div class="form-group">
            <label>Rubah Data</label><br>
<button type="button" class="btn btn-<?php echo $arraybox[array_rand($arraybox)]; ?> btn-block OpenLimbah" data-toggle="tooltip" data-placement="right" data-id="<?php echo $id; ?>" data-id2="<?php echo $id2; ?>" title="Rubah Data" data-toggle="modal" data-target="#modal-default">
  Rubah Data Indikator Mutu
          ...
          <div class="form-group">
            <label>Rubah Data</label><br>
<button type="button" class="btn btn-<?php echo $arraybox[array_rand($arraybox)]; ?> btn-block OpenUkur" data-toggle="tooltip" data-placement="right" data-id="<?php echo $id; ?>" data-id2="<?php echo $id2; ?>" title="Rubah Data" data-toggle="modal" data-target="#modal-default">
  Rubah Sumber Pengukuran
</button>
          </div>
          </div>  
  <div class="col-md-12">   
        ...
        <div class="box-body">
              <table id="example2" width="100%" class="table table-bordered table-striped">
                <thead>
                  ...
                  ?>
                    <th style="background-color:#9b0e27;color:white;vertical-align:middle;text-align: center;" rowspan="2">Sumber Pengukuran</th>
                  <?php  
                    }
                  ?>
                  <?php  
                  ...
                  ?>
                    <th style="background-color:#9b0e27;color:white;vertical-align:middle;text-align: center;" rowspan="2">TPS</th>
                  <?php  
                    }
                    $cols = $jumlah_bulan * 2;
                  ?>
                    ...
                    <th style="background-color:#9b0e27;color:white;vertical-align:middle;text-align: center;" colspan="<?= $cols ?>">Realisasi Bulan</th>
                  </tr>
                  <tr>
                    <?php  
...
/*                      }else{
                        $tabel_detil = $this->m_sanitasi->tabel_detil_dgids($id2,$rowtabel_limbah_detil['id_limbah'],$rowonly_blnyear_lhu['blnyear'],$min_tanggal,$max_tanggal,$rowtabel_limbah_detil['id_sumber_emisi']);
                      }*/
        ...
        <div class="box-body">
              <table id="example2" width="100%" class="table table-bordered table-striped">
                <thead>
                  <tr>
                  <?php  
                    $total_cols = $jumlah_bulan * 2;
                  ?>
                    <th style="background-color:#9b0e27;color:white;vertical-align:middle;text-align: center;" rowspan="3">Parameter</th>
                    <th style="background-color:#9b0e27;color:white;vertical-align:middle;text-align: center;" rowspan="3">Baku Mutu</th>
                    <th style="background-color:#9b0e27;color:white;vertical-align:middle;text-align: center;" rowspan="3">Satuan</th>
                    <th style="background-color:#9b0e27;color:white;vertical-align:middle;text-align: center;" colspan="<?= $total_cols ?>">Realisasi Bulan</th>
                  </tr>
                  <tr>
                    <?php  
                      foreach ($only_blnyear_lhu_kelola as $rowonly_blnyear_lhu){
                    ?>
                   <th style="background-color:#9b0e27;color:white;vertical-align:middle;text-align: center;" colspan="2"><?php echo $this->m_rancak->getsemiBulan($rowonly_blnyear_lhu['buln']); ?></th>
                   <?php  
                    }
                   ?>
                  </tr>
                  <tr>
                    <?php  
                      foreach ($only_blnyear_lhu_kelola as $rowonly_blnyear_lhu){
                    ?>
                   <th style="background-color:#9b0e27;color:white;vertical-align:middle;text-align: center;">Hasil</th>
                   <th style="background-color:#9b0e27;color:white;vertical-align:middle;text-align: center;">Kelola</th>
                   <?php  
                    }
                   ?>
                  </tr>
              ...
              <tbody>
                <?php  foreach($tabel_limbah_detil_kelola as $rowtabel_limbah_detil){
                ?>
                <tr>
                  <td><?= $rowtabel_limbah_detil['nama_limbah'] ?></td>
                  <td class="text-right"><?= ROUND($rowtabel_limbah_detil['standar_mutu'],3) ?> <?php if($rowtabel_limbah_detil['range_mutu'] > 0){ echo ' s.d '.ROUND($rowtabel_limbah_detil['range_mutu'],3); } ?></td>
                  <td><?= $rowtabel_limbah_detil['satuan_limbah'] ?></td>
                    <?php  
                      foreach ($only_blnyear_lhu_kelola as $rowonly_blnyear_lhu){
                        $tabel_detil = $this->m_sanitasi->tabel_detil_kelola($id2,$rowtabel_limbah_detil['id_limbah'],$rowonly_blnyear_lhu['blnyear'],$min_tanggal,$max_tanggal,$rowtabel_limbah_detil['id_sumber_emisi']);
                        foreach($tabel_detil as $rowtabel_detil){
                    ?>
                   <td style="vertical-align:middle;text-align: center;"><?= round($rowtabel_detil['hasil_lhu_detil'],3) ?></td>
                   <td style="vertical-align:middle;text-align: center;"><?= round($rowtabel_detil['output_lhu_detil'],3) ?></td>
                   <?php  
                        }
                    }
                   ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content"> 
      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
           <h3 class="box-title">
    <a href="<?php echo base_url('sanitasi/laporan/edit/');?><?= $id ?>"
      class="btn btn-<?php echo $arraybox[array_rand($arraybox)]; ?>" > <i class="fa fa-reply"></i> Kembali
    </a>              
           </h3>
...
.select2-container {
    ...
    padding: 0;
      ...
      <div class="row">
        <div class="col-md-12">
    <FORM method="POST" class="form-horizontal" action="<?php echo base_url('sanitasi/laporan/simpan_rubah_data');?>" onClick="return cek();">
...
.select2-container {
    ...
    padding: 0;
      ...
      <div class="row">
        <div class="col-md-12">
    <FORM method="POST" class="form-horizontal" action="<?php echo base_url('sanitasi/laporan/simpan_rubah_limbah');?>" onClick="return cek();">
          <input type="hidden" name="id_laporan" value="<?= $id_laporan; ?>">
          <input type="hidden" name="barcode_laporan" value="<?= $barcode_laporan; ?>">
          <input type="hidden" name="id_laporan_tabel" value="<?= $id_laporan_tabel; ?>">
          <input type="hidden" name="barcode_laporan_tabel" value="<?= $barcode_laporan_tabel; ?>">
...
.select2-container {
    ...
    padding: 0;
      ...
      <div class="row">
        <div class="col-md-12">
    <FORM method="POST" class="form-horizontal" action="<?php echo base_url('sanitasi/laporan/simpan_rubah_ukur');?>" onClick="return cek();">
          <input type="hidden" name="id_laporan" value="<?= $id_laporan; ?>">
          <input type="hidden" name="barcode_laporan" value="<?= $barcode_laporan; ?>">
          <input type="hidden" name="id_laporan_tabel" value="<?= $id_laporan_tabel; ?>">
          <input type="hidden" name="barcode_laporan_tabel" value="<?= $barcode_laporan_tabel; ?>">
...
.select2-container {
  ...
  //      input_textcustom("",""," autofocus class='form-control input-sm' id='search-inp' ","CARI DI TABEL","text");
      ?>
        ...
        <div class="box-body">
      <?php echo form_open_multipart('sanitasi/lihat/view/'.$id.'/'.$id2.'/'.$id3.'/'.$id4,' id="signupform" '); ?>
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
          <h3 class="box-title">RANGE /PERIODE TANGGAL</h3>
        </div>
...
?>
 ...
 <!--          <a href="invoice-print.html" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
         <button type="button" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> Submit Payment
          ...
          <a href="<?php echo base_url('sanitasi/lihat/laporan/'.$id);?>" class="btn btn-primary pull-right" style="margin-right: 5px;">
            Laporan <i class="fa fa-share"></i>
          </a>
          <a href="<?php echo base_url('sanitasi/lihat/galeri/'.$id);?>" class="btn btn-success pull-right" style="margin-right: 5px;">
          ...
          ?>
          <div class="col-xs-6">
           <a href="<?php echo base_url('sanitasi/lihat/tabel/'.$id.'/'.$rowambil_sn_laporan_tabel['barcode_laporan_tabel']);?>" class="btn btn-block btn-sm bg-<?php echo $btnarray[array_rand($btnarray)]; ?>" style="margin: 5px;"><i class="fa fa-line-chart"></i> <?= $rowambil_sn_laporan_tabel['judul_laporan_tabel'] ?>
            </a>
          </div>
          <?php
            }
 ...
 <!--          <a href="invoice-print.html" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
         <button type="button" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> Submit Payment
          ...
          <a href="<?php echo base_url('sanitasi/lihat/laporan/'.$id);?>" class="btn btn-primary pull-right" style="margin-right: 5px;">
           ...
           <a href="<?php echo base_url('sanitasi/lihat/profil/'.$id);?>" class="btn btn-warning pull-right" style="margin-right: 5px;"><i class="fa fa-reply"></i> Profil
            </a>
        </div>
          <div class="col-xs-12">
            <hr>        
...
-->
      <section class="content-header text-center">
        ...
        <div class="row no-print">
          <div class="col-xs-12">
   <!--          <a href="invoice-print.html" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>-->
               <a href="<?php echo base_url('sanitasi/lihat/laporan/'.$id);?>" class="btn btn-primary pull-right">
              Laporan <i class="fa fa-share"></i>
            </a>
           <a href="<?php echo base_url('sanitasi/lihat/profil/'.$id);?>" class="btn btn-warning pull-right" style="margin-right: 5px;"><i class="fa fa-reply"></i> Profil
            </a>
...
?>
   ...
   <!--          <a href="invoice-print.html" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>-->
           ...
           <a href="<?php echo base_url('sanitasi/lihat/profil/'.$id);?>" class="btn btn-success pull-right" style="margin-right: 5px;"><i class="fa fa-reply"></i> Profil
            </a>
          </div>
          <div class="col-xs-12">
            <hr>          
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('sanitasi/berkas/simpan_rubah');?>" onClick="return cek();">
