...
$("#id2").inputmask("datetime", {
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>sanitasi/<?php echo $page;?>/data/<?php echo $id;?>/<?php echo $id2;?>/<?php echo $id3;?>/<?php echo $id4;?>",
                "type" : "POST"
            },
            "columns": [
                ...
                return row.cp_lhu + ' (' + row.no_cp_lhu + ')';
                      ...
                      { 
                        ...
                        "render": function(data, type, row, meta){
                            if (data !== null && data !== '') {
        return '<a href="<?php echo base_url();?>assets/berkas/sanitasi/'+data+'" target="_blank"><i class="fa fa-search"></i> Lihat Lampiran</a>';
                            } else {
                               return '';
                            }
                        }
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('sanitasi/'.$page.'/tambah'); ?>',function(){
                ...
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        location.href = '<?php echo base_url('sanitasi/'.$page.'/input/'); ?>'+data;
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_lhu'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('sanitasi/'.$page.'/upload/'); ?>'+data;
                    }
                },
/*               {
...
$(document).ready(function() {
    ...
    CKEDITOR.replace('editor1', {enterMode: CKEDITOR.ENTER_BR});
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>sanitasi/lhu/data2/<?php echo $id;?>",
                "type" : "POST"
            },
            "columns": [             
                      { "data": "id_lhu_detil", "searchable":false, "visible":false },
                      { "data": "nama_limbah" },
                      { "data": "nama_sumber_emisi", "searchable":false },                                   
                      { "data": "nama_tps", "searchable":false },                                   
                      { "data": "hasil_lhu_detil", "searchable":false, className: "text-right" },                                   
                      { "data": "output_lhu_detil", "searchable":false, className: "text-right" },                                   
                      { "data": "prosentase", "searchable":false, className: "text-right" },                                   
                      { "data": "standar_mutu", "searchable":false, className: "text-right" },         
                      { "data": "satuan_limbah", "searchable":false },
                      { "data": "ket_lhu_detil", "searchable":false }
            ],
            "order": [[0, 'asc']] ,
            select: 'single',            
            dom: 'Blrtip',
            "buttons": [        
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('sanitasi/lhu/isi/'); ?><?php echo $id;?>',function(){
                            $('#modal-default').modal({show:true});
                          });
                    }
                },
              {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          ...
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('sanitasi/lhu/rubah/'); ?><?php echo $id;?>/'+data,function(){
                              $('#modal-default').modal({show:true});
                            });
                  }
              },          
...
{
?>
const numInputs = document.querySelectorAll('.hasil, .max')
...
$("#id2").inputmask("datetime", {
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
"url"  : "<?php echo base_url();?>sanitasi/<?php echo $page;?>/data/<?php echo $id;?>/<?php echo $id2;?>/<?php echo $id3;?>/<?php echo $id4;?>/<?php echo $id5;?>/<?php echo $id6;?>",
                "type" : "POST"
            },
            "columns": [
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('sanitasi/'.$page.'/tambah'); ?>';
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('sanitasi/'.$page.'/edit/'); ?>'+data;
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_laporan'];                       
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('sanitasi/'.$page.'/clone/'); ?>'+data;
                    }
                },
                {
                    text: "<i class='fa fa-upload'></i> Upload / Pilih Struktur Organisasi",
                    extend: "selected",
                    className: "btnmaroon",
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_laporan'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('sanitasi/'.$page.'/struktur/'); ?>'+data;
                    }
                },
                {
                    text: "<i class='fa fa-upload'></i> Upload / Pilih Regulasi / Berkas Terkait",
                    extend: "selected",
                    className: "btnmaroon",
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_laporan'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('sanitasi/'.$page.'/regulasi/'); ?>'+data;
                    }
                },
                {
                    text: "<i class='fa fa-upload'></i> Upload / Pilih Galeri",
                    extend: "selected",
                    className: "btnmaroon",
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_laporan'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('sanitasi/'.$page.'/galeri/'); ?>'+data;
                    }
                },
                {
                    text: "<i class='fa fa-upload'></i> Upload Berkas Lainnya",
                    extend: "selected",
                    className: "btnmaroon",
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_laporan'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('sanitasi/'.$page.'/berkas/'); ?>'+data;
                    }
                },
 /*               {
                  text: "<i class='fa fa-search'></i> Lihat Laporan",
                  extend: "selected",
                  className: "btnpurple",
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_laporan'];
                        window.open(' echo base_url('sanitasi/'.$page.'/print_laporan/'); ?>'+data);
                    }
                },
                 {
                    ...
                    action: function ( e, dt, node, config ) {
                       kredensial = dt.rows( { selected: true } ).data()[0]['kredensial'];
                        ...
                        if(stspk=='1' && kredensial !== null && kredensial !== '' && mutu !== null && mutu !== '' && etika !== null && etika !== '' && spk !== null && spk !== ''){
                         data = dt.rows( { selected: true } ).data()[0]['barcode_laporan'];
                         window.open(' echo base_url('sanitasi/'.$page.'/pdf_intro/'); ?>'+data);
                        }
                        else{
                            swal({
...
let rekomendasi;
  ...
  Net.load("<?php echo site_url('sanitasi/ambil_analisa/')?><?php echo $id2; ?>").then(function(dt) {
    analisa = JSON.parse(dt.response);
  }).catch(function(dt) {
    console.log("Error loading " + dt.xhr.responseURL);
  });

  Net.load("<?php echo site_url('sanitasi/ambil_rekomendasi/')?><?php echo $id2; ?>").then(function(dt) {
    rekomendasi = JSON.parse(dt.response);
  }).catch(function(dt) {
    console.log("Error loading " + dt.xhr.responseURL);
  });
...
//    am4core.ready(function() {
    ...
    chart.dataSource.url = "<?php echo base_url();?>sanitasi/laporan/pie/<?php echo $id;?>/<?php echo $id2;?>";
...
$("#tgl_akhir").inputmask("datetime", {
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>sanitasi/laporan/data2/<?php echo $id;?>",
                "type" : "POST"
            },
            "columns": [
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('sanitasi/laporan/tambah_tabel/'); ?><?php echo $id;?>';
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('sanitasi/laporan/edit_tabel/'); ?>'+data+'/'+data2;
                    }
                },
              {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          ...
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('sanitasi/laporan/urutan/'); ?><?php echo $id;?>/'+data,function(){
                              $('#modal-default').modal({show:true});
                            });
                  }
              }, 
/*                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        data2 = dt.rows( { selected: true } ).data()[0]['barcode_laporan_tabel'];
                        // alert(JSON.stringify(data));
                        location.href = ' echo base_url('sanitasi/laporan/print_tabel/'); ?>'+data+'/'+data2;
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        data2 = dt.rows( { selected: true } ).data()[0]['barcode_laporan_tabel'];
                        // alert(JSON.stringify(data));
                        window.open(' echo base_url('sanitasi/laporan/pdf_table/'); ?>'+data+'/'+data2);
                    }
                },*/
                {
                    text: "<i class='fa fa-refresh'></i> Reload",
...
elseif ($page=="laporan_berkas" || $page=="laporan_galeri" || $page=="laporan_struktur" || $page=="laporan_regulasi")
{
?>
$('#tgl_a_berkas').datepicker({
  format: 'dd-mm-yyyy',
  autoclose: true
})
$("#tgl_a_berkas").inputmask("datetime", {
    mask: "1-2-y",
    placeholder: "dd-mm-yyyy",
    leapday: "-02-29",
    separator: "-",
...
?>
    ...
    $('.OpenDisposisi').on('click',function(){
        ...
        $('.modal-body').load('<?php echo base_url('sanitasi/laporan/rubah_data/'); ?>'+id+'/'+id2,function(){
            $('#exampleModal').modal({show:true});
        });
    });
    $('.OpenLimbah').on('click',function(){
          var id = $(this).data('id');   
          var id2 = $(this).data('id2');   
        $('.modal-body').load('<?php echo base_url('sanitasi/laporan/rubah_limbah/'); ?>'+id+'/'+id2,function(){
            $('#exampleModal').modal({show:true});
        });
    });
    $('.OpenUkur').on('click',function(){
          var id = $(this).data('id');   
          var id2 = $(this).data('id2');   
        $('.modal-body').load('<?php echo base_url('sanitasi/laporan/rubah_ukur/'); ?>'+id+'/'+id2,function(){
            $('#exampleModal').modal({show:true});
        });
    });
...
=================================
      function getData() {
        $.ajax("https://localhost/pengabdian_ayam/getdata.php", {
          dataType: "json",
          success: function(dt, status, xhr) { // success callback function
            let res = [];
...
function buildTableBody(data, columns) {
    ...
    body.push(columns); // hapus untuk hilangkan header
...
?>
    ...
    ?>
    {
      ...
      <?php
      $no = 0;
      $jsonx = $this->m_sanitasi->grafik_garis_hasil($rowgrafik_garis_opsi['tgl_lhu'],$rowgrafik_garis_opsi['id_limbah']);
...
?>
    ...
    ?>
    {
      ...
      foreach($jsonx as $row2){
          $no++;
      ?>
      <?php echo '"'.$row2['id_limbah'].'"'; ?>:<?php echo round($row2['hasil_lhu_detil'],3); ?>,
      <?php
      }
      ?>
    },
...
/*  valueAxis.renderer.grid.template.location = 3;
  valueAxis.renderer.labels.template.location = 3;*/
...
//    rangerg.label.location = 0.4;
 ...
 //           }
    ...
    ?>
    createSeriesAndAxis(<?php echo '"'.$rowambil_limbah_grafik['id_limbah'].'"'; ?>, <?php echo '"'.$rowambil_limbah_grafik['nama_limbah'].'"'; ?>, true, true, <?php echo round($rowambil_limbah_grafik['standar_mutu'],0); ?>, <?php echo round($rowambil_limbah_grafik['range_mutu'],0); ?>);
    <?php
    }
    ?>
...
chart.hiddenState.properties.opacity = 0; // this creates initial fade-in
    ...
    ?>
    {
      ...
      <?php
      $ambil_all_limbah_grafik = $this->m_sanitasi->ambil_all_limbah_grafik($id2,$rowambil_dt_limbah_grafik['id_limbah']);
      foreach($ambil_all_limbah_grafik as $rowambil_all_limbah_grafik){
      ?>
      value1:<?php echo $rowambil_all_limbah_grafik['cemua']; ?>,
      <?php
      }
      $ambil_sesuai_limbah_grafik = $this->m_sanitasi->ambil_sesuai_limbah_grafik($id2,$rowambil_dt_limbah_grafik['id_limbah']);
...
var lineSeriesData = [];
    ...
    ?>
         <?php echo '"'.$rowgrafik_batang_range_jejer['nama_limbah'].', Bln : '.$limbah.'"'; ?>: {
           "Min": <?php echo round($rowgrafik_batang_range_jejer['standar_mutu'],0); ?>,            
           "Hasil": <?php echo round($rowgrafik_batang_range_jejer['hasil_lhu_detil'],0); ?>,
           "Max": <?php echo round($rowgrafik_batang_range_jejer['range_mutu'],0); ?>,
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_laporan'];                       
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('sanitasi/'.$page.'/profil/'); ?>'+data;
                    }
                },
                {
                ...
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_laporan'];                       
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('sanitasi/'.$page.'/laporan/'); ?>'+data;
                    }
                },
                {
                    text: "<i class='fa fa-refresh'></i> Reload",
...
?>
    $(document).ready(function() {
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>sanitasi/<?php echo $page;?>/data",
                "type" : "POST"
            },
            "columns": [
            ...
            "buttons": [
              {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          ...
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('sanitasi/'.$page.'/rubah/'); ?>'+data,function(){
                              $('#modal-default').modal({show:true});
                            });
                  }
              }, 
