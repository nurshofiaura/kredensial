    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
	       ...
	       <li class="treeview <?php cek_aktif($page,array('lhu','lhu_input','lhu_upload','laporan','laporan_tambah','laporan_edit','laporan_tambah_tabel','laporan_edit_tabel','laporan_print_tabel','laporan_clone','laporan_regulasi','laporan_berkas','laporan_galeri','laporan_struktur','berkas','lihat','lihat_profil','lihat_laporan','lihat_tabel','lihat_galeri')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('lhu','lhu_input','lhu_upload'));?>">
							<a href="<?php echo base_url('sanitasi/lhu');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Capaian Mutu
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('laporan','laporan_tambah','laporan_edit','laporan_tambah_tabel','laporan_edit_tabel','laporan_print_tabel','laporan_clone','laporan_regulasi','laporan_berkas','laporan_galeri','laporan_struktur'));?>">
							<a href="<?php echo base_url('sanitasi/laporan');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Seting Laporan
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('berkas'));?>">
							<a href="<?php echo base_url('sanitasi/berkas');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Manajemen Berkas
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('lihat','lihat_profil','lihat_laporan','lihat_tabel','lihat_galeri'));?>">
							<a href="<?php echo base_url('sanitasi/lihat');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Lihat Laporan
							</a>
						</li>
	          </ul>
	        </li>
