...
tr.shown td.details-control {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	<?php echo form_open_multipart('dokter/daftar/view/'.$first_date.'/'.$last_date.'/'.$key,' id="signupform" '); ;
	?>
	  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
		<div class="box-header with-border">
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="<?php echo base_url('dokter/daftar/tambah/'.$first_date);?>">Pemeriksaan</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li class="active"><a href="<?php echo base_url('dokter/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('dokter/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li class="active"><a href="<?php echo base_url('dokter/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
              <li class="pull-right"><h3><i class="fa fa-server"></i> E REKAM MEDIS</h3></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="<?php echo base_url('dokter/daftar/tambah/'.$first_date);?>">Pemeriksaan</a></li>
              <li class="active"><a href="<?php echo base_url('dokter/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('dokter/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li class="active"><a href="<?php echo base_url('dokter/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('dokter/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li class="active"><a href="<?php echo base_url('dokter/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
              <li class="pull-right"><h3><i class="fa fa-server"></i> E REKAM MEDIS</h3></li>
            </ul>
            <div class="tab-content">
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="<?php echo base_url('dokter/daftar/tambah/'.$first_date);?>">Pemeriksaan</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li class="active"><a href="<?php echo base_url('dokter/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('dokter/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li class="active"><a href="<?php echo base_url('dokter/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
              <li class="pull-right"><h3><i class="fa fa-server"></i> E REKAM MEDIS</h3></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active">
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('dokter/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li class="active"><a href="<?php echo base_url('dokter/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="<?php echo base_url('dokter/daftar/tambah/'.$first_date);?>">Pemeriksaan</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('dokter/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
            ...
            <div class="tab-content">
              <div class="tab-pane active">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class="active"><a href="<?php echo base_url('dokter/daftar/tambah/'.$first_date);?>">Billing Dokter</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_radiologi/'.$first_date);?>">Permintaan Radiologi</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/asesment/'.$first_date);?>">Asesment Dokter</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_lab/'.$first_date);?>">Permintaan Laboratorium</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_apotek/'.$first_date);?>">Permintaan Apotek</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_ugd/'.$first_date);?>">Permintaan Tindakan Keperawatan</a></li>
...
$('#btn_pemeriksaan').on('click',function(){
    ...
    $.ajax({
        type : "POST",
        url  : "<?php echo base_url('dokter/daftar/simpan_tambah_pemeriksaan_billing')?>",
        dataType : "JSON",
      ...
      "oLanguage": {
        ...
        "select": {
          ...
          "rows": {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>dokter/daftar/bil_dokter/<?php echo $first_date;?>",
                "type" : "POST"
            },
            "columns": [
...
/*              {
              ...
              },*/
              {
                ...
                className: "btnred",
                  action: function ( e, dt, node, config ) {
                      data = dt.rows( { selected: true } ).data()[0]['barcode_pemeriksaan'];
                      $("#modal-default").modal();
                        $('.modal-body').load('<?php echo base_url('dokter/daftar/hapus_pemeriksaan/'); ?>'+data,function(){
                          $('#modal-default').modal({show:true});
                        });
    ...
    $('select[name=id_kelas]').on('change',function(){
        $.ajax({
            url:'<?php echo base_url();?>dokter/data_pemeriksaan_dokter/'+$(this).val(),
            type: "POST",
            dataType: 'json'
         }).done(function(data) {
               var len = data.length;
...
$('#btn_hapus').on('click',function(){
    ...
    $.ajax({
        type : "POST",
        url  : "<?php echo base_url('dokter/daftar/simpan_hapus_pemeriksaan')?>",
        dataType : "JSON",
...
.select2-container {
    ...
    <FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('dokter/pemeriksaan/simpan_edit_pemeriksaan');?>" onClick="return cek();">
      <input type="hidden" name="barcode_pemeriksaan" id="barcode_pemeriksaan" value="<?= $barcode_pemeriksaan; ?>">
...
elseif ($page=="daftar_tambah_radiologi")
{
?>
<style>
.select2-container {
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="tab-pane active">
                <div class="nav-tabs-custom">
                <ul class="nav nav-tabs pull-right">
                  <li><a href="<?php echo base_url('dokter/daftar/tambah/'.$first_date);?>">Billing Dokter</a></li>
                  <li class="active"><a href="<?php echo base_url('dokter/daftar/tambah_radiologi/'.$first_date);?>">Permintaan Radiologi</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/asesment/'.$first_date);?>">Asesment Dokter</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_lab/'.$first_date);?>">Permintaan Laboratorium</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_apotek/'.$first_date);?>">Permintaan Apotek</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_ugd/'.$first_date);?>">Permintaan Tindakan Keperawatan</a></li>
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="datadaftar">
                      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
                        ...
                        </div><?php echo form_open('dokter/daftar/tambah_radiologi/'.$first_date,' '); 
input_text("barcode_pendaftaran_unit",$barcode_pendaftaran_unit,"","","hidden");
input_text("barcode_pendaftaran",$barcode_pendaftaran,"","","hidden");
input_text("id_status_pasien",$id_status_pasien,"","","hidden");
input_text("unit_ke_lobby",2,"","","hidden");
?>
                        <div class="box-body">
                      <!--     <div id="pemeriksaane" class="pemeriksaane"></div>    -->
...
elseif ($page=="daftar_pemeriksaan_radiologi")
{
?>
<style>
.select2-container {
...
<input type="hidden" name="id_detil_cara_bayar" id="id_detil_cara_bayar" value="<?= $id_detil_cara_bayar; ?>">
<input type="hidden" name="id_status_pasien" id="id_status_pasien" value="<?= $id_status_pasien; ?>">
<input type="hidden" name="unit_ke" id="unit_ke" value="2">
  <div class="box box-<?php echo $thenarray; ?> box-solid">
    <div class="box-header with-border">
       <h3 class="box-title">INPUT TINDAKAN / PEMERIKSAAN</h3>
...
$('#btn_pemeriksaan').on('click',function(){
    var id=$('#barcode_tindakan_tarif').val();
    var bape=$('#barcode_pendaftaran').val();
    var no=$('#no_pemeriksaan').val();
    var ket=$('#ket_pemeriksaan').val();
    var tgl=$('#tgl_pemeriksaan').val();
    var tgl_lahir=$('#tgl_lahir').val();
    ...
    var st=$('#id_status_pasien').val();
    var uke=$('#unit_ke').val();
    var ike=$('#id_kelas').val();
    $.ajax({
        type : "POST",
        url  : "<?php echo base_url('dokter/daftar/simpan_tambah_pemeriksaan_lab')?>",
        dataType : "JSON",
        data : {id:id, no:no, tgl:tgl, jml:jml, daftar:daftar, tgl_lahir:tgl_lahir, ket:ket, cb:cb, dcb:dcb, st:st, uke:uke, bape:bape, ike:ike},
        success: function(data){
      ...
      "oLanguage": {
        ...
        "select": {
          ...
          "rows": {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>dokter/daftar/bil_radiologi/<?php echo $first_date;?>",
                "type" : "POST"
            },
            "columns": [
                      { "data": "tgl_pemeriksaan", "searchable":false },
...
/*              {
    ...
    $('select[name=id_kelas]').on('change',function(){
        $.ajax({
            url:'<?php echo base_url();?>dokter/data_pemeriksaan_radiologi/'+$(this).val(),
            type: "POST",
            dataType: 'json'
         }).done(function(data) {
               var len = data.length;
    ...
    <section class="content">
      ...
      <div class="row">
            ...
            <div class="tab-content">
              <div class="tab-pane active">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li><a href="<?php echo base_url('dokter/daftar/tambah/'.$first_date);?>">Billing Dokter</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_radiologi/'.$first_date);?>">Permintaan Radiologi</a></li>
                  <li class="active"><a href="<?php echo base_url('dokter/daftar/asesment/'.$first_date);?>">Asesment Dokter</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_lab/'.$first_date);?>">Permintaan Laboratorium</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_apotek/'.$first_date);?>">Permintaan Apotek</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_ugd/'.$first_date);?>">Permintaan Tindakan Keperawatan</a></li>
                  <li class="pull-left header"><i class="fa fa-money"></i> Billing</li>
                  ...
                  <div class="tab-content">
                    <?php echo form_open_multipart('dokter/daftar/asesment/'.$first_date,'  '); 
                      input_text("barcode_pendaftaran_unit",$barcode_pendaftaran_unit,"","","hidden");
                      input_text("barcode_pendaftaran",$barcode_pendaftaran,"","","hidden");
                      input_text("id_status_pasien",$id_status_pasien,"","","hidden");
                      input_text("id_icd101",$id_icd101,"","","hidden");
                      input_text("id_icd102",$id_icd102,"","","hidden");
                      input_text("id_icd103",$id_icd103,"","","hidden");
                    ?>                  
                    <div class="tab-pane active" id="datadaftar">
                      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
                        <div class="box-header with-border">
       ...
       <div class="col-md-6">
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
          ...
          <div class="box-body">
            <?php
              input_textareacustom("subjective",$subjective," id='editor1' rows='10' cols='100' class='form-control' ","Keterangan");
            ?>  
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
          ...
          <div class="box-body">
            <?php
              input_textareacustom("objective",$objective," id='editor2' rows='10' cols='100' class='form-control' ","Keterangan");
            ?>  
          </div>
        </div>
      </div> 
      <div class="col-md-6">
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
          <div class="box-header with-border">
             <h3 class="box-title">ASESMENT</h3>
          ...
          <div class="box-body">
            <?php
              input_textareacustom("asesment",$asesment," id='editor3' rows='10' cols='100' class='form-control' ","Keterangan");
            ?>  
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
          ...
          <div class="box-body">
            <?php
              input_textareacustom("planning",$planning," id='editor4' rows='10' cols='100' class='form-control' ","Keterangan");
            ?>  
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
          <div class="box-header with-border">
             <h3 class="box-title">IMPLEMENTASI</h3>
          ...
          <div class="box-body">
            <?php
              input_textareacustom("implementasi",$implementasi," id='editor5' rows='10' placeholder='' cols='100' class='form-control' ","Keterangan");
            ?>  
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
          ...
          <div class="box-body">
             <label>Diagnosa 1 (Ketik Kode / Nama ICD)</label>
              <?php
                input_text("nama_icd101",$nama_icd101,"  ","Ketik ICD / Kode ICD","text");
              ?>  
             <label>Diagnosa 2 (Ketik Kode / Nama ICD)</label>
              <?php
                input_text("nama_icd102",$nama_icd102,"  ","Ketik ICD / Kode ICD","text");
              ?>  
             <label>Diagnosa 3 (Ketik Kode / Nama ICD)</label>
              <?php
                input_text("nama_icd103",$nama_icd103,"  ","Ketik ICD / Kode ICD","text");
              ?>  
...
<div class="col-md-12">
<p style="font-weight:bold;">1. Tulis bagian subjektif (S)</p>

<p style="text-indent: 10px;">Pada bagian ini, tuliskan riwayat medis pasien dan hasil temuan subjektif Anda berdasarkan laporan medis pasien tersebut. Riwayat pasien yang dicantumkan pada bagian “Subjektif” umumnya meliputi etiologi (penyebab utama penyakit) atau MOI (Mechanism of Injury) alias mekanisme cedera, C.C. (Chief Complaint) atau keluhan utama, gejala penyakit, deskripsi keluhan, dan riwayat pasien.</p>

<p style="text-indent: 10px;">Riwayat pasien memiliki porsi paling besar dalam catatan SOAP, terutama karena memahami riwayat pasien sangat diperlukan untuk menentukan dan mempersempit perkiraan/potensi cedera pasien. Saat mengajukan pertanyaan, hindari pertanyaan tertutup yang hanya bisa dijawab dengan “ya” atau “tidak”. Misalnya, jangan bertanya, “Di bagian itu sakit, ya?”</p>

<p style="font-weight:bold;">2. Tulis bagian objektif (O)</p>

<p style="text-indent: 10px;">Bagian O dari catatan Rekam Medis SOAP berisi hasil observasi kuantitatif Anda sebagai tenaga medis, seperti jarak pandang, palpasi jaringan lunak dan keras, lingkar pinggang, ROM (Range of Motion) atau rentang gerak - AROM, PROM dan RROM alias Active, Passive, dan Resistive Range of Motion (Rentang Gerak Aktif, Pasif, dan Resistif), hasil tes otot manual, penilaian neurologis, sirkulasi darah, dan hasil pemeriksaan khusus pasien lain.</p>

<p style="text-indent: 10px;">Jika dilakukan pemeriksaan khusus lain (termasuk pemeriksaan jaringan lunak dan keras, pemeriksaan neurologis, dsb.), masukkan pula hasilnya ke dalam catatan Anda. Pada bagian ini, pastikan Anda mempersempit potensi cedera dan menentukan diagnosis pasien. Misalnya, pada tahap ini Anda akan menemukan apakah masalah utama pasien terjadi di daerah otot atau justru di ligamennya.</p>

<p style="font-weight:bold;">3. Tulis bagian penilaian (A)</p>

<p style="text-indent: 10px;">Cantumkan diagnosis yang paling memungkinkan pada bagian ini. Jika diagnosis akhir belum berhasil didapatkan, Anda bisa mencantumkan beberapa kemungkinan diagnosis terlebih dahulu. Jika ada, cantumkan pula beberapa diagnosis tambahan yang perlu diperhatikan.</p>
            ...
            <div class="tab-content">
              <div class="tab-pane active">
                ...
                <ul class="nav nav-tabs pull-right">
                  ...
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_radiologi/'.$first_date);?>">Permintaan Radiologi</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/asesment/'.$first_date);?>">Asesment Dokter</a></li>
                  <li class="active"><a href="<?php echo base_url('dokter/daftar/tambah_lab/'.$first_date);?>">Permintaan Laboratorium</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_apotek/'.$first_date);?>">Permintaan Apotek</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_ugd/'.$first_date);?>">Permintaan Tindakan Keperawatan</a></li>
                  <li class="pull-left header"><i class="fa fa-money"></i> Billing</li>
                </ul>
                  <div class="tab-content">
                    <div class="tab-pane active" id="datadaftar">
                      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
                        <div class="box-header with-border">
                           <h3 class="box-title">PILIH PEMERIKSAAN LABORATORIUM</h3>
...
<?php echo form_open('dokter/daftar/tambah_lab/'.$first_date,' '); 
input_text("barcode_pendaftaran_unit",$barcode_pendaftaran_unit,"","","hidden");
input_text("barcode_pendaftaran",$barcode_pendaftaran,"","","hidden");
input_text("id_status_pasien",$id_status_pasien,"","","hidden");
input_text("unit_ke_lobby",3,"","","hidden");
?>
                        <div class="box-body">
                      <!--    <div id="labe" class="labe"></div> -->
            <label>Keterangan</label>
              <?php
                input_text("ket_lobby",$ket_lobby," maxlength='255' autofocus","Keterangan Disini","text");
              ?>
            ...
            <div class="tab-content">
              <div class="tab-pane active">
                ...
                <ul class="nav nav-tabs pull-right">
                  ...
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_lab/'.$first_date);?>">Permintaan Laboratorium</a></li>
                  <li><a href="<?php echo base_url('dokter/daftar/tambah_apotek/'.$first_date);?>">Permintaan Apotek</a></li>
                  <li class="active"><a href="<?php echo base_url('dokter/daftar/tambah_ugd/'.$first_date);?>">Permintaan Tindakan Keperawatan</a></li>
                  <li class="pull-left header"><i class="fa fa-money"></i> Billing</li>
                </ul>
                  <div class="tab-content">
                    <div class="tab-pane active" id="datadaftar">
...
<?php echo form_open('dokter/daftar/tambah_ugd/'.$first_date,' '); 
input_text("barcode_pendaftaran_unit",$barcode_pendaftaran_unit,"","","hidden");
input_text("barcode_pendaftaran",$barcode_pendaftaran,"","","hidden");
input_text("id_status_pasien",$id_status_pasien,"","","hidden");
input_text("unit_ke_lobby",6,"","","hidden");
?>
                        <div class="box-body">
                      <!--    <div id="labe" class="labe"></div> -->
            <label>Keterangan</label>
...
<input type="hidden" name="id_detil_cara_bayar" id="id_detil_cara_bayar" value="<?= $id_detil_cara_bayar; ?>">
<input type="hidden" name="id_status_pasien" id="id_status_pasien" value="<?= $id_status_pasien; ?>">
<input type="hidden" name="unit_ke" id="unit_ke" value="3">
  <div class="box box-<?php echo $thenarray; ?> box-solid">
    <div class="box-header with-border">
       <h3 class="box-title">INPUT TINDAKAN / PEMERIKSAAN</h3>
      ...
      "oLanguage": {
        ...
        "select": {
          ...
          "rows": {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>dokter/daftar/bil_lab/<?php echo $first_date;?>",
                "type" : "POST"
            },
            "columns": [
                      { "data": "tgl_pemeriksaan", "searchable":false },
...
/*              {
    ...
    $('select[name=id_kelas]').on('change',function(){
        $.ajax({
            url:'<?php echo base_url();?>dokter/data_pemeriksaan_lab/'+$(this).val(),
            type: "POST",
            dataType: 'json'
         }).done(function(data) {
               var len = data.length;
