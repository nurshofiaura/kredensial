...
$mene_level = $this->m_umum->ambil_data('user_level','id_level',$this->session->id_level);
            ...
            <ul class="dropdown-menu" style="box-shadow:10px 10px 5px grey; margin-right: 5px;">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small><?php echo $room_name; ?></small>
                </p>
              </li>
              <!-- Menu Footer-->
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <p><small>
          	<?php
          	$wekaweka = $this->m_rancak->ambil_pk_pegawai($this->session->id_pegawai);
          	if($wekaweka['id_kode_kewenangan'] == NULL){
          		echo $level_name; 
          	}else{
          	 echo $wekaweka['nama_kode_kewenangan'];           		
          	}
         		?>
         	</small></p>
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $room_name; ?></li>
		<li><a href="<?php echo base_url($this->session->beranda);?>">
			<i class="fa fa-dashboard text-<?php echo $v; ?>"></i> 
			<span><?= $mene_level['nama_level'] ?></span></a>
		</li>
    <li class="treeview <?php cek_aktif($page,array()); ?>">
      <a href="#">
        <i class="fa fa-link text-<?php echo $v; ?>"></i>
        <span>Multi Akses</span>
      ...
      <ul class="treeview-menu">
      	<?php
      		$ambil_hak_akses_pegawai = $this->m_rancak->ambil_hak_akses_pegawai($this->session->id_pegawai);
      		foreach($ambil_hak_akses_pegawai as $rowambil_hak_akses_pegawai){
      	?>
         <li class="<?php cek_aktif($page,array());?>">
						<a href="<?php echo base_url($rowambil_hak_akses_pegawai['link_akses']);?>">
							<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> 
								<?= $rowambil_hak_akses_pegawai['nama_akses'] ?>
						</a>
					</li>
      	<?php
      		}
       ...
       <li class="treeview <?php cek_aktif($page,array('berkas','berkas_tambah','ijasah','ijasah_tambah','pelatihan','pelatihan_tambah',
			'surat_ijin','surat_ijin_tambah','download')); ?>">
          <a href="#">
            <i class="fa fa-server text-<?php echo $v; ?>"></i>
            <span>Data</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('berkas','berkas_tambah'));?>">
				<a href="<?php echo base_url('pegawai/berkas');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Berkas
				</a>
			</li>
            <li class="<?php cek_aktif($page,array('ijasah','ijasah_tambah'));?>">
				<a href="<?php echo base_url('pegawai/ijasah');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Ijasah
				</a>
			</li>
            <li class="<?php cek_aktif($page,array('pelatihan','pelatihan_tambah'));?>">
				<a href="<?php echo base_url('pegawai/pelatihan');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pelatihan
				</a>
			</li>
            <li class="<?php cek_aktif($page,array('surat_ijin','surat_ijin_tambah'));?>">
				<a href="<?php echo base_url('pegawai/surat_ijin');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Surat Ijin
				</a>
			</li>
            <li class="<?php cek_aktif($page,array('download'));?>">
				<a href="<?php echo base_url('pegawai/download');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pengumuman
				</a>
			</li>
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('logbook','logbook_tambah')); ?>">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('logbook','logbook_tambah'));?>">
				<a href="<?php echo base_url('pegawai/logbook');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Isi Logbook
				</a>
			</li>
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('seting_dupak','seting_dupak_tambah','seting_dupak_transfer','logbook_dupak','logbook_dupak_tambah',
				'dupak','dupak_tambah')); ?>">
          <a href="#">
            <i class="fa fa-book text-<?php echo $v; ?>"></i>
            <span>Dupak</span>
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('seting_dupak','seting_dupak_tambah','seting_dupak_transfer'));?>">
				<a href="<?php echo base_url('pegawai/seting_dupak');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pilih Butir Kegiatan
				</a>
			</li>
            <li class="<?php cek_aktif($page,array('logbook_dupak','logbook_dupak_tambah'));?>">
				<a href="<?php echo base_url('pegawai/logbook_dupak');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pilih Logbook => Dupak
				</a>
			</li>
            <li class="<?php cek_aktif($page,array('dupak','dupak_tambah'));?>">
				<a href="<?php echo base_url('pegawai/dupak');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Dupak
				</a>
			</li>
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_isi','berkas_logbook','berkas_str',
				'berkaslain_berkas','berkas_etik','berkas_sertifikat','berkas_ijasah')); ?>">
          <a href="#">
            <i class="fa fa-book text-<?php echo $v; ?>"></i>
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_isi','berkas_logbook','berkas_str',
							'berkaslain_berkas','berkas_etik','berkas_sertifikat','berkas_ijasah'));?>">
							<a href="<?php echo base_url('pegawai/pengajuan_kompetensi');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kompetensi/ Kredensial
							</a>
						</li>
          </ul>
        </li>
				<li class="treeview <?php cek_aktif($page,array('penilaian_kinerja','fppe')); ?>">
           <a href="#">
             <i class="fa fa-book text-<?php echo $v; ?>"></i>
           ...
           <ul class="treeview-menu">
             <li class="<?php cek_aktif($page,array('penilaian_kinerja'));?>">
			 				<a href="<?php echo base_url('pegawai/penilaian_kinerja');?>">
			 					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> OPPE
			 				</a>
 						 </li>
             <li class="<?php cek_aktif($page,array('fppe'));?>">
			 				<a href="<?php echo base_url('pegawai/fppe');?>">
			 					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> FPPE
			 				</a>
 						 </li>
           </ul>
         </li>
        <li class="treeview <?php cek_aktif($page,array('pie','lt','lb','lh')); ?>">
          <a href="#">
			<i class="fa fa-area-chart text-<?php echo $v; ?>"></i>
            <span> Grafik</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          ...
          <ul class="treeview-menu">
			<li class="treeview <?php cek_aktif($page,array('lt','lb','lh')); ?>">
			  <a href="#"><i class="fa fa-line-chart text-<?php echo $v; ?>"></i> Grafik Line
				<span class="pull-right-container">
				  <i class="fa fa-angle-left pull-right"></i>
				</span>
			  </a>
