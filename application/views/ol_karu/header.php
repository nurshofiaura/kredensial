...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-lg"><b>E T I K</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php cek_aktif($page,array('etik','etik_edit','etik_tambah'));?>">
					<a href="<?php echo base_url('ol_etik/etik');?>">
        ...
        <li class="<?php cek_aktif($page,array('ms_etik','ms_etik_edit','ms_etik_tambah'));?>">
					<a href="<?php echo base_url('ol_etik/ms_etik');?>">
        ...
        <li class="<?php cek_aktif($page,array('etik_pegawai','etik_pegawai_lihat','etik_pegawai_tambah'));?>">
					<a href="<?php echo base_url('ol_etik/etik_pegawai');?>">
