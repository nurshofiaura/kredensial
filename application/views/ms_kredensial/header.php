...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url($this->session->beranda);?>" class="logo">
      ...
      <span class="logo-lg"><b>KREDENSIAL</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview <?php cek_aktif($page,array('kompetensi','kewenangan')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('kompetensi'));?>">
							<a href="<?php echo base_url('master_kredensial/kompetensi');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kompetensi
							</a>
						</li>
            <li class="<?php cek_aktif($page,array('kewenangan'));?>">
							<a href="<?php echo base_url('master_kredensial/kewenangan');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kewenangan
							</a>
						</li>
          </ul>
        </li>
