    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
	       ...
	       <li class="treeview <?php cek_aktif($page,array('pegawai_pengurus','pegawai_pengurus_tambah','pegawai_pengurus_edit','pengurus','pengurus_edit','pengurus_tambah','cabang','cabang_edit','user','unit','registrasi','registrasi_aktifasi')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('cabang','cabang_edit'));?>">
							<a href="<?php echo base_url('ol_administrator/cabang');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Wilayah / Daerah
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('pengurus','pengurus_edit','pengurus_tambah'));?>">
							<a href="<?php echo base_url('ol_administrator/pengurus');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Nama Pengurus
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('pegawai_pengurus','pegawai_pengurus_edit','pegawai_pengurus_tambah'));?>">
							<a href="<?php echo base_url('ol_administrator/pegawai_pengurus');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pilih Anggota Pengurus
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('registrasi','registrasi_aktifasi'));?>">
							<a href="<?php echo base_url('ol_administrator/registrasi');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Aktifasi
							</a>
						</li>
	           <li class="<?php cek_aktif($page,array('user'));?>">
							<a href="<?php echo base_url('ol_administrator/user');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> User
							</a>
						</li>
	          </ul>
	        </li>
	       <li class="treeview <?php cek_aktif($page,array('pengajuan_korespodensi','pengajuan_korespodensi_validasi')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('pengajuan_korespodensi','pengajuan_korespodensi_validasi'));?>">
							<a href="<?php echo base_url('ol_administrator/pengajuan_korespodensi');?>">
