  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview <?php cek_aktif($page,array('daftar','daftar_tambah','pemeriksaan','hasil','lobby')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('lobby'));?>">
							<a href="<?php echo base_url('radiologi/lobby');?>"><i class="fa fa-clock-o text-<?php echo $v; ?>"></i>
								Lobby
							</a>
						</li>	
            ...
            <li class="<?php cek_aktif($page,array('pemeriksaan'));?>">
							<a href="<?php echo base_url('radiologi/pemeriksaan');?>"><i class="fa fa-clock-o text-<?php echo $v; ?>"></i>
								Pemeriksaan
							</a>
						</li>			
            <li class="<?php cek_aktif($page,array('hasil'));?>">
							<a href="<?php echo base_url('radiologi/hasil');?>"><i class="fa fa-clock-o text-<?php echo $v; ?>"></i>
								Hasil
							</a>
						</li>				
          </ul>
