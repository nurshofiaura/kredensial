...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	<?php echo form_open_multipart('analisa/pengajuan_kompetensi/view/'.$id,' id="signupform" ');
	?>
	  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
		<div class="box-header with-border">
...
#chartdiv {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	<?php echo form_open_multipart('analisa/pengajuan_kompetensi/bcp/'.$id.'/'.$all.'/'.$first_date.'/'.$last_date,' id="signupform" '); ?>
	  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
		<div class="box-header with-border">
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	<?php echo form_open_multipart('analisa/multi_akses/view/'.$id,' id="signupform" ');
	?>
	  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
		<div class="box-header with-border">
		  <h3 class="box-title">MULTIPLE SEARCH</h3>
		  ...
		  <div class="box-body">
				<div class="col-md-12">
					<div class="form-group">
					  <label> Ketik multiple pisahkan dengan spasi untuk Akses dan Nama</label>
							<?php
								input_text("id",$id," autofocus","Ketik multiple pisahkan dengan spasi atau -","text");
							?>
					</div>
        ...
        <div class="box-body">
			<table id="dttb" width="100%" class="table table-bordered table-striped table-hover" >
				<thead>
					<tr>
					  <th style="vertical-align: middle; width: 5%;">ID</th>
					  <th style="vertical-align: middle; width: 5%;">ID PEG</th>
					  <th style="vertical-align: middle;">Nama Pegawai</th>
					  <th style="vertical-align: middle;">Nama Akses</th>
