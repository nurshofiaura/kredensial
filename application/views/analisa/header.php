      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>
				...
				<li class="<?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_logbook')); ?>">
						<a href="<?php  echo base_url('analisa/pengajuan_kompetensi');?>">
							<i class="fa fa-dashboard text-<?php echo $v; ?>"></i> 
							<span>Pengajuan Kompetensi</span>
						</a>
				</li>
				<li class="<?php cek_aktif($page,array('pengajuan_kompetensi_bcp')); ?>">
						<a href="<?php  echo base_url('analisa/pengajuan_kompetensi/bcp');?>">
							<i class="fa fa-dashboard text-<?php echo $v; ?>"></i> 
							<span>Buku catatan Pribadi</span>
						</a>
				</li>
				<li class="<?php cek_aktif($page,array('multi_akses')); ?>">
						<a href="<?php  echo base_url('analisa/multi_akses');?>">
							<i class="fa fa-dashboard text-<?php echo $v; ?>"></i> 
