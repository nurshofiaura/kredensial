...
else if ($page=="pegawai_pengurus_tambah" || $page=="etik_tambah" || $page=="etik_edit" || $page=="struktur_tambah" || $page=="pegawai_struktur_tambah" || $page=="pegawai_struktur_edit"  || $page=="ms_etik_tambah" || $page=="ms_etik_edit"  || $page=="etik_pegawai_lihat")
{
?>
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ol_daftar/<?php echo $page;?>/data/<?php echo $id;?>",
                "type" : "POST"
            },
            "columns": [
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/aktifasi/'); ?>'+data;
                    }
                },
                 {
                     ...
                     .then((willDelete) => {
                       if (willDelete) {
                         location.href = '<?php echo base_url('ol_daftar/'.$page.'/hapus/'); ?>'+data; //[Modif Disini]
                       }
                     });
                    }
                 },
...
else if ($page=="work_tambah" || $page=="work_edit"  || $page=="daftar_registrasi_aktifasi" || $page=="user_tambah" || $page=="user_edit" || $page=="cabang_tambah" || $page=="cabang_edit")
{
?>
    $('select[name=id_prov]').on('change',function(){
        $.ajax({
            url:'<?php echo base_url();?>ol_daftar/kab_data/'+$(this).val(),
            type: "POST",
            dataType: 'json'
         }).done(function(data) {
...
// alert("id="+data[1]["id_kab"]+" nama="+data[1]["nama_kab"]);
    ...
    $('select[name=id_kab]').on('change',function(){
        $.ajax({
            url:'<?php echo base_url();?>ol_daftar/kec_data/'+$(this).val(),
            type: "POST",
            dataType: 'json'
         }).done(function(data) {
               var len = data.length;
    ...
    $('select[name=id_kec]').on('change',function(){
        $.ajax({
            url:'<?php echo base_url();?>ol_daftar/kel_data/'+$(this).val(),
            type: "POST",
            dataType: 'json'
         }).done(function(data) {
               var len = data.length;
     ...
     $('select[name=id_jabatan_fungsional]').on('change',function(){
        $.ajax({
            url:'<?php echo base_url();?>ol_daftar/pengcab/'+$(this).val(),
            type: "POST",
            dataType: 'json'
         }).done(function(data) {
            // alert(data[0]["nama_kab"]);
	...
	$('.select2').select2()
		$("#username").on("input", function(e) {
			...
			if ($('#username').val() == null || $('#username').val() == "") {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>ol_daftar/check_availability",
...
$('select[name=tipe_pegawai]').on('change',function(){
    $.ajax({
        url:'<?php echo base_url();?>ol_daftar/jabfung_data/'+$(this).val(),
        type: "POST",
        dataType: 'json'
     }).done(function(data) {
        // alert(data[0]["nama_kab"]);
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ol_daftar/<?php echo $page;?>/data",
                "type" : "POST"
            },
            "columns": [
                      { "data": "id_working","searchable":false,"visible":false },
                      { "data": "nama_working" },
                      { "data": "nama_kategori_work", "searchable":false },
                      { "data": "alamat_working", "searchable":false },
                      { "data": "kontak_working", "searchable":false },
                      { "data": "email_working", "searchable":false }
            ],
            "order": [[0, 'desc']] ,
            select: 'single',
            dom: 'Blrtip',
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/tambah'); ?>';
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/edit/'); ?>'+data;
                    }
                },
                {
                    text: "<i class='fa fa-refresh'></i> Reload",
                      ...
                      { "data": "status_pegawai_instansi",
                        "render": function(data, type, row){
                            if (row.status_pegawai_instansi === '0') {
                               return '<button class="btn btn-xs btn-danger">RESIGN</button>';
                           } else {
                               return '<button class="btn btn-xs btn-success">MASIH BEKERJA</button>';
                           }
                        }
                     }
            ],
            ...
            "buttons": [
              {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          ...
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/edit/'); ?>'+data,function(){
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      { "data": "id_status_pegawai","searchable":false,"visible":false },
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/tambah'); ?>',function(){
                            $('#modal-default').modal({show:true});
                          });
                    }
                },
              {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
	                      data = dt.rows( { selected: true } ).data()[0]['id_status_pegawai'];
	                      $("#modal-default").modal();
	                        $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/edit/'); ?>'+data,function(){
	                          $('#modal-default').modal({show:true});
	                        });
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      { "data": "id_kategori_work","searchable":false,"visible":false },
                      { "data": "nama_kategori_work" },
										  { "data": "status_kategori_work",
											"render": function(data, type, row){
												if (row.status_kategori_work === '0') {
												   return '<button class="btn btn-xs btn-danger">NON AKTIF</button>';
											   } else {
												   return '<button class="btn btn-xs btn-success">AKTIF</button>';
											   }
            ...
            "buttons": [
                ...
                },
              {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
	                      data = dt.rows( { selected: true } ).data()[0]['id_kategori_work'];
	                      $("#modal-default").modal();
	                        $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/edit/'); ?>'+data,function(){
	                          $('#modal-default').modal({show:true});
	                        });
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      { "data": "id_ms_pengurus","searchable":false,"visible":false },
                      { "data": "nama_ms_pengurus" },
					  { "data": "status_ms_pengurus",
						"render": function(data, type, row){
            ...
            "buttons": [
            <?php 
            	if(!empty($pengcab_id) && $pengcab_id !== 0 && $pengcab_id !== '0'){
            ?>
                {
                    text: "<i class='fa fa-plus'></i> Tambah",
                    className: "btnmaroon",
            ...
            ?>
                {
                    text: "<i class='fa fa-exclamation'></i> Mohon Isi Pengcab di Biodata Untuk Tambah Data",
                    className: "btnred"
                },
            <?php
            	}
            ?>
              {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
	                      data = dt.rows( { selected: true } ).data()[0]['id_ms_pengurus'];
	                      $("#modal-default").modal();
	                        $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/edit/'); ?>'+data,function(){
	                          $('#modal-default').modal({show:true});
	                        });
...
else if ($page=="pengurus_tambah" || $page=="pengurus_tambah_pengurus" || $page=='kompetensi_tambah_unit' || $page=="lulus_tambah")
{
?>
$(document).ready(function() {
	$('.select2').select2()
...
else if ($page=="pegawai_pengurus_edit")
{
?>
$(document).ready(function() {
	$('.select2').select2()
});
$('select[name=id_pengcab]').on('change',function(){
    $.ajax({
        url:'<?php echo base_url();?>ol_daftar/jabfung_data_dropdown_pegawai_clicked/'+$(this).val(),
        type: "POST",
        dataType: 'json'
     }).done(function(data) {
        // alert(data[0]["nama_kab"]);
            ...
            "buttons": [
                ...
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_pengcab'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/stempel/'); ?>'+data;
                    }
                },
              {
    ...
    $(document).ready(function() {
        var table = $('#dttb').DataTable( {
            ...
            "buttons": [
                ...
                {
                  text: "<i class='fa fa-plus'></i> Level",
                  extend: "selected",
                  className: "btnolive",
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['id_pegawai'];
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/login/'); ?>'+data,function(){
                            $('#modal-default').modal({show:true});
                          });
                ...
                },
                {
                   ...
                   .then((willDelete) => {
                     if (willDelete) {
                       location.href = '<?php echo base_url('ol_daftar/'.$page.'/reset/'); ?>'+data+'/<?php echo $id;?>'; //[Modif Disini]
                     }
                   });
                  }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_pegawai'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('ol_daftar/akses/view/'); ?>'+data;
                    }
                },
                {
                    text: "<i class='fa fa-refresh'></i> Reload",
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      ...
                      { "data": "nama_level", "searchable":false },
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/tambah/'); ?><?php echo $id;?>',function(){
                            $('#modal-default').modal({show:true});
                          });
                    }
                },
                 {
                     ...
                     .then((willDelete) => {
                       if (willDelete) {
                         location.href = '<?php echo base_url('ol_daftar/'.$page.'/status/1/'); ?>'+data; //[Modif Disini]
                       }
                     });
                    }
                 },
                 {
                     ...
                     .then((willDelete) => {
                       if (willDelete) {
                         location.href = '<?php echo base_url('ol_daftar/'.$page.'/status/0/'); ?>'+data; //[Modif Disini]
                       }
                     });
                    }
                 }, 
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      { "data": "id_kategori","searchable":false,"visible":false },
                      { "data": "nama_kategori" },
										   { "data": "status_kategori", "searchable":false,
												"render": function(data, type, row){
            ...
            "buttons": [
                ...
                {
                    text: "<i class='fa fa-pencil'></i> Rubah Dan Set Format",
                    extend: "selected",
                    className: "btnpurple",
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['barcode_kategori'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/edit/'); ?>'+data;
                    }
                }, 
...
//			"pageLength": 10,
            ...
            "columns": [
                      { "data": "id_kategori_berkas", "searchable":false, "visible":false },
					  { "data": "nama_kategori_berkas" },
										   { "data": "status_kategori_berkas", "searchable":false,
												"render": function(data, type, row){
													if (row.status_kategori_berkas === '0') {
													   return '<button class="btn btn-xs btn-danger">NON AKTIF</button>';
												   } else {
													   return '<button class="btn btn-xs btn-success">AKTIF</button>';
												   }
            ...
            "buttons": [
                ...
                },
                {
                  ...
                  className: "btnteal",
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['id_kategori_berkas'];
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/edit/'); ?>'+data,function(){
                            $('#modal-default').modal({show:true});
                          });
...
//			"pageLength": 10,
            ...
            "columns": [
					  ...
					  { "data": "nama_kategori_pelatihan" },
										   { "data": "status_kategori_pelatihan", "searchable":false,
												"render": function(data, type, row){
													if (row.status_kategori_pelatihan === '0') {
													   return '<button class="btn btn-xs btn-danger">NON AKTIF</button>';
												   } else {
													   return '<button class="btn btn-xs btn-success">AKTIF</button>';
												   }
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/validasi/'); ?>'+data;
                    }
                }, 
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/kirim/0/'); ?>'+data;
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['id_korespodensi'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/kirim/1/'); ?>'+data;
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['id_korespodensi'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/kirim/2/'); ?>'+data;
                    }
                }, 
                {
                    text: "<i class='fa fa-send'></i> Kirim Selesai",
                    extend: "selected",
                    className: "btngreen",
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['id_korespodensi'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/kirim/3/'); ?>'+data;
                    }
                },
                {
                    text: "<i class='fa fa-send'></i> Kirim Di Tolak",
                    extend: "selected",
                    className: "btnred",
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['id_korespodensi'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/kirim/4/'); ?>'+data;
                    }
                },
                {
                    text: "<i class='fa fa-refresh'></i> Reload",
...
?>
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ol_daftar/pengajuan_korespodensi/dataprint/<?php echo $id;?>",
                "type" : "POST"
            },
            "columns": [
                ...
                className: "btnblue",
                  ...
                  //    data = dt.rows( { selected: true } ).data()[0]['id_pendaftaran_unit'];
                      ...
                      if(data !== null && data !== ''){                     
                        ...
                        window.open('<?php echo base_url('ol_daftar/pengajuan_korespodensi/pdf_surat/'); ?>'+data2);
                      }
                      else{
                          swal({
              ...
              },
              {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          ...
                          $("#exampleModal").modal();
                            $('.modal-body').load('<?php echo base_url('ol_daftar/pengajuan_korespodensi/edit_korprint/'); ?><?php echo $id;?>/'+data,function(){
    ...
    $('.OpenPengurus').on('click',function(){
        ...
        $('.modal-body').load('<?php echo base_url('ol_daftar/pengajuan_korespodensi/pengurus/'); ?>'+id+'/'+id2,function(){
            $('#exampleModal').modal({show:true});
        });
    });
    $('.OpenTambahKat').on('click',function(){
          var id = $(this).data('id');   
          var id2 = $(this).data('id2');   
        $('.modal-body').load('<?php echo base_url('ol_daftar/pengajuan_korespodensi/tambah_kategori/'); ?>'+id+'/'+id2,function(){
            $('#exampleModal').modal({show:true});
        });
    });
<?php  
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ol_daftar/<?php echo $page;?>/data/<?php echo $id_jabatan;?>/<?php echo $opsi_kewenangan;?>",
                "type" : "POST"
            },
            "columns": [
                      { "data": "id_kewenangan", "orderable":false, "searchable":false, "visible":false },
                      { "data": "nama_kewenangan" },
                      <?php 
                         if($opsi_kewenangan == 0){
                      ?>
                      { "data": "nama_jabatan", "orderable":false, "searchable":false },
                      ...
                      ?>
                      { "data": "nama_jabatan_fungsional", "orderable":false, "searchable":false }
                      <?php
                        }
                      ?>
            ],
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      { "data": "id_peminatan","searchable":false,"visible":false },
                      { "data": "nama_peminatan" },
                      { "data": "nama_jabatan" },
                                          { "data": "status_peminatan",
                                            "render": function(data, type, row){
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      { "data": "id_kewenangan_detil", "searchable":false , "visible":false },
                      { "data": "nama_kewenangan" },
                      { "data": "nama_kode_kewenangan", "searchable":false },
                      { "data": "nama_kompetensi" },
                      { "data": "nama_sifat_kewenangan", "searchable":false },
            ...
            "buttons": [
                {
                    text: "<i class='fa fa-plus'></i> Tambah Berdasarkan Unit",
                    className: "btnfuchsia",
                    init: function(api, node, config) {
                        $(node).removeClass('btn-default')
                    },
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/tambah_unit'); ?>';
                    }
                },
                {
                  text: "<i class='fa fa-edit'></i> Rubah",
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      { "data": "id_kewenangan_lulus", "searchable":false, "visible":false },
                      { "data": "nama_pegawai", "searchable":false },
                      { "data": "nama_kompetensi", "searchable":false },
                      { "data": "nama_kewenangan" }
            ],
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/tambah/'); ?><?php echo $id;?>';
                    }
                },
                 {
                     text: "<i class='fa fa-trash'></i> Hapus",
                     ...
                     .then((willDelete) => {
                       if (willDelete) {
                         location.href = '<?php echo base_url('ol_daftar/'.$page.'/hapus/'); ?><?php echo $id;?>/'+data; //[Modif Disini]
                       }
                     });
                    }
                 },
        ...
        var table = $('#dttb').DataTable( {
            ...
            "buttons": [ 
                ...
                },
                {
                  ...
                  className: "btnteal",
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['id_catatan'];
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/edit/'); ?>'+data,function(){
                            $('#modal-default').modal({show:true});
                          });
...
$(document).ready(function() {
    ...
    var table = $('#dttb').DataTable( {
        ...
        "ajax": {
            "url"  : "<?php echo base_url();?>ol_daftar/bcp/data_logbook/<?php echo $id;?>/<?php echo $all;?>/<?php echo $first_date;?>/<?php echo $last_date;?>",
            "type" : "POST"
        },
        "columns": [
                    {
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ol_daftar/<?php echo $page;?>/data/<?php echo $id_jabatan;?>",
                "type" : "POST"
            },
            "columns": [
            ...
            "buttons": [
                ...
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('ol_daftar/'.$page.'/lihat/'); ?>'+data;
                    }
                },
                {
                    text: "<i class='fa fa-refresh'></i> Reload",
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "columns": [
                      { "data": "id_ms_struktur","searchable":false,"visible":false },
                      { "data": "nama_ms_struktur" },
                      { "data": "status_ms_struktur",
                        "render": function(data, type, row){
            ...
            "buttons": [
                ...
                },
              {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          data = dt.rows( { selected: true } ).data()[0]['id_ms_struktur'];
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/edit/'); ?>'+data,function(){
                              $('#modal-default').modal({show:true});
                            });
              ...
              },
                {
                  ...
                  className: "btnteal",
                    action: function ( e, dt, node, config ) {
                        ...
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/jabatan/'); ?>'+data,function(){
                            $('#modal-default').modal({show:true});
                          });
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>ol_daftar/<?php echo $page;?>/data/<?php echo $id_jabatan_fungsional;?>",
                "type" : "POST"
            },
            "columns": [
                ...
                },
             {
                ...
                className: "btnlightblue",
                  action: function ( e, dt, node, config ) {
                          ...
                          $("#modal-default").modal();
                            $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/edit/'); ?>'+data+'/'+data2,function(){
                              $('#modal-default').modal({show:true});
                            });
                  }
              }, 
            ...
            "buttons": [    
                {
                   ...
                   action: function ( e, dt, node, config ) {  
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/tambah/'); ?><?php echo $id;?>',
                          function(){
                            $('#modal-default').modal({show:true});
                          });
                ...
                },      
                {
                   ...
                   action: function ( e, dt, node, config ) {
                        ...
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/edit/'); ?><?php echo $id;?>/'+data,
                          function(){
                            $('#modal-default').modal({show:true});
                          });
            ...
            "buttons": [    
                {
                   ...
                   action: function ( e, dt, node, config ) {  
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/tambah'); ?>',
                          function(){
                            $('#modal-default').modal({show:true});
                          });
                ...
                },      
                {
                   ...
                   action: function ( e, dt, node, config ) {
                        ...
                        $("#modal-default").modal();
                          $('.modal-body').load('<?php echo base_url('ol_daftar/'.$page.'/edit/'); ?>'+data,
                          function(){
                            $('#modal-default').modal({show:true});
                          });
            ...
            "columns": [
                    {
                      ...
                      { "data": "barcode_registrasi","searchable":false },
                      { "data": "wkt_registrasi","searchable":false },
                      { "data": "wkt_simpan","searchable":false },
                      { "data": "nama_pegawai" },
                      { "data": "nama_pengcab" },
                      { "data": "no_hp","searchable":false },
                      { "data": "status_registrasi","visible":false },
                      { "data": "status_registrasi", "searchable":false, 
                        "render": function(data, type, row){
                            if (row.status_registrasi === '0') {
                               return '<button class="btn btn-xs btn-warning"> Proses</button>';
                             } else if (row.status_registrasi === '1') {
                               return '<button class="btn btn-xs btn-danger"> Terinput</button>';
                             } else {
                               return '<button class="btn btn-xs btn-success"> Terdaftar</button>';
                             } 
                        }
                      },
                      {
                        ...
                        "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                            $(nTd).html("<a href='https://wa.me/"+oData.cp+"?text=<?php echo base_url();?>ol_registrasi/registrasi/"+oData.barcode_registrasi+"' target=_blank><i class='fa fa-whatsapp'></i> "+oData.cp+"</a>")
                        }
                      }
            ],
            "order": [[7, 'desc']] ,
