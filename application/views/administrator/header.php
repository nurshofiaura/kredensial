  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href="<?php echo base_url('akunting');?>"><i class="fa fa-money text-<?php echo $v; ?>"></i><span>Akunting</span></a></li>		
		<li><a href="<?php echo base_url('laporan');?>"><i class="fa fa-file-o text-<?php echo $v; ?>"></i><span>Laporan</span></a></li>	
		<li><a href="<?php echo base_url('upload');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i><span>Upload</span></a></li>
         <li class="treeview <?php cek_aktif($page,array()); ?>">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('user'));?>">
				<a href="<?php echo base_url('user');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> User</a></li>
             <li class="<?php cek_aktif($page,array('unit'));?>">
				<a href="<?php echo base_url('unit');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Unit</a></li>
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('kurs','ms_code','ms_sub','code','coa','dk')); ?>">
          <a href="#">
            <i class="fa fa-cog text-<?php echo $v; ?>"></i>
            <span>Akunting</span>
            <span class="pull-right-container">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('dk'));?>">
				<a href="<?php echo base_url('admin_keuangan/dk');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Debitur/Kreditur</a></li>
            <li class="<?php cek_aktif($page,array('kurs'));?>">
				<a href="<?php echo base_url('admin_keuangan/kurs');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Mata Uang</a></li>
            <li class="<?php cek_aktif($page,array('code'));?>">
				<a href="<?php echo base_url('admin_keuangan/code');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Tipe</a></li>
            <li class="<?php cek_aktif($page,array('coa'));?>">
				<a href="<?php echo base_url('admin_keuangan/coa');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> COA</a></li>
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('kategori_barang','barang','termin')); ?>">
          <a href="#">
            <i class="fa fa-cog text-<?php echo $v; ?>"></i>
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('kategori_barang'));?>">
				<a href="<?php echo base_url('admin_keuangan/kategori_barang');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kategori</a>
			</li>
            <li class="<?php cek_aktif($page,array('barang'));?>">
				<a href="<?php echo base_url('admin_keuangan/barang');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Barang</a>
			</li>
            <li class="<?php cek_aktif($page,array('termin'));?>">
				<a href="<?php echo base_url('admin_keuangan/termin');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Termin</a>
			</li>
          </ul>
        </li>
      </ul>
