...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-lg"><b>SURAT PROFESI</b></span>
    </a>
        ...
        <li class="header"><?php echo $level_name; ?></li>		
	      ...
	      <li class="treeview">
	         ...
	         <ul class="treeview-menu">
	         	...
	         	?>
	          <li>
							<a href="<?php echo base_url($rowmulti_level['link_level']);?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> <?= $rowmulti_level['nama_level'] ?>
							</a>
						</li>
	         	<?php
	         		}
	        ...
	        ?>	
	       <li class="treeview <?php cek_aktif($page,array('profil')); ?>">
	         <a href="#">
