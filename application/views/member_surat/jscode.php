...
$("#last_date").inputmask("datetime", {
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>member/<?php echo $page;?>/data/<?php echo $first_date;?>/<?php echo $last_date;?>",
                "type" : "POST"
            },
            "columns": [
                    {
            ...
            "buttons": [
                 {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('member/'.$page.'/non_keperawatan/'.$first_date.'/'.$last_date.'/0'); ?>';
                    }
                },
                 {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('member/'.$page.'/tambah/'.$first_date.'/'.$last_date.'/1'); ?>';
                    }
                },
                 {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('member/'.$page.'/tambah/'.$first_date.'/'.$last_date.'/2'); ?>';
                    }
                },
                 {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('member/'.$page.'/tambah/'.$first_date.'/'.$last_date.'/3'); ?>';
                    }
                },
                 {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('member/'.$page.'/tambah/'.$first_date.'/'.$last_date.'/4'); ?>';
                    }
                },
                 {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('member/'.$page.'/tambah/'.$first_date.'/'.$last_date.'/5'); ?>';
                    }
                },
                 {
                     ...
                     .then((willDelete) => {
                       if (willDelete) {
                         location.href = '<?php echo base_url('member/'.$page.'/hapus/'); ?><?php echo $first_date.'/'.$last_date; ?>/'+data['id_logbook'];
					}
                     });
                     }
                 },
...
?>
    ...
    $(document).ready(function() {
        ...
        var table = $('#dttb').DataTable( {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>member/<?php echo $page;?>/data/<?php echo $bulan;?>/<?php echo $tahun;?>",
                "type" : "POST"
            },
            "columns": [
            ...
            "buttons": [
                ...
                },
                 {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('member/'.$page.'/transfer'); ?>';
                    }
                },
                 {
                     text: "<i class='fa fa-trash'></i> Hapus",
                     ...
                     .then((willDelete) => {
                       if (willDelete) {
                         location.href = '<?php echo base_url('member/'.$page.'/hapus/'); ?>'+data['id_buket_pegawai'];
					}
                     });
                     }
                 },
            ...
            "buttons": [
                 {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href = '<?php echo base_url('member/logbook_dupak/view/'); ?><?php echo $bulan;?>/<?php echo $tahun;?>';
                    }
                },
                {
                    text: "<i class='fa fa-refresh'></i> Reload",
            ...
            "buttons": [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('member/'.$page.'/status/1/'); ?>'+data;
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        data = dt.rows( { selected: true } ).data()[0]['id_logbook'];
                        // alert(JSON.stringify(data));
                        location.href = '<?php echo base_url('member/'.$page.'/status/0/'); ?>'+data;
                    }
                },
                {
                    text: "<i class='fa fa-refresh'></i> Reload",
