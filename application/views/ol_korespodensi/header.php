...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-lg"><b>SURAT</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><?php echo $level_name; ?></li>		
	       ...
	       <li class="treeview <?php cek_aktif($page,array('pengajuan_korespodensi','pengajuan_korespodensi_isi','berkas_ijasah','berkas_str','berkas_sertifikat','berkaslain_berkas')); ?>">
	         <a href="#">
	         ...
	         <ul class="treeview-menu">
	           <li class="<?php cek_aktif($page,array('pengajuan_korespodensi','pengajuan_korespodensi_isi','berkas_ijasah','berkas_str','berkas_sertifikat','berkaslain_berkas'));?>">
							<a href="<?php echo base_url('ol_korespodensi/pengajuan_korespodensi');?>">
								<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pengajuan
							</a>
						</li>
	          </ul>
	        </li>
	       <li class="treeview <?php cek_aktif($page,array('berkas','berkas_tambah','berkas_edit','ijasah','ijasah_tambah','ijasah_edit','pelatihan','pelatihan_tambah','pelatihan_edit','surat_ijin','surat_ijin_tambah','surat_ijin_edit','surat_ijin_perpanjangan')); ?>">
	         <a href="#">
