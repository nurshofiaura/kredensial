...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-lg"><b>KABID</b></span>
    </a>
       ...
       <li class="treeview <?php cek_aktif($page,array('logbook','logbook_tambah')); ?>">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('logbook','logbook_tambah'));?>">
				<a href="<?php echo base_url('kabid/logbook');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Validasi Kepala Ruangan
				</a>
			</li>
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('etik','etik_tambah','etik_lihat')); ?>">
          <a href="#">
            <i class="fa fa-book text-<?php echo $v; ?>"></i>
            <span>Etik</span>
            <span class="pull-right-container">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('etik','etik_tambah','etik_lihat'));?>">
				<a href="<?php echo base_url('kabid/etik');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Etik Kepala Ruangan
				</a>
			</li>
          </ul>
        </li>
       <li class="treeview <?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_isi','pengajuan_kompetensi_asesor')); ?>">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('pengajuan_kompetensi','pengajuan_kompetensi_isi','pengajuan_kompetensi_asesor'));?>">
				<a href="<?php echo base_url('kabid/pengajuan_kompetensi');?>">
