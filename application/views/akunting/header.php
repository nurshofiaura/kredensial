  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href="<?php echo base_url('akunting');?>"><i class="fa fa-dashboard text-<?php echo $v; ?>"></i> <span>Dashboard</span></a></li>		
		<li><a href="<?php echo base_url('laporan');?>"><i class="fa fa-file-text text-<?php echo $v; ?>"></i> <span>Laporan</span></a></li>		
        <li class="treeview <?php cek_aktif($page,array('transaksi','saldo_awal_tambah')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('transaksi'));?>">
				<a href="<?php echo base_url('akunting/transaksi');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Transaksi</a></li>
		        <li class="<?php cek_aktif($page,array('saldo_awal_tambah'));?>">
				<a href="<?php echo base_url('akunting/saldo_awal/tambah');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Saldo Awal</a></li> 
            <li class="<?php cek_aktif($page,array('jurnal'));?>">
				<a href="<?php echo base_url('akunting/jurnal/tambah');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Jurnal</a></li>
            <li class="<?php cek_aktif($page,array('kas_masuk'));?>">
				<a href="<?php echo base_url('akunting/kas_masuk/tambah');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kas Masuk</a></li>
            <li class="<?php cek_aktif($page,array('kas_keluar'));?>">
				<a href="<?php echo base_url('akunting/kas_keluar/tambah');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Kas Keluar</a></li>
	        <li class="<?php cek_aktif($page,array('bank_masuk'));?>">
				<a href="<?php echo base_url('akunting/bank_masuk/tambah');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Bank Masuk</a></li>
	        <li class="<?php cek_aktif($page,array('bank_keluar'));?>">
				<a href="<?php echo base_url('akunting/bank_keluar/tambah');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Bank Keluar</a></li>         
		 </ul>
        </li>
        <li class="treeview <?php cek_aktif($page,array('order_beli','proses_order_beli')); ?>">
          <a href="#">
            <i class="fa fa-cog text-<?php echo $v; ?>"></i>
            <span>PEMBELIAN</span>
            <span class="pull-right-container">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('order_beli'));?>">
				<a href="<?php echo base_url('akunting/order_beli');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Order Pembelian</a></li>       
            <li class="<?php cek_aktif($page,array('proses_order_beli'));?>">
				<a href="<?php echo base_url('akunting/proses_order_beli');?>"><i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Proses Order Pembelian</a></li> 				
		 </ul>
        </li>
      </ul>
    </section>
