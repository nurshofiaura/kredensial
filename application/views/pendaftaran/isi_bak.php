...
tr.shown td.details-control {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	<?php echo form_open_multipart('pendaftaran/pasien/view/'.$key,' id="signupform" ');
	?>
	  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
		<div class="box-header with-border">
...
.select2-container {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  <?php echo form_open_multipart('pendaftaran/pasien/tambah',' id="signupform" ');
	  input_text("nik_lama",$nik,"","","hidden");
	  input_text("harie",$harie,"","","hidden");
	  input_text("bulane",$bulane,"","","hidden");
	  input_text("tahune",$tahune,"","","hidden");
	  ?>
      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
			  ...
			  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
				...
				<div class="box-body">
					<div class="form-group">
					  <label>RM</label>
						<?php
						input_textcustom("rm",$rm," maxlength='10' readonly id='rm' class='form-control nospace'","Masukkan RM","text");
						//	input_text("rm",$rm,"maxlength='10' onkeypress='return event.charCode >= 48 && event.charCode <= 57' autofocus required","Masukkan RM","text");
						?>
					</div>
					<div class="form-group">
					  <label>Nama Pasien <strong><font color="red">*</font></strong></label>
						<?php
							input_text("nama_pasien",$nama_pasien,"maxlength='40' required","Masukkan Nama Lengkap Pasien Tanpa Gelar dan Pangkat","text");
						?>
						<small><strong><font color="red">UNTUK PENAMAAN JANGAN MENGGUNAKAN GELAR DAN PANGKAT SEPERTI TN/NY/NN/DRS/AMD DAN LAIN-LAIN
						<br>UNTUK BAYI BARU LAHIR HARAP MENGISI NAMA AYAH DAN IBU BESERTA NIK / NO KTP
						</font></strong></small>
					</div>
					<div class="form-group">
					  <label>NIK (KTP) <strong><font color="red">*</font></strong> <small><span style="font-weight:bold;" id="msg"></span></small></label>
                <?php
                ...
                ?>
					...
					<div class="form-group">
					  <label>Jenis Kelamin</label>
						<?php
							input_pdselect2("jk",$cmd_jk,$jk);
						?>
					</div>
					<div class="form-group">
					  <label>Tempat Lahir</label>
						<?php
							input_text("tmp_lahir",$tmp_lahir,"maxlength='255'","Masukkan Tempat Kelahiran sesuai KTP","text");
						?>
					</div>
					<div class="row">
					<div class="col-md-6">
					<div class="form-group">
					  <label>Tanggal Lahir (Tanggal-Bulan-Tahun) <strong><font color="red">*</font></strong></label>
							<?php
								input_calendar("tgl_lahir","tgl_lahir",$tgl_lahir," onkeyup='convertDate()' ","required")
							?>
					</div>
					</div>
					<div class="col-md-6">
					<div class="form-group">
					  <label>Umur <strong><font color="red">(Dalam Tahun)<strong></font></label>
					<input type="text" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
					name="txtumur" value="<?php echo $umure; ?>" onblur="if(this.value!==''){
																						 a=eval(form.tahune.value);
																						 b=eval(form.txtumur.value);
																						 l=eval(form.bulane.value);
																						 h=eval(form.harie.value);
																						 c=a-b
																						 d=h+'-'+l
																						tgl_lahir.value= d+'-'+c
																						}"
					id="umure" maxlength="3" class="form-control">
					...
					<div class="form-group">
					  <label>No Telp</label>
						<?php
							input_text("telepon",$telepon,"maxlength='15' ","Masukkan No Telp / HP","text");
						?>
					</div>
					<div class="form-group">
					  <label>Golongan Darah</label>
						...
						//	input_pdselect2fleksibel("id_ruangan","id_ruangan",$cmd_ruangan,"id_ruangan","nama_ruangan",$id_ruangan,"Tidak Ada Ruangan");
							input_pdselect2fleksibel("id_golongan_darah","id_golongan_darah",$kol_golongan_darah,"id_golongan_darah","nama_golongan_darah",$id_golongan_darah,"Belum Ada Data Golongan Darah");
						?>
					</div>
					<div class="form-group">
					  <label>Marital Status</label>
						<?php
							//	input_pdselect2withnull($id_var,$nm_var,$foreach,$id,$name,$selected,$required)
								input_pdselect2fleksibel("id_status_kawin","id_status_kawin",$kol_status_kawin,"id_status_kawin","nama_status_kawin",$id_status_kawin,"Belum Ada Data Status Kawin");
						?>
					</div>
					<div class="form-group">
					  <label>Agama</label>
						<?php
							input_pdselect2fleksibel("id_agama","id_agama",$agama,"id_agama","nama_agama",$id_agama,"Belum Ada Data Agama");
						?>
					</div>
				</div>
			  </div>
			  ...
			  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
				...
				<div class="box-body">
					<div class="form-group">
					  <label>Alamat</label>
						<?php
							input_text("alamat",$alamat,"maxlength='255'","Masukkan Alamat","text");
						?>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  <label>Pendidikan</label>
						<?php
							input_pdselect2fleksibel("id_pendidikan","id_pendidikan",$pendidikan,"id_pendidikan","nama_pendidikan",$id_pendidikan,"Belum Ada Data Pendidikan");
						?>
					</div>
					<div class="form-group">
					  <label>Pekerjaan</label>
						<?php
							input_pdselect2fleksibel("id_pekerjaan","id_pekerjaan",$kol_pekerjaan,"id_pekerjaan","nama_pekerjaan",$id_pekerjaan,"Belum Ada Data Pekerjaan");
						?>
					</div>
					<div class="form-group">
					  <label>Nama Pasangan</label>
						<?php
							input_text("nama_pasangan",$nama_pasangan,"maxlength='35' ","Masukkan Nama Pasangan Suami / Istri","text");
						?>
					</div>
					<div class="form-group">
					  <label>Nama Ayah</label>
						<?php
							input_text("nama_ayah",$nama_ayah,"maxlength='35' ","Masukkan Nama Ayah","text");
						?>
					</div>
					<div class="form-group">
					  <label>NIK Ayah</label>
						<?php
							input_text("nik_ayah",$nik_ayah,"maxlength='35' ","Masukkan NIK Ayah","text");
						?>
					</div>
					<div class="form-group">
					  <label>Nama Ibu</label>
						<?php
							input_text("nama_ibu",$nama_ibu,"maxlength='35' ","Masukkan Nama Ibu","text");
						?>
					</div>
					<div class="form-group">
					  <label>NIK Ibu</label>
						<?php
							input_text("nik_ibu",$nik_ibu,"maxlength='35' ","Masukkan NIK Ibu","text");
						?>
					</div>
				</div>
			  </div>
...
.select2-container {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  <?php echo form_open_multipart('pendaftaran/pasien/edit/'.$key,' id="signupform" ');
	  input_text("barcode_pasien",$key,"","","hidden");
	  input_text("id_pasien",$id_pasien,"","","hidden");
	  input_text("harie",$harie,"","","hidden");
	  input_text("bulane",$bulane,"","","hidden");
	  input_text("tahune",$tahune,"","","hidden");
	  ?>
			  ...
			  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
				...
				<div class="box-body">
					...
					<div class="form-group">
					  <label>Nama Pasien <strong><font color="red">*</font></strong></label>
						<?php
							input_text("nama_pasien",$nama_pasien,"maxlength='40' required","Masukkan Nama Pasien","text");
						?>
						<small><strong><font color="red">UNTUK PENAMAAN JANGAN MENGGUNAKAN GELAR DAN PANGKAT SEPERTI TN/NY/NN/DRS/AMD DAN LAIN-LAIN
						<br>UNTUK BAYI BARU LAHIR HARAP MENGISI NAMA AYAH DAN IBU
						</font></strong></small>
					</div>
					<div class="form-group">
					  <label>NIK (KTP) <strong><font color="red">*</font></strong> <small><span style="font-weight:bold;" id="msg"></span></small></label>
                <?php
                  input_textcustom("nik",$nik," required id='nik' readonly
                        onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control'",
                            "Masukkan No KTP","text");
                ?>
					</div>
...
tr.shown td.details-control {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	<?php echo form_open_multipart('pendaftaran/daftar/view/'.$first_date.'/'.$last_date.'/'.$key,' id="signupform" '); ;
	?>
	  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
		<div class="box-header with-border">
		  ...
		  <div class="box-body">
				<div class="col-md-12">
					<div class="form-group">
					  <label>Cari RM, NAMA PASIEN DAN NO PENDAFTARAN ( Ketik multiple pisahkan dengan spasi atau - ) Contoh (00000 NAMA)</label>
							<?php
								input_text("key",$key," autofocus","Ketik multiple pisahkan dengan spasi atau -","text");
							?>
					</div>
...
.select2-container {
    ...
    padding: 0;
		...
		<FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('pendaftaran/daftar/simpan_send');?>" onClick="return cek();">
		<input type="hidden" name="barcode_pendaftaran" value="<?= $barcode_pendaftaran; ?>">
       <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
            <h3 class="box-title"><button type="submit" class="btn btn-primary btn-xs">Submit</button></h3>
		...
		<div class="box-body">
		  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
			<div class="box-header with-border">
			  ...
			  <div class="box-body">
					  <div class="col-md-6">
							<label>Tanggal Pendaftaran <strong><font color="red">*</font></strong></label>
							<?php
							input_calendar("tgl_pendaftaran_unit","tgl_pendaftaran_unit",$tgl_pendaftaran_unit," ","required");
							?>
					  </div>
						<div class="col-md-6">
							  <label>Unit Yang di tuju</label>
								<?php
									input_pdselect2("id_unit",$unit,$id_unit);
								?>					
						</div>
						<div class="col-md-6">
							  <label>Pilih Profesi PJ</label>
									<?php
										input_pdselect2fleksibel("id_jabatan","id_jabatan",$jabatan,"id_jabatan","nama_jabatan",$id_jabatan,"Pilih Jabatan PJ");
									?>
						</div>
						<div class="col-md-6">
							  <label>Dokter Pemeriksa / Penanggung Jawab</label>
									<?php
										input_pdselect2("id_pegawai",$penanggungjawab,$id_pegawai);
									?>
						</div>
						<div class="col-md-6">
							  <label>Kelas</label>
									<?php
										input_pdselect2("id_kelas",$cmd_kelas_tindakan,$id_kelas);
									?>
						</div>
							<div class="col-md-6">
							  <label>Keterangan</label>
								<?php
									input_text("ket_pendaftaran_unit",$ket_pendaftaran_unit,"maxlength='255' ","Masukkan Keterangan","text");
								?>						
							</div>
			  </div>
		  </div>
...
$('#tgl_pendaftaran_unit').datepicker({
  format: 'dd-mm-yyyy',
  autoclose: true
})
$("#tgl_pendaftaran_unit").inputmask("datetime", {
    mask: "1-2-y",
...
.select2-container {
    ...
    padding: 0;
		...
		<FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('pendaftaran/daftar/simpan_edit');?>" onClick="return cek();">
		<input type="hidden" name="barcode_pendaftaran_unit" value="<?= $barcode_pendaftaran_unit; ?>">
		<input type="hidden" name="barcode_pendaftaran" value="<?= $barcode_pendaftaran; ?>">
		<input type="hidden" name="barcode_pasien" value="<?= $barcode_pasien; ?>">
       <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
            <h3 class="box-title"><button type="submit" class="btn btn-primary btn-xs">Submit</button></h3>
		...
		<div class="box-body">
		  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
			<div class="box-header with-border">
			  <h3 class="box-title">EDIT PEMERIKSAAN</h3>
			</div>
			  <div class="box-body">
					  <div class="col-md-6">
							<label>Tanggal Pendaftaran <strong><font color="red">*</font></strong></label>
						...
						<div class="col-md-6">
							  <label>Unit Yang di tuju</label>
								<?php
									input_pdselect2("unit_ke",$unit,$unit_ke);
								?>					
						</div>
						<div class="col-md-4">
							  <label>Pilih Profesi PJ</label>
						...
						<div class="col-md-8">
							  <label>Dokter Pemeriksa / Penanggung Jawab</label>
									<?php
										input_pdselect2("id_pegawai",$ambil_data_daftar_no_null,$id_pegawai);
									?>
						</div>
						<div class="col-md-6">
							  <label>Kelas</label>
...
<div class="nav-tabs-custom">
  <ul class="nav nav-tabs">
    <li class="active"><a href="#tab_1" data-toggle="tab">PENDAFTARAN</a></li>
    <li><a href="#tab_2" data-toggle="tab">Cek Nomor Kartu Peserta</a></li>
    <li><a href="#tab_3" data-toggle="tab">Cek NIK</a></li>
  </ul>
  <div class="tab-content">
    <div class="tab-pane active" id="tab_1">
			  <?php echo form_open_multipart('pendaftaran/daftar/tambah/'.$first_date,' '); // id = id_pasien
		//	  input_text("id_unit_user",$room_id,"","","hidden");
		input_text("id_icd10",$id_icd10,"","","hidden");
			  input_text("barcode_pasien",$barcode_pasien,"","","hidden");
		//	  input_text("rm",$rm,"","","hidden"); ?>
		      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
		        <div class="box-header with-border">
		           <h3 class="box-title"><button type="submit" class="btn btn-xs btn-primary">Submit</button></h3>
					...
					<div class="col-md-4">
					  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
		                ...
		                <div class="form-group">
		                  <label>RM</label>
							<?php
								input_text("rm",$rm,"maxlength='10' readonly required","Masukkan RM","text");
							?>
		                </div>
		                <div class="form-group">
		                  <label>Nama Pasien</label>
							<?php
								input_textarea("nama_pasien",$nama_pasien,"maxlength='40' readonly","Masukkan Nama Pasien","text");
							?>
		                </div>
		                <div class="form-group">
		                  <label>NIK (KTP)</label>
							<?php
								input_text("nik",$nik,"maxlength='17' readonly","Masukkan NIK","text");
							?>
		                </div>
		                <div class="form-group">
		                  <label>Jenis Kelamin</label>
								<?php
									input_text("jk",$jk,"maxlength='255' readonly","Jenis Kelamin","text");
								?>
		                </div>
		                <div class="form-group">
		                  <label>Umur</label>
							<?php
								input_text("umur",$umur,"maxlength='255' readonly","Umur Pasien","text");
							?>
		                </div>
						</div>
					  </div>
					...
					<div class="col-md-8">
					  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
						...
						<div class="col-md-5">
							  <label>Tanggal</label>
								<?php
									input_calendar("input_mask_date_time","waktu_daftar",$waktu_daftar," ","required");
								?>					
						</div>
						<div class="col-md-7">
							  <label>No Pendaftaran</label>
								<?php
									input_text("no_pendaftaran",$no_pendaftaran,"maxlength='32' required","No pendaftaran","text");
								?>					
						</div>
							<div class="col-md-6">
							  <label>Keluhan</label>
								<?php
									input_text("keluhan",$keluhan,"maxlength='255' required","Masukkan Keluhan Pasien","text");
								?>						
							</div>
							<div class="col-md-6">
							  <label>Keterangan</label>
							...
							<div class="col-md-12">
							  <label>Diagnosa Awal (Ketik Kode / Nama ICD)</label>
								<?php
									input_text("nama_icd10",$nama_icd10,"  ","Ketik ICD / Kode ICD","text");
								?>						
							</div>
							<div class="col-md-6">
								<div class="form-group">
								  <label>Cara Bayar</label>
									<?php
										input_pdselect2fleksibel("id_cara_bayar","id_cara_bayar",$kol_cara_bayar,"id_cara_bayar","nama_cara_bayar",$id_cara_bayar,"Pilih Cara Bayar");
									?>
								</div>
								<div class="form-group">
								  <label id="labeldetil">Detil Cara Bayar</label>
									<?php
										input_pdselect2("id_detil_cara_bayar",$kol_detil_cara_bayar,$id_detil_cara_bayar);
									?>
								</div>
								<div class="form-group">
								  <label id="labelbpjs">NO BPJS</label>
									<?php
										input_text("no_bpjs",$no_bpjs,"","Masukkan No BPJS","text");
									?>
								</div>
								<div class="form-group">
								<label id="labelpetugas">Data Karyawan</label>
									<?php
										input_pdselect2fleksibel("id_petugas","id_petugas",$pegawai,"id_pegawai","nama_pegawai",$id_petugas,"Silahkan Pilih Nama Karyawan");
							...
							<div class="col-md-6">
								<div class="form-group">
								  <label>Cara Masuk</label>
									<?php
										input_pdselect2fleksibel("id_cara_masuk","id_cara_masuk",$kol_cara_masuk,"id_cara_masuk","nama_cara_masuk",$id_cara_masuk,"Silahkan Pilih Cara Masuk");
									?>
								</div>
							<div class="form-group">
								<label id="labeldokter">Pengirim</label>
							  <?php
								 input_pdselect2("id_rujukan_dokter",$rujukandokter,$id_rujukan_dokter); ?>
							</div>
							<div class="form-group">
								<label id="labelinstansi">Instansi Kesehatan</label>
							  <?php
							   input_pdselect2("id_rujukan_instansi",$rujukanrs,$id_rujukan_instansi); ?>
							</div>
							<div class="form-group">
								<label id="labelunit">Ruangan</label>
							  <?php
								 input_pdselect2("ruangan",$radiologi_unit,$ruangan); ?>
							</div>
							<div class="form-group">
								<label id="labelpengirim">Dokter Pengirim</label>
							  <?php
							   input_pdselect2("pengirim",$radiologi_pengirim,$pengirim); ?>
							</div>
							</div>
						</div>
					  </div>
    ...
    <div class="tab-pane" id="tab_2">
      <div class="box box-<?php echo $thenarray; ?> box-solid">
        ...
        <div class="box-body">
          <div class="form-group">
            <label for="kode_nama">Nomor Kartu Peserta</label>
            <div class="input-group">
              <input type="text" name="nokartu" id="nokartu" class="form-control">
                  <span class="input-group-btn">
                    <button type="button" class="btn btn-info btn-flat" id="gonobpjs">Cek</button>
                  </span>
            </div>
          </div>
        </div>
        <div class="box-footer">
          <div class="form-group">
            <label>Result</label>
							<textarea class="form-control" rows="10" id="responnobpjs"></textarea>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="tab-pane" id="tab_3">
      <div class="box box-<?php echo $thenarray; ?> box-solid">
        ...
        <div class="box-body">
          <div class="form-group">
            <label for="kode_nama">NIK Peserta</label>
            <div class="input-group">
              <input type="text" name="nik" id="nik" class="form-control">
                  <span class="input-group-btn">
                    <button type="button" class="btn btn-info btn-flat" id="gonik">Cek</button>
                  </span>
            </div>
          </div>
        </div>
        <div class="box-footer">
          <div class="form-group">
            <label>Result</label>
							<textarea class="form-control" rows="10" id="responnik"></textarea>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="<?php echo base_url('pendaftaran/daftar/edit/'.$first_date);?>">Pemeriksaan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
              ...
              <div class="tab-pane active">
                <div class="nav-tabs-custom">
                  <ul class="nav nav-tabs pull-right">
                    <li class="active"><a href="<?php echo base_url('pendaftaran/daftar/edit/'.$first_date);?>">Pendaftaran</a></li>
                    <li><a href="<?php echo base_url('pendaftaran/daftar/penunjang_luar/'.$first_date);?>" >Penunjang dari Luar</a></li>
                    <li><a href="<?php echo base_url('pendaftaran/daftar/vital_sign/'.$first_date);?>" >Pemeriksaan Vital Sign</a></li>
                    <li><a href="<?php echo base_url('pendaftaran/daftar/asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
...
$('#btn_pemeriksaan').on('click',function(){
    ...
    $.ajax({
        type : "POST",
        url  : "<?php echo base_url('pendaftaran/daftar/simpan_tambah_pemeriksaan_billing')?>",
        dataType : "JSON",
      ...
      "oLanguage": {
        ...
        "select": {
          ...
          "rows": {
            ...
            "ajax": {
                "url"  : "<?php echo base_url();?>pendaftaran/daftar/billing/<?php echo $first_date;?>",
                "type" : "POST"
            },
            "columns": [
...
/*              {
              ...
              },*/
              {
                ...
                className: "btnred",
                  action: function ( e, dt, node, config ) {
                      data = dt.rows( { selected: true } ).data()[0]['barcode_pemeriksaan'];
                      $("#modal-default").modal();
                        $('.modal-body').load('<?php echo base_url('pendaftaran/daftar/hapus_pemeriksaan/'); ?>'+data,function(){
                          $('#modal-default').modal({show:true});
                        });
    ...
    $('select[name=id_kelas]').on('change',function(){
        $.ajax({
            url:'<?php echo base_url();?>pendaftaran/data_pemeriksaan/'+$(this).val(),
            type: "POST",
            dataType: 'json'
         }).done(function(data) {
               var len = data.length;
...
$('#btn_hapus').on('click',function(){
    ...
    $.ajax({
        type : "POST",
        url  : "<?php echo base_url('ugd/daftar/simpan_hapus_pemeriksaan')?>",
        dataType : "JSON",
...
.select2-container {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  <?php echo form_open_multipart('pendaftaran/daftar/edit/'.$first_date,' '); // id = id_pasien
	  input_text("no_antri",$no_antri,"","","hidden");
	  input_text("id_pendaftaran_unit",$id_pendaftaran_unit,"","","hidden");
	  input_text("id_pendaftaran",$id_pendaftaran,"","","hidden");
//	  input_text("rm",$rm,"","","hidden"); ?>
      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
           <h3 class="box-title"><button type="submit" class="btn btn-xs btn-primary">Submit</button></h3>
			...
			<div class="col-md-3">
			  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
                ...
                <div class="form-group">
                  <label>Nama Pasien</label>
					<?php
						input_text("nama_pasien",$nama_pasien,"maxlength='40' readonly","Masukkan Nama Pasien","text");
					?>
                </div>
                <div class="form-group">
                  <label>NIK (KTP)</label>
			  ...
			  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						<label id="labeldokter">Pengirim</label>
					  <?php
					  input_pdselect2fleksibel("id_dokter_rujukan","id_dokter_rujukan",$rujukandokter,"id_rujukan_dokter","nama_rujukan_dokter",$id_dokter_rujukan,"Silahkan Pilih Cara Masuk");
					//	 input_pdselect2("id_dokter_rujukan",$rujukandokter,$id_dokter_rujukan); ?>
					</div>
					<div class="form-group">
						<label id="labelinstansi">Instansi Kesehatan</label>
					  <?php
                                ...
                                <tbody id="addinvoiceItem">
                                       <tr>
                                        <td class="product_field">
                                            <input type="text" name="product_name" class="form-control productSelection" required="" id="product_name_1" tabindex="7">
                                        ...
                                        <td>
                                            <select class="form-control" id="batch_id_1" name="batch_id[]"  tabindex="8" required="required">
                                                <option></option>
                                            </select>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="product_quantity[]" class="total_qntt_1 form-control text-right allownumericwithdecimal" id="total_qntt_1" placeholder="0.00" min="0" tabindex="9" required/>
                                        </td>
                                        <td class="invoice_fields">
                                            <input type="text" name="product_rate[]" id="price_item_1" class="price_item1 price_item form-control text-right allownumericwithdecimal" tabindex="10" required="" placeholder="0.00" min="0"/>
                                        </td>
                                        <!-- Discount -->
                                        <td>
                                            <input type="text" name="discount[]" id="discount_1" class="form-control text-right allownumericwithdecimal" min="0" tabindex="11" placeholder="0.00"/>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="<?php echo base_url('pendaftaran/daftar/edit/'.$first_date);?>">Pemeriksaan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li class="active"><a href="<?php echo base_url('pendaftaran/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
              <li class="pull-right"><h3><i class="fa fa-server"></i> E REKAM MEDIS</h3></li>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li class="active"><a href="<?php echo base_url('pendaftaran/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="<?php echo base_url('pendaftaran/daftar/edit/'.$first_date);?>">Pemeriksaan</a></li>
              <li class="active"><a href="<?php echo base_url('pendaftaran/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li class="active"><a href="<?php echo base_url('pendaftaran/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              ...
              <div class="tab-pane active">
                <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
                  ...
                  <div class="box-body">
                        ...
                        ?>
                        <div class="col-md-12">
<input value="<?php echo $rowvital['nama_triase']; ?>" class="form-control" readonly style="text-shadow: 0.000em 0.075em #608b31, 0.029em 0.069em #608b31, 0.053em 0.053em #608b31, 0.069em 0.029em #608b31, 0.075em 0.000em #608b31, 0.069em -0.029em #608b31, 0.053em -0.053em #608b31, 0.029em -0.069em #608b31, 0.000em -0.075em #608b31, -0.029em -0.069em #608b31, -0.053em -0.053em #608b31, -0.069em -0.029em #608b31, -0.075em -0.000em #608b31, -0.069em 0.029em #608b31, -0.053em 0.053em #608b31, -0.029em 0.069em #608b31;color: white;font-weight:bold;background-color:<?php echo $rowvital['warna_triase']; ?>;text-align:center;"><br>
                        <div class="box-header with-border">
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li class="active"><a href="<?php echo base_url('pendaftaran/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
              <li class="pull-right"><h3><i class="fa fa-server"></i> E REKAM MEDIS</h3></li>
            </ul>
            <div class="tab-content">
                          ...
                          <table id="dttb" style="width:100%" class="table table-hover table-transaksi table-sm">
                            <thead>
                              <tr style="background-color: #29675B;color: white;">
                                ...
                                <th class="text-sm text-label text-left border-0" >No Pendaftaran</th>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="<?php echo base_url('pendaftaran/daftar/edit/'.$first_date);?>">Pemeriksaan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_dokter/'.$first_date);?>" >Dokter</a></li>
              <li class="active"><a href="<?php echo base_url('pendaftaran/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
              <li class="active"><a href="<?php echo base_url('pendaftaran/daftar/grafik_vital/'.$first_date);?>" >Vital Sign</a></li>
              <li class="pull-right"><h3><i class="fa fa-server"></i> E REKAM MEDIS</h3></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active">
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_penunjang/'.$first_date);?>" >Penunjang Luar</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_vital/'.$first_date);?>" >Hasil Pemeriksaan Pasien</a></li>
              <li class="active"><a href="<?php echo base_url('pendaftaran/daftar/data_asuhan/'.$first_date);?>" >Asuhan Keperawatan</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_radiologi/'.$first_date);?>" >Radiologi</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_lab/'.$first_date);?>" >Laboratorium</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_apotek/'.$first_date);?>" >Apotek</a></li>
              <li><a href="<?php echo base_url('pendaftaran/daftar/data_ps/'.$first_date);?>" >Riwayat Kunjungan</a></li>
...
?>
      ...
      ?>      
                  ...
                  <div class="col-sm-12">
                    <label>Eye (Skor Normal : 4)</label><p>
                    <?php
                  ...
                  <div class="col-sm-12">
                    <label>Motorik (Skor Normal : 6)</label><p>
                    <?php
                  ...
                  <div class="col-sm-12">
                    <label>Verbal (Skor Normal : 5)</label><p>
                    <?php
        ...
        <div class="box-body">
          <div class="form-group">
            <label>Diagnosa</label>
							<?php
								input_text("diagnosa",$diagnosa," required","Ketik Angka dan Huruf","text");
							?>
          </div>
        </div>
        <div class="box-footer">
          <button type="button" class="btn btn-info btn-flat" id="go">Cari</button>
        </div>
      </div>
      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border"><?= $title ?>
        ...
        <div class="box-body">
          <div class="form-group">
            <label>Result</label>
							<?php
								input_textarea("respon",$respon," rows='10' ","","text");
							?>
          </div>
        </div>
      </div>
      ...
      <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        ...
        <div class="box-body">
          <div class="form-group">
            <label>Poli</label>
							<?php
								input_text("poli",$poli," ","Ketik Angka dan Huruf","text");
							?>
          </div>
        </div>
        <div class="box-footer">
	...
	//			input_textcustom("",""," autofocus class='form-control input-sm' id='search-inp' ","CARI DI TABEL","text");
						...
						<table id="dttb" width="100%" class="table table-bordered table-striped table-hover" >
							<thead>
								<tr>
								  ...
								  <th style="text-align:right;width: 7%;">Jumlah</th>
        ...
        <div class="box-footer">
						<table width="100%" class="table table-bordered table-striped table-hover" >
								<th style="text-align:right;font-weight: bold;width: 87%;">Jumlah</th>
								<th style="text-align:right;font-weight: bold;width: 13%;" colspan="5">
									<?= $hitung_billing ?>
								</th>
						</table>
        </div>
...
.select2-container {
    ...
    padding: 0;
		...
		<FORM method="POST" class="form-horizontal" id="signupform" action="<?php echo base_url('pendaftaran/billing/simpan_edit');?>" onClick="return cek();">
		<input type="hidden" name="barcode_billing" value="<?= $barcode_billing; ?>">
		<input type="hidden" name="id_status_billing" value="<?= $id_status_billing; ?>">
		<input type="hidden" name="id_status_pasien" value="<?= $id_status_pasien; ?>">
		<input type="hidden" name="barcode_pendaftaran" value="<?= $id2; ?>">
       <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
        <div class="box-header with-border">
            <h3 class="box-title"><button type="submit" class="btn btn-primary btn-xs">Submit</button></h3>
		...
		<div class="box-body">
		  <div class="box box-<?php echo $arraybox[array_rand($arraybox)]; ?> box-solid">
			<div class="box-header with-border">
			  <h3 class="box-title">EDIT BILLING</h3>
			</div>
			  <div class="box-body">
						<div class="col-md-12">
							  <label>Jumlah</label>
			...
			input_pdselect2fleksibel("id_cara_bayar","id_cara_bayar",$kol_cara_bayar,"id_cara_bayar","nama_cara_bayar",$id_cara_bayar,"Pilih Cara Bayar");
						...
						<div class="col-md-12">
								<label id="labelpetugas">Data Karyawan</label>
									<?php
										input_pdselect2fleksibel("id_pegawai","id_pegawai",$pegawai,"id_pegawai","nama_pegawai",$id_pegawai,"Silahkan Pilih Nama Karyawan");
...
<script type="text/javascript">
    $(document).ready(function() {
		...
		if ($('#id_cara_bayar').val() == '6') {
			$('#id_pegawai').next(".select2-container").show();
			$('#labelpetugas').show();
		}
		else {
			$('#id_pegawai').next(".select2-container").hide();
			$('#labelpetugas').hide();
		}
	});
	...
	$('#id_cara_bayar').change(function () {
		if ($('#id_cara_bayar').val() == '6') {
			$('#id_pegawai').next(".select2-container").show();
			$("#id_pegawai").val("0").trigger("change");
			$('#labelpetugas').show();
		}
		else {
			$('#id_pegawai').next(".select2-container").hide();
