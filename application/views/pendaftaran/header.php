  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href="<?php echo base_url($this->session->beranda);?>"><i class="fa fa-dashboard text-<?php echo $v; ?>"></i> <span>Dashboard</span></a></li>		

       <li class="treeview <?php cek_aktif($page,array('pasien','pasien_tambah','pasien_edit','daftar','daftar_tambah','daftar_edit','billing','billing_lihats','billing_bayar')); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?php cek_aktif($page,array('pasien','pasien_tambah','pasien_edit'));?>">
				<a href="<?php echo base_url('pendaftaran/pasien');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pasien
				</a>
			</li>
      <li class="<?php cek_aktif($page,array('daftar','daftar_tambah','daftar_edit'));?>">
				<a href="<?php echo base_url('pendaftaran/daftar');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Pendaftaran
				</a>
			</li>
      <li class="<?php cek_aktif($page,array('billing','billing_lihats','billing_bayar'));?>">
				<a href="<?php echo base_url('pendaftaran/billing');?>">
					<i class="fa fa-circle-o text-<?php echo $v; ?>"></i> Billing
				</a>
			</li>
          </ul>
        </li>
        <li class="header">P CARE</li>		
