...
// -----------------------------------------------------------START-----------------------------------------
  ...
  function index(){
	...
	$program    = $this->m_umum->ambil_data('a_program','id_program','2');
	...
	$this->tampil($data);
      ...
      if($mode=='simpan_tambah'){
		  if($this->m_administrator->simpan_mata_uang()){
			...
			redirect(base_url('admin_keuangan/kurs'));
		  }else{
	...
	$this->tampil($data);
      ...
      if($mode=='simpan_tambah'){
		  if($this->m_administrator->simpan_keu_coa()){
			$this->session->set_flashdata('sukses', 'Data Berhasil Di Simpan');
			redirect(base_url('admin_keuangan/coa'));
		  }else{
			$this->session->set_flashdata('danger', 'Ada Kesalahan Tambah Data');
			redirect(base_url('admin_keuangan/coa'));
		  }
...
/*     else if($mode=='hapus'){
      ...
      if($mode=='simpan_tambah'){
		...
		if($jml == 0){
			...
			redirect(base_url('admin_keuangan/dk'));
      }
      if($mode=='edit'){
        $data['page'] =  $data['page']."_edit";
	...
	$this->tampil($data);
      ...
      if($mode=='simpan_tambah'){
		  if($this->m_administrator->simpan_item_kategori()){
			$this->session->set_flashdata('sukses', 'Data Berhasil Di Simpan');
			redirect(base_url('admin_keuangan/kategori_barang'));
		  }else{
			$this->session->set_flashdata('danger', 'Ada Kesalahan Tambah Data');
			redirect(base_url('admin_keuangan/kategori_barang'));
		  }
	...
	$this->tampil($data);
      ...
      if($mode=='simpan_tambah'){
		  if($this->m_administrator->simpan_barang()){
			$this->session->set_flashdata('sukses', 'Data Berhasil Di Simpan');
			redirect(base_url('admin_keuangan/barang'));
		  }else{
			$this->session->set_flashdata('danger', 'Ada Kesalahan Tambah Data');
			redirect(base_url('admin_keuangan/barang'));
		  }
	...
	$this->tampil($data);
      ...
      if($mode=='simpan_tambah'){
		  if($this->m_administrator->simpan_termin()){
			$this->session->set_flashdata('sukses', 'Data Berhasil Di Simpan');
			redirect(base_url('admin_keuangan/termin'));
		  }else{
			$this->session->set_flashdata('danger', 'Ada Kesalahan Tambah Data');
			redirect(base_url('admin_keuangan/termin'));
		  }
