...
class Member_surat extends CI_controller
{
// -----------------------------------------------------------START-----------------------------------------
  public function __construct(){
          ...
          $this->load->model('m_member_surat');
  ...
  // ========================================================================
	function index(){
		...
		$data['multi_level'] = $this->m_ol_rancak->ambil_data_level($this->session->id_pegawai);
 ...
 // ================================================ USER ==================================
  ...
  function profil($mode='view')
  {
	...
	$data['ambil_data_rujukan_instansi'] = $this->m_ol_rancak->ambil_data_rujukan_instansi();
...
{
	$this->load->view("member_surat/header",$data);
	$this->load->view("member_surat/isi");
	$this->load->view("footer");
	$this->load->view("member_surat/jsload");
	$this->load->view("member_surat/jscode");
}
