...
class Mega_admin extends CI_controller
{
// -----------------------------------------------------------START-----------------------------------------
  ...
  function cek_login_kah()
  {
      if ( $this->session->has_userdata('id_pegawai') && $this->session->userdata('id_level')==99 )
          return TRUE;
      elseif ( $this->session->has_userdata('id_pegawai') && $this->session->userdata('id_level')==98 ) //administrator
          return TRUE;
     else
...
{
	$this->load->view("mega/header",$data);
	$this->load->view("mega/isi");
	$this->load->view("footer");
	$this->load->view("mega/jsload");
	$this->load->view("mega/jscode");
}
